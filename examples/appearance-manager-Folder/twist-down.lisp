...
;;;; twist-down
;;;;
;;;; Displays a hierarchy in a manner similar to finder's twist-down folders.
;;;;
...
;;;;  
;;; Version 3.0c1 (September 6, 2004) for MCL 4.3.1, 4.3.5, 5.0, 5.1 and up (hopefully ;-).
;;;
;;; Maintained by Terje Norderhaug <terje@in-progress.com> upon request by Richard Lynch.
;;; Contains significant differences since Richard's 2.1 version from 1995.
;;;
...
A Twist Down view displays a hierarchy similar to the Finder's listing of files, where
the user can disclose lower levels in the hierarchy by clicking a triangle. See the bottom 

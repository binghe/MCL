...
;;  2 2/19/96  akh  add some tests at end of file
...
; Change History
;
; changes moved back to l1-dcode etc.
; fewer things added to *clos-initialization-functions*
; bad keys error as they should
;; ------- 5.1b1
; akh fix error report in separate-method-groups
; akh put decls in right place in long-form-define-method-combination
; ---------- 4.4b5
; 05/09/98 akh with-call-method-context - next-methods is optional
...
;; make bad keys error when appropiate - modified version of def in l1-dcode
(defun compute-allowable-keywords-vector (gf methods)
  ...
  (unless (memq gf *clos-initialization-functions*)
    (let* ((gbits (inner-lfun-bits gf))
      ...
      (unless (or (and (neq :unspecified (sgf.%lambda-list gf)) ;; ??

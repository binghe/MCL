(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:Ink.h"
...
(def-mactype :InkTextRef (find-mactype '(:pointer :OpaqueInkTextRef)))
; 
;  *  InkAlternateCount
;  *  
;  *  Discussion:
...
(def-mactype :InkAlternateCount (find-mactype ':UInt32))
; ——————————————————————————————————————————————————————————————————————————————————————
;   • Ink Constants                                                                     
; ——————————————————————————————————————————————————————————————————————————————————————
; 
...
(def-mactype :InkUserWritingModeType (find-mactype ':FourCharCode))

(defconstant $kInkWriteNowhere :|nowh|)
(defconstant $kInkWriteAnywhere :|anyw|)
(defconstant $kInkWriteInInkAwareAppsOnly :|iapp|)
; 
...
(def-mactype :InkApplicationWritingModeType (find-mactype ':FourCharCode))

(defconstant $kInkWriteNowhereInApp :|nowa|)
(defconstant $kInkWriteAnywhereInApp :|anya|)
; 
;  *  InkDrawingModeType
;  *  
;  *  Summary:
...
(def-mactype :InkDrawingModeType (find-mactype ':UInt32))

(defconstant $kInkDrawNothing 0)
(defconstant $kInkDrawInkOnly 1)
(defconstant $kInkDrawInkAndWritingGuides 2)
; 
...
(def-mactype :InkTextDrawFlagsType (find-mactype ':UInt32))
; 
...
(defconstant $kInkTextDrawDefault 0)
; 
;    * Don't draw using pressure sensitive gradients.
;    

(defconstant $kInkTextDrawIgnorePressure 1)
; 
;    * Honor the CGContext settings for items such as line color and
;    * width.
;    

(defconstant $kInkTextDrawHonorContext 2)
; 
;  *  InkTerminationType
;  *  
;  *  Discussion:
...
(def-mactype :InkTerminationType (find-mactype ':UInt32))
; 
;    * Can be used to inhibit all automatic phrase termination.
;    

(defconstant $kInkTerminationNone 0)
; 
...
(defconstant $kInkTerminationTimeOut 1)
; 
...
(defconstant $kInkTerminationOutOfProximity 2)
(defconstant $kInkTerminationRecognizerHorizontalBreak 4)
(defconstant $kInkTerminationRecognizerVerticalBreak 8)
; 
;    * Restores automatic phrase termination matching the current user
;    * settings. See above note for kInkTerminationOutOfProximity.
;    

(defconstant $kInkTerminationAll #xFFFFFFFF)
; 
;  *  InkSourceType
;  *  
;  *  Discussion:
...
(def-mactype :InkSourceType (find-mactype ':UInt32))
; 
;    * Addresses the user-input data stream.
;    

(defconstant $kInkSourceUser 1)
; 
;    * Addresses the application-input data stream.
;    

(defconstant $kInkSourceApplication 2)
; 
;  *  InkRecognitionType
;  *  
;  *  Discussion:
...
(def-mactype :InkRecognitionType (find-mactype ':UInt32))

(defconstant $kInkRecognitionNone 0)
(defconstant $kInkRecognitionText 1)
(defconstant $kInkRecognitionGesture 2)
(defconstant $kInkRecognitionDefault 3)
; 
;  *  Discussion:
...
(defconstant $kInkGestureUndo :|undo|)
(defconstant $kInkGestureCut :|cut |)
(defconstant $kInkGestureCopy :|copy|)
(defconstant $kInkGesturePaste :|past|)
(defconstant $kInkGestureClear :|clea|)
(defconstant $kInkGestureSelectAll :|sall|)
; 
...
(defconstant $kInkGestureEscape :|not!|)
(defconstant $kInkGestureTab :|tab |)
; 
...
(defconstant $kInkGestureLeftSpace :|lspc|)
(defconstant $kInkGestureRightSpace :|rspc|)
; 
...
(defconstant $kInkGestureLeftReturn :|lrtn|)
(defconstant $kInkGestureRightReturn :|rrtn|)
; 
...
(defconstant $kInkGestureDelete :|del |)        ;  Context-dependent (tentative) gestures…
; 
...
(defconstant $kInkGestureJoin :|join|)

(def-mactype :InkGestureKind (find-mactype ':FourCharCode))
; 
;  
; 
...
;    
   (tabletPointData :TabletPointRec)
                                                ; 
...
;type name? (%define-record :InkPoint (find-record-descriptor ':InkPoint))

(def-mactype :InkPointPtr (find-mactype '(:pointer :InkPoint)))
; ——————————————————————————————————————————————————————————————————————————————————————
;   • Ink state APIs                                                                    
; ——————————————————————————————————————————————————————————————————————————————————————
...
(deftrap-inline "_InkUserWritingMode" 
   (
...
(deftrap-inline "_InkSetApplicationWritingMode" 
   ((iWriteWhere :FourCharCode)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   nil
() )
; 
...
(deftrap-inline "_InkSetApplicationRecognitionMode" 
   ((iRecognitionType :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   nil
() )
; 
...
(deftrap-inline "_InkSetPhraseTerminationMode" 
   ((iSource :UInt32)
    (iAllowedTerminationTypes :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   nil
() )
; 
...
(deftrap-inline "_InkIsPhraseInProgress" 
   (
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :Boolean
() )
...
(deftrap-inline "_InkSetDrawingMode" 
   ((iDrawingMode :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   nil
() )
...
(deftrap-inline "_InkAddStrokeToCurrentPhrase" 
   ((iPointCount :UInt32)
    (iPointArray (:pointer :InkPoint))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   nil
() )
; 
...
(deftrap-inline "_InkTerminateCurrentPhrase" 
   ((iSource :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   nil
() )
...
(deftrap-inline "_InkTextAlternatesCount" 
   ((iTextRef (:pointer :OpaqueInkTextRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :UInt32
() )
; 
...
(deftrap-inline "_InkTextCreateCFString" 
   ((iTextRef (:pointer :OpaqueInkTextRef))
    (iIndex :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   (:pointer :__CFString)
...
(deftrap-inline "_InkTextInsertAlternatesInMenu" 
   ((iTextRef (:pointer :OpaqueInkTextRef))
    (iMenuRef (:pointer :OpaqueMenuRef))
    (iAfterItem :UInt16)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :UInt32
() )
...
(deftrap-inline "_InkTextKeyModifiers" 
   ((iTextRef (:pointer :OpaqueInkTextRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :UInt32
() )
...
(deftrap-inline "_InkTextCopy" 
   ((iTextRef (:pointer :OpaqueInkTextRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   (:pointer :OpaqueInkTextRef)
() )
; 
;  *  InkTextBounds()
;  *  
...
(deftrap-inline "_InkTextDraw" 
   ((iTextRef (:pointer :OpaqueInkTextRef))
    (iContext (:pointer :CGContext))            ;  can be NULL 
    (iBounds (:pointer :CGRect))
    (iFlags :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   nil
() )
...
(deftrap-inline "_InkTextFlatten" 
   ((iTextRef (:pointer :OpaqueInkTextRef))
    (ioDataRef (:pointer :__CFData))
    (iIndex :SInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :SInt32
() )
...
(deftrap-inline "_InkTextCreateFromCFData" 
   ((iFlattenedInkText (:pointer :__CFData))
    (iIndex :SInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   (:pointer :OpaqueInkTextRef)
() )

(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:PLStringFuncs.h"
...
(deftrap-inline "_PLstrcat" 
   ((str (:pointer :UInt8))
    (append (:pointer :STR255))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   (:pointer :UInt8)
() )
; 
...
(deftrap-inline "_PLstrpbrk" 
   ((str1 (:pointer :STR255))
    (charSet (:pointer :STR255))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :pointer
() )
; 
...
(deftrap-inline "_PLstrstr" 
   ((str1 (:pointer :STR255))
    (searchStr (:pointer :STR255))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :pointer
() )
; 
...
(provide-interface "PLStringFuncs")
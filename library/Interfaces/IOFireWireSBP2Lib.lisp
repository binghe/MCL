(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOFireWireSBP2Lib.h"
; at Sunday July 2,2006 7:29:04 pm.
; 
...
; #define kIOFireWireSBP2LibTypeID CFUUIDGetConstantUUIDWithBytes(NULL,		    0xA4, 0x5B, 0x81, 0x56, 0xB5, 0x1B, 0x11, 0xD4,							    0xAB, 0x4B, 0x00, 0x0A, 0x27, 0x7E, 0x72, 0x34 )
;  AE3A2684-B51B-11D4-B516-000A277E7234 
; #define kIOFireWireSBP2LibFactoryID CFUUIDGetConstantUUIDWithBytes(NULL, 	    0xAE, 0x3A, 0x26, 0x84, 0xB5, 0x1B, 0x11, 0xD4,							    0xB5, 0x16, 0x00, 0x0A, 0x27, 0x7E, 0x72, 0x34 )
;  B63446A8-B51B-11D4-AAB0-000A277E7234 
; #define kIOFireWireSBP2LibLUNInterfaceID CFUUIDGetConstantUUIDWithBytes(NULL,	    0xB6, 0x34, 0x46, 0xA8, 0xB5, 0x1B, 0x11, 0xD4,						    	    0xAA, 0xB0, 0x00, 0x0A, 0x27, 0x7E, 0x72, 0x34 )
;  BBE32C26-BAD4-11D4-A580-000A277E7234 
; #define kIOFireWireSBP2LibLoginInterfaceID CFUUIDGetConstantUUIDWithBytes(NULL,	    0xBB, 0xE3, 0x2C, 0x26, 0xBA, 0xD4, 0x11, 0xD4, 								0xA5, 0x80, 0x00, 0x0A, 0x27, 0x7E, 0x72, 0x34 )
;  0D818E2E-BC55-11D4-9B72-000A277E7234 
; #define kIOFireWireSBP2LibORBInterfaceID CFUUIDGetConstantUUIDWithBytes(NULL,	    0x0D, 0x81, 0x8E, 0x2E, 0xBC, 0x55, 0x11, 0xD4, 								0x9B, 0x72, 0x00, 0x0A, 0x27, 0x7E, 0x72, 0x34 )
;  ECD3E338-BDBC-11D4-A592-000A277E7234 
; #define kIOFireWireSBP2LibMgmtORBInterfaceID CFUUIDGetConstantUUIDWithBytes(NULL,	    0xEC, 0xD3, 0xE3, 0x38, 0xBD, 0xBC, 0x11, 0xD4,										0xA5, 0x92, 0x00, 0x0A, 0x27, 0x7E, 0x72, 0x34 )
; ////////////////////
...
;  
(def-mactype :IODirection (find-mactype ':sint32))

(defconstant $kIODirectionNone 0)
(defconstant $kIODirectionIn 1)                 ;  User land 'read'

(defconstant $kIODirectionOut 2)                ;  User land 'write'

(defconstant $kIODirectionOutIn 3)
(defrecord FWSBP2VirtualRange
   (address :pointer)
   (length :UInt32)
)
; ////////////////////
...
(defconstant $kFWSBP2CommandCompleteNotify 1)
(defconstant $kFWSBP2CommandTransferDataFromTarget 2)
(defconstant $kFWSBP2CommandImmediate 4)
(defconstant $kFWSBP2CommandNormalORB 32)
(defconstant $kFWSBP2CommandReservedORB 64)
(defconstant $kFWSBP2CommandVendorORB #x80)
(defconstant $kFWSBP2CommandDummyORB #x100)
(defconstant $kFWSBP2CommandCheckGeneration #x200)
(defconstant $kFWSBP2CommandFixedSize #x400)    ;  handy for debugging

(defconstant $kFWSBP2CommandVirtualORBs #x800)

(defconstant $kFWSBP2QueryLogins 1)
(defconstant $kFWSBP2AbortTask 11)
(defconstant $kFWSBP2AbortTaskSet 12)
(defconstant $kFWSBP2LogicalUnitReset 14)
(defconstant $kFWSBP2TargetReset 15)
;  notification events
...
(defrecord FWSBP2LoginCompleteParams
   (refCon :pointer)
                                                ;  refCon from login object
   (generation :UInt32)
                                                ;  generation this login was attempted in 
   (status :signed-long)
                                                ;  status of login attempt
   (loginResponse (:pointer :FWSBP2LOGINRESPONSE))
...
(defrecord FWSBP2ReconnectParams
   (refCon :pointer)
                                                ;  refCon from lun object
   (generation :UInt32)
                                                ;  generation this login was attempted in
   (status :signed-long)
                                                ;  status of reconnect attempt
   (reconnectStatusBlock (:pointer :FWSBP2STATUSBLOCK))
                                                ;  pointer to statusBlock buffer
...
(def-mactype :IOFWSBP2MessageCallback (find-mactype ':pointer)); (void * refCon , UInt32 type , void * arg)
; ! 
...
(def-mactype :IOFWSBP2LoginCallback (find-mactype ':pointer)); (void * refCon , FWSBP2LoginCompleteParams * params)
; ! 
...
(def-mactype :IOFWSBP2LogoutCallback (find-mactype ':pointer)); (void * refCon , FWSBP2LogoutCompleteParams * params)
; ! 
...
(def-mactype :IOFWSBP2ORBAppendCallback (find-mactype ':pointer)); (void * refCon , IOReturn status , void * orb)
; ! 
...
(def-mactype :IOFWSBP2ORBCompleteCallback (find-mactype ':pointer)); (void * refCon , IOReturn status , void * orb)
; ! 
...
(def-mactype :IOFWSBP2NotifyCallback (find-mactype ':pointer)); (void * refCon , FWSBP2NotifyParams * params)
; ! 
...
(def-mactype :IOFWSBP2StatusCallback (find-mactype ':pointer)); (void * refCon , IOReturn status)
; ! 
...
(def-mactype :IOFWSBP2FetchAgentWriteCallback (find-mactype ':pointer)); (void * refCon , IOReturn status , void * orbRefCon)
; ////////////////////
(defrecord IOFireWireSBP2LibLUNInterface                                                ; !
...
;     
   (setMessageCallback (:pointer :callback))    ;(void (void * self , void * refCon , IOFWSBP2MessageCallback callback))
                                                ; !
; 		@function setRefCon
...
;     
   (setRefCon (:pointer :callback))             ;(void (void * self , UInt32 refCon))
                                                ; !
; 		@function getRefCon
...
; 	
   (getRefCon (:pointer :callback))             ;(UInt32 (void * self))
                                                ; !
...
; 	
   (** (:pointer :callback))                    ;(IUnknownVTbl (* createLogin) (void * self , REFIID iid))
                                                ; !
...
; 	
   (** (:pointer :callback))                    ;(IUnknownVTbl (* createMgmtORB) (void * self , REFIID iid))
)
(defrecord IOFireWireSBP2LibORBInterface                                                ; !
...
;     
   (setCommandFlags (:pointer :callback))       ;(void (void * self , UInt32 flags))
                                                ; ! 
...
;     
   (setMaxORBPayloadSize (:pointer :callback))  ;(void (void * self , UInt32 size))
                                                ; ! 
...
;     
   (setCommandTimeout (:pointer :callback))     ;(void (void * self , UInt32 timeout))
                                                ; ! 
...
;     
   (setCommandGeneration (:pointer :callback))  ;(void (void * self , UInt32 generation))
                                                ; ! 
...
;     
   (setCommandBuffersAsRanges (:pointer :callback));(IOReturn (void * self , FWSBP2VirtualRange * ranges , UInt32 withCount , UInt32 withDirection , UInt32 offset , UInt32 length))
                                                ; ! 
...
;     
   (releaseCommandBuffers (:pointer :callback)) ;(IOReturn (void * self))
                                                ; ! 
...
;     
   (setCommandBlock (:pointer :callback))       ;(IOReturn (void * self , void * buffer , UInt32 length))
                                                ; ! 
...
;         @result Returns KIOReturnSuccess if the page table was written successfully. 
;     
   (LSIWorkaroundSetCommandBuffersAsRanges (:pointer :callback));(IOReturn (void * self , FWSBP2VirtualRange * ranges , UInt32 withCount , UInt32 withDirection , UInt32 offset , UInt32 length))
                                                ; !
...
; 	
   (LSIWorkaroundSyncBuffersForOutput (:pointer :callback));(IOReturn (void * self))
                                                ; !
...
;         @result Returns kIOReturnSuccess if sync was successful.
; 	
   (LSIWorkaroundSyncBuffersForInput (:pointer :callback));(IOReturn (void * self))
)
(defrecord IOFireWireSBP2LibLoginInterface                                                ; !
...
; 	
   (submitLogin (:pointer :callback))           ;(IOReturn (void * self))
                                                ; !
...
; 	
   (submitLogout (:pointer :callback))          ;(IOReturn (void * self))
                                                ; !
...
; 	
   (setLoginFlags (:pointer :callback))         ;(void (void * self , UInt32 flags))
                                                ; !
...
; 	
   (setLoginCallback (:pointer :callback))      ;(void (void * self , void * refCon , IOFWSBP2LoginCallback callback))
                                                ; !
...
; 	
   (setLogoutCallback (:pointer :callback))     ;(void (void * self , void * refCon , IOFWSBP2LogoutCallback callback))
                                                ; !
; 		@function setRefCon
...
; 	
   (getMaxCommandBlockSize (:pointer :callback));(UInt32 (void * self))
                                                ; !
; 		@function getLoginID
...
; 	
   (getLoginID (:pointer :callback))            ;(UInt32 (void * self))
                                                ; !
...
; 	
   (setReconnectTime (:pointer :callback))      ;(void (void * self , UInt32 time))
                                                ; !
; 		@function createORB
...
; 	
   (** (:pointer :callback))                    ;(IUnknownVTbl (* createORB) (void * self , REFIID iid))
                                                ; !
; 		@function submitORB
...
; 	
   (submitORB (:pointer :callback))             ;(IOReturn (void * self , IOFireWireSBP2LibORBInterface ** orb))
                                                ; !
...
; 	
   (setUnsolicitedStatusNotify (:pointer :callback));(void (void * self , void * refCon , IOFWSBP2NotifyCallback callback))
                                                ; !
...
;         @param callback Address of callback method of type FWSBP2NotifyCallback.
; 	
   (setStatusNotify (:pointer :callback))       ;(void (void * self , void * refCon , IOFWSBP2NotifyCallback callback))
                                                ; !
...
; 	
   (setFetchAgentResetCallback (:pointer :callback));(void (void * self , void * refCon , IOFWSBP2StatusCallback callback))
                                                ; !
...
; 	
   (submitFetchAgentReset (:pointer :callback)) ;(IOReturn (void * self))
                                                ; !
...
;         @param callback address of callback method of type FWSBP2FetchAgentWriteCallback.
; 	
   (setFetchAgentWriteCallback (:pointer :callback));(void (void * self , void * refCon , IOFWSBP2FetchAgentWriteCallback callback))
                                                ; !
...
; 	
   (ringDoorbell (:pointer :callback))          ;(IOReturn (void * self))
                                                ; !
...
; 	
   (enableUnsolicitedStatus (:pointer :callback));(IOReturn (void * self))
                                                ; !
...
;     
   (setBusyTimeoutRegisterValue (:pointer :callback));(IOReturn (void * self , UInt32 timeout))
                                                ; !
...
;         @result Returns kIOReturnSuccess on success.
; 	
   (setPassword (:pointer :callback))           ;(IOReturn (void * self , void * buffer , UInt32 length))
)
(defrecord IOFireWireSBP2LibMgmtORBInterface                                                ; !
...
;     
   (submitORB (:pointer :callback))             ;(IOReturn (void * self))
                                                ; !
...
;     
   (setORBCompleteCallback (:pointer :callback));(void (void * self , void * refCon , IOFWSBP2ORBCompleteCallback callback))
                                                ; !
; 		@function setRefCon
; 		@abstract Sets the login refCon.
; 		@discussion Sets a user defined value on the login that can be retrieved later with the 
...
; 	
   (setCommandFunction (:pointer :callback))    ;(IOReturn (void * self , UInt32 function))
                                                ; !
...
;  	
   (setManageeORB (:pointer :callback))         ;(IOReturn (void * self , void * command))
                                                ; !
...
;         @result Returns kIOReturnSuccess on a success.
;  	
   (setManageeLogin (:pointer :callback))       ;(IOReturn (void * self , void * command))
                                                ; !
...
;         @result Returns kIOReturnSuccess on a success.
; 	
   (setResponseBuffer (:pointer :callback))     ;(IOReturn (void * self , void * buf , UInt32 len))
)

; #endif


(provide-interface "IOFireWireSBP2Lib")
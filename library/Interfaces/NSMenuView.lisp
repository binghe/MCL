(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:NSMenuView.h"
...
- (id)initWithFrame:(NSRect)frame;  - (id)initAsTearOff;
...
- (NSRect)innerRect; - (NSRect)rectOfItemAtIndex:(int)index;

(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOFireWireSBP2Target.h"
...
(defconstant $kIOFWSBP2FailsOnAckBusy 1)
(defconstant $kIOFWSBP2FailsOnBusResetsDuringIO 2)
; !
...
; 
#|
 confused about CLASS IOFireWireSBP2Target #\: public IOService #\{ OSDeclareDefaultStructors #\( IOFireWireSBP2Target #\) #\; protected #\:; ///////////////////////////////////////
;  rom keys
 enum #\{ kCmdSpecIDKey = 0x38 #\, kCmdSetKey = 0x39 #\, kSoftwareRevKey = 0x3b #\, kFirmwareRevKey = 0x3c #\, kLUNKey = 0x14 #\, kLUNDirectoryKey = 0xd4 #\, kManagementAgentOffsetKey = 0x54 #\, kUnitCharacteristicsKey = 0x3A #\, kRevisionKey = 0x21 #\, kFastStartKey = 0x3E #\} #\; typedef struct #\{ UInt32 cmdSpecID #\; UInt32 cmdSet #\; UInt32 vendorID #\; UInt32 softwareRev #\; UInt32 firmwareRev #\; UInt32 lun #\; UInt32 devType #\; UInt32 unitCharacteristics #\; UInt32 managementOffset #\; UInt32 revision #\; bool fastStartSupported #\; UInt32 fastStart #\; #\} LUNInfo #\;;  reserved for future use
 struct ExpansionData #\{ #\} #\; ExpansionData * reserved #\;; ///////////////////////////////////////
;  private fields
 bool fOpenFromTarget #\; UInt32 fOpenFromLUNCount #\; IOFireWireUnit * fProviderUnit #\; UInt32 fFlags #\; IOFireWireController * fControl #\; UInt32 fIOCriticalSectionCount #\;; ///////////////////////////////////////
;  private internals
 virtual void free #\( void #\) #\; virtual IOReturn message #\( UInt32 type #\, IOService * provider #\, void * argument = 0 #\) #\; virtual void scanForLUNs #\( void #\) #\; IOReturn createLUN #\( LUNInfo * info #\) #\; public #\:; ///////////////////////////////////////
;  public methods
; ! @function handleOpen

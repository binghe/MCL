(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IODataQueueClient.h"
; at Sunday July 2,2006 7:28:46 pm.
; 
...
(require-interface "IOKit/IODataQueueShared")
; !
...
(deftrap-inline "_IODataQueueDataAvailable" 
   ((dataQueue (:pointer :IODATAQUEUEMEMORY))
   )
   :Boolean
() )
; !
...
(deftrap-inline "_IODataQueuePeek" 
   ((dataQueue (:pointer :IODATAQUEUEMEMORY))
   )
   (:pointer :_IODATAQUEUEENTRY)
() )
; !
...
(deftrap-inline "_IODataQueueDequeue" 
   ((dataQueue (:pointer :IODATAQUEUEMEMORY))
    (data :pointer)
...
(deftrap-inline "_IODataQueueWaitForAvailableData" 
   ((dataQueue (:pointer :IODATAQUEUEMEMORY))
...
(deftrap-inline "_IODataQueueAllocateNotificationPort" 
   ((ARG2 (:NIL :NIL))
   )
   :pointer
() )
...
(provide-interface "IODataQueueClient")
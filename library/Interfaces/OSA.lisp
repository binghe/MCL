(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:OSA.h"
...
(def-mactype :OSACreateAppleEventProcPtr (find-mactype ':pointer)); (AEEventClass theAEEventClass , AEEventID theAEEventID , const AEAddressDesc * target , short returnID , long transactionID , AppleEvent * result , long refCon)

(def-mactype :OSASendProcPtr (find-mactype ':pointer)); (const AppleEvent * theAppleEvent , AppleEvent * reply , AESendMode sendMode , AESendPriority sendPriority , long timeOutInTicks , AEIdleUPP idleProc , AEFilterUPP filterProc , long refCon)

(def-mactype :OSACreateAppleEventUPP (find-mactype '(:pointer :OpaqueOSACreateAppleEventProcPtr)))

(def-mactype :OSASendUPP (find-mactype '(:pointer :OpaqueOSASendProcPtr)))
; 
...
(deftrap-inline "_NewOSACreateAppleEventUPP" 
   ((userRoutine :pointer)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   (:pointer :OpaqueOSACreateAppleEventProcPtr)
() )
; 
;  *  NewOSASendUPP()
;  *  
...
(deftrap-inline "_NewOSASendUPP" 
   ((userRoutine :pointer)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   (:pointer :OpaqueOSASendProcPtr)
() )
; 
...
(deftrap-inline "_DisposeOSACreateAppleEventUPP" 
   ((userUPP (:pointer :OpaqueOSACreateAppleEventProcPtr))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   nil
() )
; 
...
(deftrap-inline "_DisposeOSASendUPP" 
   ((userUPP (:pointer :OpaqueOSASendProcPtr))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   nil
() )
; 
...
(deftrap-inline "_InvokeOSACreateAppleEventUPP" 
...
(deftrap-inline "_InvokeOSASendUPP" 
...
(defconstant $kOSASupportsCompiling 2)
(defconstant $kOSASupportsGetSource 4)
(defconstant $kOSASupportsAECoercion 8)
(defconstant $kOSASupportsAESending 16)
(defconstant $kOSASupportsRecording 32)
(defconstant $kOSASupportsConvenience 64)
(defconstant $kOSASupportsDialects #x80)
(defconstant $kOSASupportsEventHandling #x100)
;  Component Selectors: 

(defconstant $kOSASelectLoad 1)
(defconstant $kOSASelectStore 2)
(defconstant $kOSASelectExecute 3)
(defconstant $kOSASelectDisplay 4)
(defconstant $kOSASelectScriptError 5)
(defconstant $kOSASelectDispose 6)
(defconstant $kOSASelectSetScriptInfo 7)
(defconstant $kOSASelectGetScriptInfo 8)
(defconstant $kOSASelectSetActiveProc 9)
(defconstant $kOSASelectGetActiveProc 10)
;  Compiling: 
...
(defconstant $kOSASelectCopyScript #x105)
;  GetSource: 
...
(defconstant $kOSADebuggerCreateSession #x901)
(defconstant $kOSADebuggerGetSessionState #x902)
(defconstant $kOSADebuggerSessionStep #x903)
(defconstant $kOSADebuggerDisposeSession #x904)
(defconstant $kOSADebuggerGetStatementRanges #x905)
(defconstant $kOSADebuggerGetBreakpoint #x910)
(defconstant $kOSADebuggerSetBreakpoint #x911)
(defconstant $kOSADebuggerGetDefaultBreakpoint #x912)
(defconstant $kOSADebuggerGetCurrentCallFrame #x906)
(defconstant $kOSADebuggerGetCallFrameState #x907)
(defconstant $kOSADebuggerGetVariable #x908)
(defconstant $kOSADebuggerSetVariable #x909)
(defconstant $kOSADebuggerGetPreviousCallFrame #x90A)
(defconstant $kOSADebuggerDisposeCallFrame #x90B)
...
(defconstant $kOSAModePreventGetSource 1)
; 
...
(defconstant $kOSAModeNeverInteract 16)
(defconstant $kOSAModeCanInteract 32)
(defconstant $kOSAModeAlwaysInteract 48)
(defconstant $kOSAModeDontReconnect #x80)
; 
...
(defconstant $kOSAModeCantSwitchLayer 64)
; 
;         This mode flag may be passed to OSACompile, OSAExecute, OSALoadExecute
;         OSACompileExecute, OSADoScript, OSAExecuteEvent, or OSADoEvent to
...
(defconstant $kOSAModeCompileIntoContext 2)
; 
...
(defconstant $kOSAModeAugmentContext 4)
; 
...
(defconstant $kOSAModeDisplayForHumans 8)
; 
...
(defconstant $kOSAModeFullyQualifyDescriptors #x80000)
; *************************************************************************
...
(defconstant $kOSAScriptResourceType :|scpt|)
; 
;         Default type given to OSAStore which creates "generic" loadable script
;         data descriptors.
;     

(defconstant $typeOSAGenericStorage :|scpt|)
; 
;  *  OSALoad()
;  *  
;  *  Availability:
...
(deftrap-inline "_OSAStore" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (scriptID :UInt32)
    (desiredType :FourCharCode)
    (modeFlags :signed-long)
    (resultingScriptData (:pointer :AEDesc))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
; 
...
(deftrap-inline "_OSAScriptError" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (selector :OSType)
    (desiredType :FourCharCode)
...
(deftrap-inline "_OSASetScriptInfo" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (scriptID :UInt32)
    (selector :OSType)
    (value :signed-long)
...
(deftrap-inline "_OSAGetScriptInfo" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (scriptID :UInt32)
    (selector :OSType)
    (result (:pointer :long))
...
(def-mactype :OSAActiveProcPtr (find-mactype ':pointer)); (long refCon)

(def-mactype :OSAActiveUPP (find-mactype '(:pointer :OpaqueOSAActiveProcPtr)))
; 
;  *  NewOSAActiveUPP()
;  *  
;  *  Availability:
...
(deftrap-inline "_NewOSAActiveUPP" 
   ((userRoutine :pointer)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   (:pointer :OpaqueOSAActiveProcPtr)
() )
; 
;  *  DisposeOSAActiveUPP()
;  *  
...
(deftrap-inline "_DisposeOSAActiveUPP" 
   ((userUPP (:pointer :OpaqueOSAActiveProcPtr))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   nil
() )
; 
...
(deftrap-inline "_InvokeOSAActiveUPP" 
   ((refCon :signed-long)
    (userUPP (:pointer :OpaqueOSAActiveProcPtr))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSErr
...
(deftrap-inline "_OSASetActiveProc" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (activeProc (:pointer :OpaqueOSAActiveProcPtr))
    (refCon :signed-long)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
...
(deftrap-inline "_OSAGetActiveProc" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (activeProc (:pointer :OSAACTIVEUPP))
    (refCon (:pointer :long))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
...
(deftrap-inline "_OSAScriptingComponentName" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (resultingScriptingComponentName (:pointer :AEDesc))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
; 
...
(deftrap-inline "_OSACompile" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (sourceData (:pointer :AEDesc))
    (modeFlags :signed-long)
    (previousAndResultingScriptID (:pointer :OSAID))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
; 
...
(deftrap-inline "_OSACoerceFromDesc" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (scriptData (:pointer :AEDesc))
    (modeFlags :signed-long)
    (resultingScriptID (:pointer :OSAID))
...
(deftrap-inline "_OSACoerceToDesc" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (scriptID :UInt32)
    (desiredType :FourCharCode)
    (modeFlags :signed-long)
...
(deftrap-inline "_OSASetSendProc" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (sendProc (:pointer :OpaqueOSASendProcPtr))
    (refCon :signed-long)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
...
(deftrap-inline "_OSAGetSendProc" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (sendProc (:pointer :OSASENDUPP))
    (refCon (:pointer :long))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
...
(deftrap-inline "_OSASetCreateProc" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (createProc (:pointer :OpaqueOSACreateAppleEventProcPtr))
    (refCon :signed-long)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
...
(deftrap-inline "_OSAGetCreateProc" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (createProc (:pointer :OSACREATEAPPLEEVENTUPP))
    (refCon (:pointer :long))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
...
(deftrap-inline "_OSASetDefaultTarget" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (target (:pointer :AEADDRESSDESC))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
...
(deftrap-inline "_OSAStartRecording" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (compiledScriptToModifyID (:pointer :OSAID))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
; 
...
(deftrap-inline "_OSAStopRecording" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (compiledScriptID :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
...
(deftrap-inline "_OSALoadExecute" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (scriptData (:pointer :AEDesc))
    (contextID :UInt32)
    (modeFlags :signed-long)
...
(deftrap-inline "_OSACompileExecute" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (sourceData (:pointer :AEDesc))
    (contextID :UInt32)
    (modeFlags :signed-long)
...
(deftrap-inline "_OSASetCurrentDialect" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (dialectCode :SInt16)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
...
(deftrap-inline "_OSAGetCurrentDialect" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (resultingDialectCode (:pointer :short))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
; 
...
(deftrap-inline "_OSAAvailableDialects" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (resultingDialectInfoList (:pointer :AEDesc))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
; 
...
(deftrap-inline "_OSAGetDialectInfo" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (dialectCode :SInt16)
    (selector :OSType)
    (resultingDialectInfo (:pointer :AEDesc))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
; 
...
(deftrap-inline "_OSAAvailableDialectCodeList" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (resultingDialectCodeList (:pointer :AEDesc))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
; 
...
(deftrap-inline "_OSASetResumeDispatchProc" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (resumeDispatchProc (:pointer :OpaqueAEEventHandlerProcPtr))
    (refCon :signed-long)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
...
(defconstant $kOSAUseStandardDispatch #xFFFFFFFF)
; 
...
(deftrap-inline "_OSAGetResumeDispatchProc" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (resumeDispatchProc (:pointer :AEEVENTHANDLERUPP))
    (refCon (:pointer :long))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
...
(deftrap-inline "_OSAExecuteEvent" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (theAppleEvent (:pointer :AppleEvent))
    (contextID :UInt32)
    (modeFlags :signed-long)
...
(deftrap-inline "_OSAMakeContext" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (contextName (:pointer :AEDesc))
    (parentContext :UInt32)
    (resultingContextID (:pointer :OSAID))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
; 
...
(def-mactype :OSADebugSessionRef (find-mactype ':UInt32))

(def-mactype :OSADebugCallFrameRef (find-mactype ':UInt32))
; 
;  * Constants
;  

(def-mactype :OSAProgramState (find-mactype ':UInt32))

(defconstant $eNotStarted 0)
(defconstant $eRunnable 1)
(defconstant $eRunning 2)
(defconstant $eStopped 3)
(defconstant $eTerminated 4)

(def-mactype :OSADebugStepKind (find-mactype ':UInt32))

(defconstant $eStepOver 0)
(defconstant $eStepIn 1)
(defconstant $eStepOut 2)
(defconstant $eRun 3)
; 
;  * Session Information
;  

(defconstant $keyProgramState :|dsps|)
; 
;  * Call Frame Information
;  
(defrecord StatementRange
   (startPos :UInt32)
   (endPos :UInt32)
)

;type name? (%define-record :StatementRange (find-record-descriptor ':StatementRange))

(defconstant $typeStatementRange :|srng|)

(defconstant $keyProcedureName :|dfnm|)         ;  typeChar 

(defconstant $keyStatementRange :|dfsr|)        ;  typeStatementRange 

(defconstant $keyLocalsNames :|dfln|)           ;  typeAEList of typeChar 

(defconstant $keyGlobalsNames :|dfgn|)          ;  typeAEList of typeChar 

(defconstant $keyParamsNames :|dfpn|)           ;  typeAEList of typeChar 
...
(deftrap-inline "_OSADebuggerCreateSession" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (inScript :UInt32)
    (inContext :UInt32)
    (outSession (:pointer :OSADEBUGSESSIONREF))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
; 
...
(deftrap-inline "_OSADebuggerGetSessionState" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (inSession :UInt32)
    (outState (:pointer :AERecord))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
; 
...
(deftrap-inline "_OSADebuggerSessionStep" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (inSession :UInt32)
    (inKind :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
...
(deftrap-inline "_OSADebuggerDisposeSession" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (inSession :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
...
(deftrap-inline "_OSADebuggerGetStatementRanges" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (inSession :UInt32)
    (outStatementRangeArray (:pointer :AEDescList))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
...
(deftrap-inline "_OSADebuggerGetBreakpoint" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (inSession :UInt32)
    (inSrcOffset :UInt32)
    (outBreakpoint (:pointer :OSAID))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
; 
...
(deftrap-inline "_OSADebuggerSetBreakpoint" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (inSession :UInt32)
    (inSrcOffset :UInt32)
    (inBreakpoint :UInt32)
...
(deftrap-inline "_OSADebuggerGetDefaultBreakpoint" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (inSession :UInt32)
    (outBreakpoint (:pointer :OSAID))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
...
(deftrap-inline "_OSADebuggerGetCurrentCallFrame" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (inSession :UInt32)
    (outCallFrame (:pointer :OSADEBUGCALLFRAMEREF))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
; 
...
(deftrap-inline "_OSADebuggerGetCallFrameState" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (inCallFrame :UInt32)
    (outState (:pointer :AERecord))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
...
(deftrap-inline "_OSADebuggerGetVariable" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (inCallFrame :UInt32)
    (inVariableName (:pointer :AEDesc))
    (outVariable (:pointer :OSAID))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
; 
...
(deftrap-inline "_OSADebuggerSetVariable" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (inCallFrame :UInt32)
    (inVariableName (:pointer :AEDesc))
    (inVariable :UInt32)
...
(deftrap-inline "_OSADebuggerGetPreviousCallFrame" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (inCurrentFrame :UInt32)
    (outPrevFrame (:pointer :OSADEBUGCALLFRAMEREF))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
() )
; 
...
(deftrap-inline "_OSADebuggerDisposeCallFrame" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (inCallFrame :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :signed-long
...
(deftrap-inline "_OSALoadFile" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (scriptFile (:pointer :FSRef))
    (storable (:pointer :Boolean))
    (modeFlags :signed-long)
    (resultingScriptID (:pointer :OSAID))
...
(deftrap-inline "_OSALoadExecuteFile" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (scriptFile (:pointer :FSRef))
    (contextID :UInt32)
    (modeFlags :signed-long)
...
(deftrap-inline "_OSADoScriptFile" 
   ((scriptingComponent (:pointer :ComponentInstanceRecord))
    (scriptFile (:pointer :FSRef))
    (contextID :UInt32)
    (desiredType :FourCharCode)

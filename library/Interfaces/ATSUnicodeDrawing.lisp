(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:ATSUnicodeDrawing.h"
...
(deftrap-inline "_ATSUDrawText" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iLineOffset :UInt32)
    (iLineLength :UInt32)
    (iLocationX :signed-long)
    (iLocationY :signed-long)
...
(deftrap-inline "_ATSUGetUnjustifiedBounds" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iLineStart :UInt32)
    (iLineLength :UInt32)
    (oTextBefore (:pointer :ATSUTEXTMEASUREMENT))
    (oTextAfter (:pointer :ATSUTEXTMEASUREMENT))
    (oAscent (:pointer :ATSUTEXTMEASUREMENT))
    (oDescent (:pointer :ATSUTEXTMEASUREMENT))
...
(deftrap-inline "_ATSUMeasureTextImage" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iLineOffset :UInt32)
    (iLineLength :UInt32)
    (iLocationX :signed-long)
    (iLocationY :signed-long)
    (oTextImageRect (:pointer :Rect))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUGetGlyphBounds" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iTextBasePointX :signed-long)
    (iTextBasePointY :signed-long)
    (iBoundsCharStart :UInt32)
    (iBoundsCharLength :UInt32)
    (iTypeOfBounds :UInt16)
    (iMaxNumberOfBounds :UInt32)
    (oGlyphBounds (:pointer :ATSTrapezoid))     ;  can be NULL 
    (oActualNumberOfBounds (:pointer :ItemCount));  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
;  ---------------------------------------------------------------------------- 
...
(deftrap-inline "_ATSUBatchBreakLines" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iRangeStart :UInt32)
    (iRangeLength :UInt32)
    (iLineWidth :signed-long)
    (oBreakCount (:pointer :ItemCount))         ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUBreakLine" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iLineStart :UInt32)
    (iLineWidth :signed-long)
    (iUseAsSoftLineBreak :Boolean)
    (oLineBreak (:pointer :UNICHARARRAYOFFSET)) ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUSetSoftLineBreak" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iLineBreak :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
...
(deftrap-inline "_ATSUGetSoftLineBreaks" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iRangeStart :UInt32)
    (iRangeLength :UInt32)
    (iMaximumBreaks :UInt32)
    (oBreaks (:pointer :UNICHARARRAYOFFSET))    ;  can be NULL 
    (oBreakCount (:pointer :ItemCount))         ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_ATSUClearSoftLineBreaks" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iRangeStart :UInt32)
    (iRangeLength :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
...
(deftrap-inline "_ATSUSetHighlightingMethod" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iMethod :UInt32)
    (iUnhighlightData (:pointer :ATSUUnhighlightData));  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUHighlightText" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iTextBasePointX :signed-long)
    (iTextBasePointY :signed-long)
    (iHighlightStart :UInt32)
    (iHighlightLength :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUUnhighlightText" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iTextBasePointX :signed-long)
    (iTextBasePointY :signed-long)
    (iHighlightStart :UInt32)
...
(deftrap-inline "_ATSUGetTextHighlight" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iTextBasePointX :signed-long)
    (iTextBasePointY :signed-long)
    (iHighlightStart :UInt32)
    (iHighlightLength :UInt32)
    (oHighlightRegion (:pointer :OpaqueRgnHandle))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUHighlightInactiveText" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iTextBasePointX :signed-long)
    (iTextBasePointY :signed-long)
    (iHighlightStart :UInt32)
...
(deftrap-inline "_ATSUPositionToOffset" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iLocationX :signed-long)
    (iLocationY :signed-long)
    (ioPrimaryOffset (:pointer :UNICHARARRAYOFFSET))
    (oIsLeading (:pointer :Boolean))
    (oSecondaryOffset (:pointer :UNICHARARRAYOFFSET))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUOffsetToPosition" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iOffset :UInt32)
    (iIsLeading :Boolean)
    (oMainCaret (:pointer :ATSUCaret))
    (oSecondCaret (:pointer :ATSUCaret))
    (oCaretIsSplit (:pointer :Boolean))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUPositionToCursorOffset" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iLocationX :signed-long)
    (iLocationY :signed-long)
    (iMovementType :UInt16)
    (ioPrimaryOffset (:pointer :UNICHARARRAYOFFSET))
    (oIsLeading (:pointer :Boolean))
    (oSecondaryOffset (:pointer :UNICHARARRAYOFFSET))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
...
(deftrap-inline "_ATSUOffsetToCursorPosition" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iOffset :UInt32)
    (iIsLeading :Boolean)
    (iMovementType :UInt16)
...
(deftrap-inline "_ATSUNextCursorPosition" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iOldOffset :UInt32)
    (iMovementType :UInt16)
    (oNewOffset (:pointer :UNICHARARRAYOFFSET))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUPreviousCursorPosition" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iOldOffset :UInt32)
    (iMovementType :UInt16)
    (oNewOffset (:pointer :UNICHARARRAYOFFSET))
...
(deftrap-inline "_ATSURightwardCursorPosition" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iOldOffset :UInt32)
    (iMovementType :UInt16)
    (oNewOffset (:pointer :UNICHARARRAYOFFSET))
...
(deftrap-inline "_ATSULeftwardCursorPosition" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iOldOffset :UInt32)
    (iMovementType :UInt16)
    (oNewOffset (:pointer :UNICHARARRAYOFFSET))
...
(deftrap-inline "_ATSUMeasureText" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iLineStart :UInt32)
    (iLineLength :UInt32)
    (oTextBefore (:pointer :ATSUTEXTMEASUREMENT))
...
(provide-interface "ATSUnicodeDrawing")
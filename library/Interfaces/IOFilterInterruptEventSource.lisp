(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOFilterInterruptEventSource.h"
...
; 
#|
 confused about CLASS IOFilterInterruptEventSource #\: public IOInterruptEventSource #\{ OSDeclareDefaultStructors #\( IOFilterInterruptEventSource #\) public #\:
; !
;     @typedef Filter
...
;     @abstract Override $link IOInterruptEventSource::disableInterruptOccurred to make a filter callout. 
 virtual void disableInterruptOccurred #\( void * self #\, IOService * prov #\, int ind #\) #\; private #\: OSMetaClassDeclareReservedUnused #\( IOFilterInterruptEventSource #\, 0 #\) #\; OSMetaClassDeclareReservedUnused #\( IOFilterInterruptEventSource #\, 1 #\) #\; OSMetaClassDeclareReservedUnused #\( IOFilterInterruptEventSource #\, 2 #\) #\; OSMetaClassDeclareReservedUnused #\( IOFilterInterruptEventSource #\, 3 #\) #\; OSMetaClassDeclareReservedUnused #\( IOFilterInterruptEventSource #\, 4 #\) #\; OSMetaClassDeclareReservedUnused #\( IOFilterInterruptEventSource #\, 5 #\) #\; OSMetaClassDeclareReservedUnused #\( IOFilterInterruptEventSource #\, 6 #\) #\; OSMetaClassDeclareReservedUnused #\( IOFilterInterruptEventSource #\, 7 #\) #\;
|#

; #endif /* !_IOKIT_IOFILTERINTERRUPTEVENTSOURCE_H */


(provide-interface "IOFilterInterruptEventSource")
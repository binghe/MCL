(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:ImageCompression.k.h"
...
#| #|
	#ifndefGRAPHICSIMPORT_GLOBALS
		#define GRAPHICSIMPORT_GLOBALS() 
		#define ADD_GRAPHICSIMPORT_COMMA 
	#else		#define ADD_GRAPHICSIMPORT_COMMA ,
	#endif	#define GRAPHICSIMPORT_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define GRAPHICSIMPORT_STRCAT(a,b) GRAPHICSIMPORT_GLUE(a,b)
...
#| #|
	#ifndefGRAPHICSEXPORT_GLOBALS
		#define GRAPHICSEXPORT_GLOBALS() 
		#define ADD_GRAPHICSEXPORT_COMMA 
	#else		#define ADD_GRAPHICSEXPORT_COMMA ,
	#endif	#define GRAPHICSEXPORT_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define GRAPHICSEXPORT_STRCAT(a,b) GRAPHICSEXPORT_GLUE(a,b)
...
#| #|
	#ifndefIMAGETRANSCODER_GLOBALS
		#define IMAGETRANSCODER_GLOBALS() 
		#define ADD_IMAGETRANSCODER_COMMA 
	#else		#define ADD_IMAGETRANSCODER_COMMA ,
	#endif	#define IMAGETRANSCODER_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define IMAGETRANSCODER_STRCAT(a,b) IMAGETRANSCODER_GLUE(a,b)
...
#| #|
		...
		#define QT_GLOBALS() 
		#define ADD_QT_COMMA 
	#else		#define ADD_QT_COMMA ,
	#endif	#define QT_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define QT_STRCAT(a,b) QT_GLUE(a,b)
...
(provide-interface "ImageCompression.k")
(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:Movies.k.h"
; at Sunday July 2,2006 7:30:30 pm.
; 
;      File:       Movies.k.h
;  
...
#| #|
	#ifndefVIDEOMEDIA_GLOBALS
		#define VIDEOMEDIA_GLOBALS() 
		#define ADD_VIDEOMEDIA_COMMA 
	#else		#define ADD_VIDEOMEDIA_COMMA ,
	#endif	#define VIDEOMEDIA_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define VIDEOMEDIA_STRCAT(a,b) VIDEOMEDIA_GLUE(a,b)
...
#| #|
	#ifndefTEXTMEDIA_GLOBALS
		#define TEXTMEDIA_GLOBALS() 
		#define ADD_TEXTMEDIA_COMMA 
	#else		#define ADD_TEXTMEDIA_COMMA ,
	#endif	#define TEXTMEDIA_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define TEXTMEDIA_STRCAT(a,b) TEXTMEDIA_GLUE(a,b)
...
#| #|
	#ifndefSPRITEMEDIA_GLOBALS
		#define SPRITEMEDIA_GLOBALS() 
		#define ADD_SPRITEMEDIA_COMMA 
	#else		#define ADD_SPRITEMEDIA_COMMA ,
	#endif	#define SPRITEMEDIA_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define SPRITEMEDIA_STRCAT(a,b) SPRITEMEDIA_GLUE(a,b)
...
#| #|
	#ifndefFLASHMEDIA_GLOBALS
		#define FLASHMEDIA_GLOBALS() 
		#define ADD_FLASHMEDIA_COMMA 
	#else		#define ADD_FLASHMEDIA_COMMA ,
	#endif	#define FLASHMEDIA_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define FLASHMEDIA_STRCAT(a,b) FLASHMEDIA_GLUE(a,b)
...
#| #|
	#ifndefMOVIEMEDIA_GLOBALS
		#define MOVIEMEDIA_GLOBALS() 
		#define ADD_MOVIEMEDIA_COMMA 
	#else		#define ADD_MOVIEMEDIA_COMMA ,
	#endif	#define MOVIEMEDIA_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define MOVIEMEDIA_STRCAT(a,b) MOVIEMEDIA_GLUE(a,b)
...
#| #|
	#ifndefMEDIA3D_GLOBALS
		#define MEDIA3D_GLOBALS() 
		#define ADD_MEDIA3D_COMMA 
	#else		#define ADD_MEDIA3D_COMMA ,
	#endif	#define MEDIA3D_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define MEDIA3D_STRCAT(a,b) MEDIA3D_GLUE(a,b)
...
#| #|
		...
		#define MC_GLOBALS() 
		#define ADD_MC_COMMA 
	#else		#define ADD_MC_COMMA ,
	#endif	#define MC_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define MC_STRCAT(a,b) MC_GLUE(a,b)
...
#| #|
	#ifndefMUSICMEDIA_GLOBALS
		#define MUSICMEDIA_GLOBALS() 
		#define ADD_MUSICMEDIA_COMMA 
	#else		#define ADD_MUSICMEDIA_COMMA ,
	#endif	#define MUSICMEDIA_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define MUSICMEDIA_STRCAT(a,b) MUSICMEDIA_GLUE(a,b)

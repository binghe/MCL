(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOPCCard16Enabler.h"
...
;  
(defconstant $kMaxConfigurations 32)
; #define kMaxConfigurations	32
;  return values from getWindowType()
(defconstant $IOPCCARD16_BAD_INDEX 0)
; #define IOPCCARD16_BAD_INDEX		0
(defconstant $IOPCCARD16_MEMORY_WINDOW 1)
; #define IOPCCARD16_MEMORY_WINDOW 	1
(defconstant $IOPCCARD16_IO_WINDOW 2)
...
; 
#|
 confused about CLASS IOPCCard16Enabler #\: public OSObject #\{ OSDeclareDefaultStructors #\( IOPCCard16Enabler #\) #\; protected #\:
; ! @var device
...
;       Tracks the current common memory mapping 
 memreq_t map #\[ CISTPL_MEM_MAX_WIN #\] #\; struct ExpansionData #\{ #\} #\; ExpansionData * reserved #\; public #\:
; ! @function withDevice
...
;      
 static IOPCCard16Enabler * withDevice #\( IOPCCard16Device * provider #\) #\; virtual bool init #\( IOPCCard16Device * provider #\) #\; virtual bool attach #\( IOPCCard16Device * provider #\) #\; virtual bool detach #\( IOPCCard16Device * provider #\) #\; virtual void free #\( void #\) #\;
...
;      
 virtual bool setWindowOffset #\( UInt32 index #\, UInt32 newOffset #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 0 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 1 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 2 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 3 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 4 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 5 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 6 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 7 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 8 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 9 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 10 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 11 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 12 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 13 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 14 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 15 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 16 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 17 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 18 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 19 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 20 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 21 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 22 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 23 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 24 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 25 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 26 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 27 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 28 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 29 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 30 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Enabler #\, 31 #\) #\;
|#

; #endif /* ! _IOKIT_IOPCCARD16ENABER_H */


(provide-interface "IOPCCard16Enabler")
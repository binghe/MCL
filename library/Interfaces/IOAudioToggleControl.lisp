(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOAudioToggleControl.h"
...
;  
#|
 confused about CLASS IOAudioToggleControl #\: public IOAudioControl #\{ OSDeclareDefaultStructors #\( IOAudioToggleControl #\) protected #\: struct ExpansionData #\{ #\} #\; ExpansionData * reserved #\;;  New code added here
 public #\:
; !
...
;      * @result Returns a newly allocated and initialized mute IOAudioControl
;      
 static IOAudioToggleControl * create #\( bool initialValue #\, UInt32 channelID #\, const char * channelName = 0 #\, UInt32 cntrlID = 0 #\, UInt32 subType = 0 #\, UInt32 usage = 0 #\) #\; static IOAudioToggleControl * createMuteControl #\( bool initialValue #\, UInt32 channelID #\, const char * channelName = 0 #\, UInt32 cntrlID = 0 #\, UInt32 usage = 0 #\) #\;
; !
;      * @function init
...
(provide-interface "IOAudioToggleControl")
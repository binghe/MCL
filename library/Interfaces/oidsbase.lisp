(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:oidsbase.h"
...
(defconstant $INTEL_CERT_AND_PRIVATE_KEY_2_0_LENGTH 11)
...
(defconstant $OID_ISO_STANDARD 40)
; #define OID_ISO_STANDARD      	 			40
(defconstant $OID_ISO_MEMBER 42)
; #define OID_ISO_MEMBER         				42                     
; #define OID_US                 				OID_ISO_MEMBER, 134, 72
(defconstant $OID_ISO_IDENTIFIED_ORG 43)
...
(defconstant $OID_ISO_MEMBER_LENGTH 1)
...
;  
(defconstant $NETSCAPE_CERT_EXTEN 96)
; #define NETSCAPE_CERT_EXTEN		0x60, 0x86, 0x48, 0x01, 0x86, 0xf8, 0x42, 0x01
(defconstant $NETSCAPE_CERT_EXTEN_LENGTH 8)

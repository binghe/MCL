(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:WSProtocolHandler.h"
...
(def-mactype :WSProtocolHandlerRef (find-mactype '(:pointer :OpaqueWSProtocolHandlerRef)))
; 
...
(deftrap-inline "_WSProtocolHandlerGetTypeID" 
   (
...
(deftrap-inline "_WSProtocolHandlerCreate" 
   ((allocator (:pointer :__CFAllocator))
    (protocol (:pointer :__CFString))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   (:pointer :OpaqueWSProtocolHandlerRef)
() )
; 
...
(deftrap-inline "_WSProtocolHandlerCopyRequestDictionary" 
   ((ref (:pointer :OpaqueWSProtocolHandlerRef))
...
(deftrap-inline "_WSProtocolHandlerCopyReplyDictionary" 
   ((ref (:pointer :OpaqueWSProtocolHandlerRef))
...
(deftrap-inline "_WSProtocolHandlerCopyReplyDocument" 
   ((ref (:pointer :OpaqueWSProtocolHandlerRef))
    (methodContext (:pointer :__CFDictionary))
    (resultValue (:pointer :void))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   (:pointer :__CFData)
() )
; 
...
(deftrap-inline "_WSProtocolHandlerCopyFaultDocument" 
   ((ref (:pointer :OpaqueWSProtocolHandlerRef))
    (methodContext (:pointer :__CFDictionary))
    (faultDict (:pointer :__CFDictionary))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   (:pointer :__CFData)
() )
; 
...
(deftrap-inline "_WSProtocolHandlerCopyRequestDocument" 
   ((ref (:pointer :OpaqueWSProtocolHandlerRef))
    (methodName (:pointer :__CFString))
    (methodParams (:pointer :__CFDictionary))
    (methodParamOrder (:pointer :__CFArray))
    (methodExtras (:pointer :__CFDictionary))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   (:pointer :__CFData)
() )
; 
...
(deftrap-inline "_WSProtocolHandlerCopyProperty" 
   ((ref (:pointer :OpaqueWSProtocolHandlerRef))
...
(deftrap-inline "_WSProtocolHandlerSetProperty" 
   ((ref (:pointer :OpaqueWSProtocolHandlerRef))
    (propertyName (:pointer :__CFString))
...
(def-mactype :WSProtocolHandlerSerializationProcPtr (find-mactype ':pointer)); (WSProtocolHandlerRef protocol , CFTypeRef obj , void * info)
; 
...
(deftrap-inline "_WSProtocolHandlerSetSerializationOverride" 
   ((protocol (:pointer :OpaqueWSProtocolHandlerRef))
    (objType :UInt32)
...
(def-mactype :WSProtocolHandlerDeserializationProcPtr (find-mactype ':pointer)); (WSProtocolHandlerRef protocol , CFXMLTreeRef msgRoot , CFXMLTreeRef deserializeRoot , void * info)
; 
...
(deftrap-inline "_WSProtocolHandlerSetDeserializationOverride" 
   ((protocol (:pointer :OpaqueWSProtocolHandlerRef))
...
(provide-interface "WSProtocolHandler")
(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOPCCard16Device.h"
; at Sunday July 2,2006 7:29:39 pm.
; 
...
(defconstant $kIOPCCard16DeviceOffState 0)
(defconstant $kIOPCCard16DeviceDozeState 1)
(defconstant $kIOPCCard16DeviceOnState 2)
(defconstant $kIOPCCard16DevicePowerStateCount 3)
...
; 
#|
 confused about CLASS IOPCCard16Device #\: public IOService #\{ OSDeclareDefaultStructors #\( IOPCCard16Device #\) #\; friend class IOPCCardBridge #\; private #\: IOPCCardBridge * bridge #\; u_char socket #\; u_char function #\; dev_info_t bindName #\; client_handle_t handle #\; IOPCCard16Enabler * enabler #\; IOMemoryMap * ioMap #\; struct ExpansionData #\{ #\} #\; ExpansionData * reserved #\; protected #\: virtual bool bindCardServices #\( void #\) #\; virtual bool unbindCardServices #\( void #\) #\; virtual bool matchPropertyTable #\( OSDictionary * table #\, SInt32 * score #\) #\; virtual IOService * matchLocation #\( IOService * client #\) #\; virtual bool finalize #\( IOOptionBits options #\) #\; static int eventHandler #\( cs_event_t event #\, int priority #\, event_callback_args_t * args #\) #\; public #\: virtual bool attach #\( IOService * provider #\) #\; virtual void detach #\( IOService * provider #\) #\; virtual IOReturn setPowerState #\( unsigned long powerState #\, IOService * whatDevice #\) #\; virtual IOReturn setProperties #\( OSObject * properties #\) #\;
; ! @function getState
...
;      *  @result The value read in host byte order (big endian on PPC).
;      
 virtual UInt8 ioRead8 #\( UInt16 offset #\, IOMemoryMap * map = 0 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 0 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 1 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 2 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 3 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 4 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 5 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 6 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 7 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 8 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 9 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 10 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 11 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 12 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 13 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 14 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 15 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 16 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 17 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 18 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 19 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 20 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 21 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 22 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 23 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 24 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 25 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 26 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 27 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 28 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 29 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 30 #\) #\; OSMetaClassDeclareReservedUnused #\( IOPCCard16Device #\, 31 #\) #\;
|#

; #endif /* ! _IOKIT_IOPCCARD16DEVICE_H */


(provide-interface "IOPCCard16Device")
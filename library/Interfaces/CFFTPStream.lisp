(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:CFFTPStream.h"
...
;  
(def-mactype :kCFStreamErrorDomainFTP (find-mactype ':SInt32)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFStreamPropertyFTPUserName (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFStreamPropertyFTPPassword (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFStreamPropertyFTPUsePassiveMode (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFStreamPropertyFTPResourceSize (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFStreamPropertyFTPFetchResourceInfo (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFStreamPropertyFTPFileTransferOffset (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFStreamPropertyFTPAttemptPersistentConnection (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFStreamPropertyFTPProxy (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFStreamPropertyFTPProxyHost (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFStreamPropertyFTPProxyPort (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFStreamPropertyFTPProxyUser (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFStreamPropertyFTPProxyPassword (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFFTPResourceMode (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
;  *  kCFFTPResourceName
;  *  
;  *  Discussion:
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFFTPResourceName (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
;  *  kCFFTPResourceOwner
;  *  
;  *  Discussion:
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFFTPResourceOwner (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
;  *  kCFFTPResourceGroup
;  *  
;  *  Discussion:
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFFTPResourceGroup (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
;  *  kCFFTPResourceLink
;  *  
;  *  Discussion:
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFFTPResourceLink (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
;  *  kCFFTPResourceSize
;  *  
;  *  Discussion:
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFFTPResourceSize (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
;  *  kCFFTPResourceType
;  *  
;  *  Discussion:
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFFTPResourceType (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFFTPResourceModDate (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
(deftrap-inline "_CFReadStreamCreateWithFTPURL" 
   ((alloc (:pointer :__CFAllocator))
    (ftpURL (:pointer :__CFURL))
...
(deftrap-inline "_CFFTPCreateParsedResourceListing" 
   ((alloc (:pointer :__CFAllocator))
    (buffer (:pointer :UInt8))
    (bufferLength :SInt32)
    (parsed (:pointer :CFDICTIONARYREF))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :SInt32
() )
; 
...
(deftrap-inline "_CFWriteStreamCreateWithFTPURL" 
   ((alloc (:pointer :__CFAllocator))
    (ftpURL (:pointer :__CFURL))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER

(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:HITextUtils.h"
...
(deftrap-inline "_GetTextAndEncodingFromCFString" 
   ((inString (:pointer :__CFString))
    (outText (:pointer :UInt8))
    (inTextMaxLength :UInt32)
    (outTextLength (:pointer :ByteCount))
    (outEncoding (:pointer :TEXTENCODING))      ;  can be NULL 

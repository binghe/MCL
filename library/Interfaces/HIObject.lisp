(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:HIObject.h"
...
(require-interface "HIToolbox/CarbonEventsCore")
...
(def-mactype :HIObjectClassRef (find-mactype '(:pointer :OpaqueHIObjectClassRef)))

(def-mactype :HIObjectRef (find-mactype '(:pointer :OpaqueHIObjectRef)))
; 
;  *  Discussion:
;  *    HIObject errors
;  
...
(defconstant $hiObjectClassExistsErr -22080)
; 
...
(defconstant $hiObjectClassHasInstancesErr -22081)
(defconstant $hiObjectClassHasSubclassesErr -22082)
; 
...
(defconstant $hiObjectClassIsAbstractErr -22083)
; 
;  
; 
...
(defconstant $kEventClassHIObject :|hiob|)

(defconstant $kEventParamHIObjectInstance :|hioi|)
(defconstant $typeHIObjectRef :|hiob|)
; 
...
(defconstant $kEventHIObjectConstruct 1)
; 
...
(defconstant $kEventHIObjectInitialize 2)
; 
...
(defconstant $kEventHIObjectDestruct 3)
; 
...
(defconstant $kEventHIObjectIsEqual 4)
; 
...
(defconstant $kEventHIObjectPrintDebugInfo 5)
; 
...
(deftrap-inline "_HIObjectRegisterSubclass" 
   ((inClassID (:pointer :__CFString))
    (inBaseClassID (:pointer :__CFString))
    (inOptions :UInt32)
    (inConstructProc (:pointer :OpaqueEventHandlerProcPtr));  can be NULL 
    (inNumEvents :UInt32)
    (inEventList (:pointer :EventTypeSpec))
    (inConstructData :pointer)
    (outClassRef (:pointer :HIOBJECTCLASSREF))  ;  can be NULL 
...
(deftrap-inline "_HIObjectUnregisterClass" 
   ((inClassRef (:pointer :OpaqueHIObjectClassRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HIObjectCreate" 
   ((inClassID (:pointer :__CFString))
    (inConstructData (:pointer :OpaqueEventRef))
    (outObject (:pointer :HIOBJECTREF))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HIObjectGetEventTarget" 
   ((inObject (:pointer :OpaqueHIObjectRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
...
(deftrap-inline "_HIObjectPrintDebugInfo" 
   ((inObject (:pointer :OpaqueHIObjectRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   nil
() )
...
(deftrap-inline "_HIObjectCopyClassID" 
   ((inObject (:pointer :OpaqueHIObjectRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :__CFString)
() )
...
(deftrap-inline "_HIObjectIsOfClass" 
   ((inObject (:pointer :OpaqueHIObjectRef))
    (inObjectClassID (:pointer :__CFString))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :Boolean
() )
; 
...
(deftrap-inline "_HIObjectDynamicCast" 
   ((inObject (:pointer :OpaqueHIObjectRef))
    (inClassID (:pointer :__CFString))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :void)
...
(deftrap-inline "_HIObjectCreateFromBundle" 
...
(deftrap-inline "_HIObjectIsAccessibilityIgnored" 
   ((inObject (:pointer :OpaqueHIObjectRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :Boolean
() )
...
(deftrap-inline "_HIObjectSetAccessibilityIgnored" 
   ((inObject (:pointer :OpaqueHIObjectRef))
    (inIgnored :Boolean)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus

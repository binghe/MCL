(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:SKAnalysis.h"
...
;  
(def-mactype :kSKLanguageTypes (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
;  *  kSKMinTermLength
;  *  
;  *  Summary:
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kSKMinTermLength (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
;  *  kSKSubstitutions
;  *  
;  *  Summary:
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kSKSubstitutions (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
;  *  kSKStopWords
;  *  
;  *  Summary:
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kSKStopWords (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER

; #endif /* __SKANALYSIS__ */


(provide-interface "SKAnalysis")
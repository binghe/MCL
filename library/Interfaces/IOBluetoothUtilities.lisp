(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOBluetoothUtilities.h"
...
(require-interface "sysexits")

(require-interface "sys/errno")

(require-interface "unistd")
...
(deftrap-inline "_IOBluetoothNSStringToDeviceAddress" 
   ((inNameString (:pointer :NSString))
    (outDeviceAddress (:pointer :BLUETOOTHDEVICEADDRESS))
   )
   :signed-long
() )
; ---------------------------------------------------------------------------------------------------------------------------
...
(deftrap-inline "_IOBluetoothIsFileAppleDesignatedPIMData" 
   ((inFileName (:pointer :NSString))
   )
   :Boolean
() )
; ---------------------------------------------------------------------------------------------------------------------------
...
(deftrap-inline "_IOBluetoothPackData" 
   ((ioBuffer :pointer)
    (inFormat (:pointer :char))
#| |...|  ;; What should this do?
    |#
   )
   :SInt32
...
(deftrap-inline "_IOBluetoothPackDataList" 
   ((ioBuffer :pointer)
    (inFormat (:pointer :char))
    (inArgs (:pointer :void))
   )
...
(deftrap-inline "_IOBluetoothUnpackData" 
   ((inBufferSize :UInt32)
    (inBuffer :pointer)
    (inFormat (:pointer :char))
#| |...|  ;; What should this do?
...
(deftrap-inline "_IOBluetoothUnpackDataList" 
   ((inBufferSize :UInt32)
    (inBuffer :pointer)
    (inFormat (:pointer :char))
    (inArgs (:pointer :void))
...
(deftrap-inline "_IOBluetoothNumberOfAvailableHIDDevices" 
   ((ARG2 (:NIL :NIL))
   )                                            ; AVAILABLE_BLUETOOTH_VERSION_1_3_AND_LATER
   :signed-long
() )

(deftrap-inline "_IOBluetoothNumberOfPointingHIDDevices" 
   ((ARG2 (:NIL :NIL))
   )                                            ; AVAILABLE_BLUETOOTH_VERSION_1_3_AND_LATER
   :signed-long
() )

(deftrap-inline "_IOBluetoothNumberOfKeyboardHIDDevices" 
   ((ARG2 (:NIL :NIL))
   )                                            ; AVAILABLE_BLUETOOTH_VERSION_1_3_AND_LATER
   :signed-long
() )

(deftrap-inline "_IOBluetoothNumberOfTabletHIDDevices" 
   ((ARG2 (:NIL :NIL))
   )                                            ; AVAILABLE_BLUETOOTH_VERSION_1_3_AND_LATER
   :signed-long
() )

(deftrap-inline "_IOBluetoothFindNumberOfRegistryEntriesOfClassName" 
   ((deviceType (:pointer :char))
   )                                            ; AVAILABLE_BLUETOOTH_VERSION_1_3_AND_LATER
   :signed-long
() )
; #ifdef	__cplusplus
...
(provide-interface "IOBluetoothUtilities")
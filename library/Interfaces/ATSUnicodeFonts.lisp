(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:ATSUnicodeFonts.h"
; at Sunday July 2,2006 7:24:35 pm.
; 
...
(deftrap-inline "_ATSUSetFontFeatures" 
   ((iStyle (:pointer :OpaqueATSUStyle))
    (iFeatureCount :UInt32)
    (iType (:pointer :ATSUFONTFEATURETYPE))
    (iSelector (:pointer :ATSUFONTFEATURESELECTOR))
...
(deftrap-inline "_ATSUGetFontFeature" 
   ((iStyle (:pointer :OpaqueATSUStyle))
    (iFeatureIndex :UInt32)
    (oFeatureType (:pointer :ATSUFONTFEATURETYPE))
    (oFeatureSelector (:pointer :ATSUFONTFEATURESELECTOR))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUGetAllFontFeatures" 
   ((iStyle (:pointer :OpaqueATSUStyle))
    (iMaximumFeatureCount :UInt32)
    (oFeatureType (:pointer :ATSUFONTFEATURETYPE));  can be NULL 
    (oFeatureSelector (:pointer :ATSUFONTFEATURESELECTOR));  can be NULL 
    (oActualFeatureCount (:pointer :ItemCount)) ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUClearFontFeatures" 
   ((iStyle (:pointer :OpaqueATSUStyle))
    (iFeatureCount :UInt32)
    (iType (:pointer :ATSUFONTFEATURETYPE))     ;  can be NULL 
    (iSelector (:pointer :ATSUFONTFEATURESELECTOR));  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
;  ---------------------------------------------------------------------------- 
...
(deftrap-inline "_ATSUSetVariations" 
   ((iStyle (:pointer :OpaqueATSUStyle))
    (iVariationCount :UInt32)
    (iAxes (:pointer :ATSUFONTVARIATIONAXIS))
    (iValue (:pointer :ATSUFONTVARIATIONVALUE))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUGetFontVariationValue" 
   ((iStyle (:pointer :OpaqueATSUStyle))
    (iFontVariationAxis :FourCharCode)
    (oFontVariationValue (:pointer :ATSUFONTVARIATIONVALUE))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUGetAllFontVariations" 
   ((iStyle (:pointer :OpaqueATSUStyle))
    (iVariationCount :UInt32)
    (oVariationAxes (:pointer :ATSUFONTVARIATIONAXIS));  can be NULL 
    (oFontVariationValues (:pointer :ATSUFONTVARIATIONVALUE));  can be NULL 
    (oActualVariationCount (:pointer :ItemCount));  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUClearFontVariations" 
   ((iStyle (:pointer :OpaqueATSUStyle))
    (iAxisCount :UInt32)
    (iAxis (:pointer :ATSUFONTVARIATIONAXIS))   ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
;  ---------------------------------------------------------------------------- 
...
(deftrap-inline "_ATSUFontCount" 
   ((oFontCount (:pointer :ItemCount))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUGetFontIDs" 
   ((oFontIDs (:pointer :ATSUFONTID))
    (iArraySize :UInt32)
    (oFontCount (:pointer :ItemCount))          ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUFONDtoFontID" 
   ((iFONDNumber :SInt16)
    (iFONDStyle :UInt8)
...
(deftrap-inline "_ATSUFontIDtoFOND" 
   ((iFontID :UInt32)
    (oFONDNumber (:pointer :short))
    (oFONDStyle (:pointer :Style))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
;  ---------------------------------------------------------------------------- 
...
(deftrap-inline "_ATSUCountFontNames" 
   ((iFontID :UInt32)
    (oFontNameCount (:pointer :ItemCount))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUGetIndFontName" 
   ((iFontID :UInt32)
...
(deftrap-inline "_ATSUFindFontName" 
   ((iFontID :UInt32)
...
(deftrap-inline "_ATSUFindFontFromName" 
   ((iName :pointer)
    (iNameLength :UInt32)
    (iFontNameCode :UInt32)
    (iFontNamePlatform :UInt32)
...
(deftrap-inline "_ATSUCountFontFeatureTypes" 
   ((iFontID :UInt32)
    (oTypeCount (:pointer :ItemCount))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUCountFontFeatureSelectors" 
   ((iFontID :UInt32)
    (iType :UInt16)
    (oSelectorCount (:pointer :ItemCount))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUGetFontFeatureTypes" 
   ((iFontID :UInt32)
    (iMaximumTypes :UInt32)
    (oTypes (:pointer :ATSUFONTFEATURETYPE))    ;  can be NULL 
    (oActualTypeCount (:pointer :ItemCount))    ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUGetFontFeatureSelectors" 
   ((iFontID :UInt32)
    (iType :UInt16)
    (iMaximumSelectors :UInt32)
    (oSelectors (:pointer :ATSUFONTFEATURESELECTOR));  can be NULL 
    (oSelectorIsOnByDefault (:pointer :Boolean));  can be NULL 
    (oActualSelectorCount (:pointer :ItemCount));  can be NULL 
    (oIsMutuallyExclusive (:pointer :Boolean))  ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUGetFontFeatureNameCode" 
   ((iFontID :UInt32)
    (iType :UInt16)
    (iSelector :UInt16)
    (oNameCode (:pointer :FONTNAMECODE))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
;  ---------------------------------------------------------------------------- 
...
(deftrap-inline "_ATSUCountFontTracking" 
   ((iFontID :UInt32)
    (iCharacterOrientation :UInt16)
    (oTrackingCount (:pointer :ItemCount))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUGetIndFontTracking" 
   ((iFontID :UInt32)
    (iCharacterOrientation :UInt16)
    (iTrackIndex :UInt32)
    (oFontTrackingValue (:pointer :Fixed))
    (oNameCode (:pointer :FONTNAMECODE))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_ATSUCountFontVariations" 
   ((iFontID :UInt32)
    (oVariationCount (:pointer :ItemCount))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUGetIndFontVariation" 
   ((iFontID :UInt32)
    (iVariationIndex :UInt32)
    (oATSUFontVariationAxis (:pointer :ATSUFONTVARIATIONAXIS));  can be NULL 
    (oMinimumValue (:pointer :ATSUFONTVARIATIONVALUE));  can be NULL 
    (oMaximumValue (:pointer :ATSUFONTVARIATIONVALUE));  can be NULL 
    (oDefaultValue (:pointer :ATSUFONTVARIATIONVALUE));  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUGetFontVariationNameCode" 
   ((iFontID :UInt32)
    (iAxis :FourCharCode)
    (oNameCode (:pointer :FONTNAMECODE))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
...
(deftrap-inline "_ATSUCountFontInstances" 
   ((iFontID :UInt32)
    (oInstances (:pointer :ItemCount))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUGetFontInstance" 
   ((iFontID :UInt32)
    (iFontInstanceIndex :UInt32)
    (iMaximumVariations :UInt32)
    (oAxes (:pointer :ATSUFONTVARIATIONAXIS))   ;  can be NULL 
    (oValues (:pointer :ATSUFONTVARIATIONVALUE));  can be NULL 
    (oActualVariationCount (:pointer :ItemCount))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUGetFontInstanceNameCode" 
   ((iFontID :UInt32)
    (iInstanceIndex :UInt32)
    (oNameCode (:pointer :FONTNAMECODE))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
...
(provide-interface "ATSUnicodeFonts")
(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:error.h"
...
(defconstant $err_max_system 63)
; #define	err_max_system		0x3f
; 	unix errors get lumped into one subsystem  
; #define	unix_err(errno)		(err_kern|err_sub(3)|errno)

(def-mactype :mach_error_t (find-mactype ':signed-long))

(def-mactype :mach_error_fn_t (find-mactype ':pointer)); (void)

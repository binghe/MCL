(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:host_reboot.h"
...
;  * $EndLog$
;  
(defconstant $HOST_REBOOT_HALT 8)
; #define HOST_REBOOT_HALT	0x8
(defconstant $HOST_REBOOT_DEBUGGER 4096)
; #define	HOST_REBOOT_DEBUGGER	0x1000

(provide-interface "host_reboot")
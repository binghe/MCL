(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:QuickTimeMusic.k.h"
...
#| #|
	#ifndefQTMIDI_GLOBALS
		#define QTMIDI_GLOBALS() 
		#define ADD_QTMIDI_COMMA 
	#else		#define ADD_QTMIDI_COMMA ,
	#endif	#define QTMIDI_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define QTMIDI_STRCAT(a,b) QTMIDI_GLUE(a,b)
...
#| #|
	...
	#else		#define ADD_MUSIC_COMMA ,
	#endif	#define MUSIC_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define MUSIC_STRCAT(a,b) MUSIC_GLUE(a,b)
...
#| #|
		...
		#define NA_GLOBALS() 
		#define ADD_NA_COMMA 
	#else		#define ADD_NA_COMMA ,
	#endif	#define NA_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define NA_STRCAT(a,b) NA_GLUE(a,b)
...
#| #|
	...
	#else		#define ADD_TUNE_COMMA ,
	#endif	#define TUNE_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define TUNE_STRCAT(a,b) TUNE_GLUE(a,b)
...
(provide-interface "QuickTimeMusic.k")
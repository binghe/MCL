(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:vm_types.h"
...
(def-mactype :natural_t (find-mactype ':UInt32))
; 
...
(def-mactype :integer_t (find-mactype ':signed-long))
; 
;  * A vm_offset_t is a type-neutral pointer,
;  * e.g. an offset into a virtual memory space.
;  

(def-mactype :vm_offset_t (find-mactype ':UInt32))
; 
...
(def-mactype :vm_size_t (find-mactype ':UInt32))

(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:task_special_ports.h"
...
(def-mactype :task_special_port_t (find-mactype ':signed-long))
(defconstant $TASK_KERNEL_PORT 1)
; #define TASK_KERNEL_PORT	1	/* Represents task to the outside
(defconstant $TASK_HOST_PORT 2)
; #define TASK_HOST_PORT		2	/* The host (priv) port for task.  */
(defconstant $TASK_BOOTSTRAP_PORT 4)
...
(provide-interface "task_special_ports")
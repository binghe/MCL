(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IODataQueue.h"
...
(def-mactype :IODataQueueMemory (find-mactype ':_IODataQueueMemory))

#|class IOMemoryDescriptor;
|#
(defrecord _notifyMsg
   (h :MACH_MSG_HEADER_T)
)
; !
...
;  
#|
 confused about CLASS IODataQueue #\: public OSObject #\{ OSDeclareDefaultStructors #\( IODataQueue #\) protected #\: IODataQueueMemory * dataQueue #\; void * notifyMsg #\; virtual void free #\( #\) #\;
; !
...
;      
 virtual void sendDataAvailableNotification #\( #\) #\; public #\:
; !

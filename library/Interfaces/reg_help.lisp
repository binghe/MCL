(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:reg_help.h"
...
;  * macro (below).
;  
; #define	REG_PAIR_DEF(type0, name0, type1, name1)			struct {								type0	name0 __attribute__(( aligned(8) ));			type1	name1;						} name0##_##name1
; 

(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:vm_shared_memory_server.h"
...
#include <machshared_memory_server.h>
...
#define SHARED_REGION_SYSTEM	0x1 #define SHARED_REGION_FULL	0x2 #define SHARED_REGION_STALE 	0x4 
...
#include <kernqueue.h>
#include <vmvm_object.h>
#include <vmmemory_object.h>
...
(provide-interface "vm_shared_memory_server")
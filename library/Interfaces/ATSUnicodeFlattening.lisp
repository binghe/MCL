(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:ATSUnicodeFlattening.h"
...
(def-mactype :ATSUFlattenedDataStreamFormat (find-mactype ':UInt32))

(defconstant $kATSUDataStreamUnicodeStyledText :|ustl|)
; 
...
(def-mactype :ATSUFlattenStyleRunOptions (find-mactype ':UInt32))

(defconstant $kATSUFlattenOptionNoOptionsMask 0)
; 
...
(def-mactype :ATSUUnFlattenStyleRunOptions (find-mactype ':UInt32))

(defconstant $kATSUUnFlattenOptionNoOptionsMask 0)
;  ---------------------------------------------------------------------------- 
;  Data Types                                                                   
;  ---------------------------------------------------------------------------- 
; 
...
; 
(defrecord ATSUStyleRunInfo
   (runLength :UInt32)
   (styleObjectIndex :UInt32)
)

;type name? (%define-record :ATSUStyleRunInfo (find-record-descriptor ':ATSUStyleRunInfo))
;  ---------------------------------------------------------------------------- 
...
(defconstant $kATSFlatDataUstlVersion0 0)
(defconstant $kATSFlatDataUstlVersion1 1)
(defconstant $kATSFlatDataUstlVersion2 2)
(defconstant $kATSFlatDataUstlCurrentVersion 2)
;  ------------------ 
;  Block 1 Structures 
;  ------------------ 
; 
...
; 
(defrecord ATSFlatDataMainHeaderBlock
...
;type name? (%define-record :ATSFlatDataMainHeaderBlock (find-record-descriptor ':ATSFlatDataMainHeaderBlock))
;  ------------------ 
;  Block 2 Structures 
;  ------------------ 
; 
...
; 
(defrecord ATSFlatDataTextLayoutDataHeader
...
;type name? (%define-record :ATSFlatDataTextLayoutDataHeader (find-record-descriptor ':ATSFlatDataTextLayoutDataHeader))
; 
...
; 
(defrecord ATSFlatDataTextLayoutHeader
...
;type name? (%define-record :ATSFlatDataTextLayoutHeader (find-record-descriptor ':ATSFlatDataTextLayoutHeader))
; 
...
; 
(defrecord ATSFlatDataLayoutControlsDataHeader
...
;type name? (%define-record :ATSFlatDataLayoutControlsDataHeader (find-record-descriptor ':ATSFlatDataLayoutControlsDataHeader))
(defrecord ATSFlatDataLineInfoData
...
;type name? (%define-record :ATSFlatDataLineInfoData (find-record-descriptor ':ATSFlatDataLineInfoData))
; 
...
; 
(defrecord ATSFlatDataLineInfoHeader
...
;type name? (%define-record :ATSFlatDataLineInfoHeader (find-record-descriptor ':ATSFlatDataLineInfoHeader))
;  ------------------ 
;  Block 3 Structures 
;  ------------------ 
; 
...
; 
(defrecord ATSFlatDataStyleRunDataHeader
...
;type name? (%define-record :ATSFlatDataStyleRunDataHeader (find-record-descriptor ':ATSFlatDataStyleRunDataHeader))
;  ------------------ 
;  Block 4 Structures 
;  ------------------ 
; 
...
;    object. 
; 
(defrecord ATSFlatDataStyleListStyleDataHeader
...
;type name? (%define-record :ATSFlatDataStyleListStyleDataHeader (find-record-descriptor ':ATSFlatDataStyleListStyleDataHeader))
; 
...
;    block 1.
; 
(defrecord ATSFlatDataStyleListHeader
...
;type name? (%define-record :ATSFlatDataStyleListHeader (find-record-descriptor ':ATSFlatDataStyleListHeader))
; 
...
; 
(defrecord ATSFlatDataStyleListFeatureData
...
;type name? (%define-record :ATSFlatDataStyleListFeatureData (find-record-descriptor ':ATSFlatDataStyleListFeatureData))
; 
...
; 
(defrecord ATSFlatDataStyleListVariationData
                                                ;  the variation axis
   (theVariationAxis :FourCharCode)
                                                ;  the variation value
   (theVariationValue :signed-long)
)

;type name? (%define-record :ATSFlatDataStyleListVariationData (find-record-descriptor ':ATSFlatDataStyleListVariationData))
;  ------------------------ 
...
(def-mactype :ATSFlatDataFontSpeciferType (find-mactype ':UInt32))
...
(defconstant $kATSFlattenedFontSpecifierRawNameData :|namd|)
; 
...
;    nameSpecType. 
; 
(defrecord ATSFlatDataFontNameDataHeader
...
;type name? (%define-record :ATSFlatDataFontNameDataHeader (find-record-descriptor ':ATSFlatDataFontNameDataHeader))
; 
...
(defrecord ATSFlatDataFontSpecRawNameData
...
;type name? (%define-record :ATSFlatDataFontSpecRawNameData (find-record-descriptor ':ATSFlatDataFontSpecRawNameData))
; 
...
;    these. 
; 
(defrecord ATSFlatDataFontSpecRawNameDataHeader
...
;type name? (%define-record :ATSFlatDataFontSpecRawNameDataHeader (find-record-descriptor ':ATSFlatDataFontSpecRawNameDataHeader))
;  ---------------------------------------------------------------------------- 
...
(deftrap-inline "_ATSUFlattenStyleRunsToStream" 
   ((iStreamFormat :UInt32)
    (iFlattenOptions :UInt32)
    (iNumberOfRunInfo :UInt32)
    (iRunInfoArray (:pointer :ATSUStyleRunInfo))
    (iNumberOfStyleObjects :UInt32)
    (iStyleArray (:pointer :ATSUSTYLE))
    (iStreamBufferSize :UInt32)
    (oStreamBuffer :pointer)
    (oActualStreamBufferSize (:pointer :ByteCount))
...
(deftrap-inline "_ATSUUnflattenStyleRunsFromStream" 
   ((iStreamFormat :UInt32)
    (iUnflattenOptions :UInt32)
    (iStreamBufferSize :UInt32)
    (iStreamBuffer :pointer)
    (iNumberOfRunInfo :UInt32)
    (iNumberOfStyleObjects :UInt32)
    (oRunInfoArray (:pointer :ATSUStyleRunInfo))
    (oStyleArray (:pointer :ATSUSTYLE))
    (oActualNumberOfRunInfo (:pointer :ItemCount))
    (oActualNumberOfStyleObjects (:pointer :ItemCount))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_ATSUCopyToHandle" 
...
(deftrap-inline "_ATSUPasteFromHandle" 
   ((iStyle (:pointer :OpaqueATSUStyle))
    (iStyleHandle :Handle)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
...
(provide-interface "ATSUnicodeFlattening")
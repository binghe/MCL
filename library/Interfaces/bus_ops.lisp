(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:bus_ops.h"
...
; #ifdef __MACOSX__
#| #|
#include <IOKitpccardconfig.h>
|#
 |#

; #else

(require-interface "linux/config")

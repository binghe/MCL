(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOStorageDeviceCharacteristics.h"
...
(require-interface "IOKit/storage/IOStorageProtocolCharacteristics")
; 
...
; </pre>
; 
(defconstant $kIOPropertyDeviceCharacteristicsKey "Device Characteristics")
...
; </pre>
; 
(defconstant $kIOPropertyVendorNameKey "Vendor Name")
...
; </pre>
; 
(defconstant $kIOPropertyProductNameKey "Product Name")
...
; </pre>
; 
(defconstant $kIOPropertyProductRevisionLevelKey "Product Revision Level")
; #define kIOPropertyProductRevisionLevelKey			"Product Revision Level"

; #endif	/* _IOKIT_IO_STORAGE_DEVICE_CHARACTERISTICS_H_ */


(provide-interface "IOStorageDeviceCharacteristics")
(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IORangeAllocator.h"
...
(def-mactype :IORangeScalar (find-mactype ':UInt32))
...
#|
 confused about CLASS IORangeAllocator #\: public OSObject #\{ OSDeclareDefaultStructors #\( IORangeAllocator #\) protected #\: UInt32 numElements #\; UInt32 capacity #\; UInt32 capacityIncrement #\; IORangeScalar defaultAlignmentMask #\; IOOptionBits options #\; struct IORangeAllocatorElement * elements #\; private #\: virtual bool allocElement #\( UInt32 index #\) #\; virtual void deallocElement #\( UInt32 index #\) #\; public #\: enum #\{ kLocking = 0x00000001 #\} #\;
; ! @function init
...
;     @result Returns the new IORangeAllocator instance, to be released by the caller, or zero on failure. 
 static IORangeAllocator * withRange #\( IORangeScalar endOfRange #\, IORangeScalar defaultAlignment = 0 #\, UInt32 capacity = 0 #\, IOOptionBits options = 0 #\) #\; virtual void free #\( #\) #\; virtual bool serialize #\( OSSerialize * s #\) const #\;
...
(provide-interface "IORangeAllocator")
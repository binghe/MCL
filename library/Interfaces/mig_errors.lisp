(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:mig_errors.h"
; at Sunday July 2,2006 7:25:47 pm.
; 
...
; #endif
 ...
 __inline__ void __NDR_convert__mig_reply_error_t #\( mig_reply_error_t * x #\) #\{
; #if defined(__NDR_convert__int_rep__kern_return_t__defined)
 if #\( x - > NDR.int_rep ! = NDR_record.int_rep #\) __NDR_convert__int_rep__kern_return_t #\( &x - > RetCode #\, x - > NDR.int_rep #\) #\;

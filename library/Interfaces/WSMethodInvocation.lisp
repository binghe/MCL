(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:WSMethodInvocation.h"
...
; 
(def-mactype :kWSMethodInvocationResult (find-mactype ':CFStringRef))
; 
;     Dictionary entries if the result is a fault
; 
(def-mactype :kWSFaultString (find-mactype ':CFStringRef))
;  a CFString 
(def-mactype :kWSFaultCode (find-mactype ':CFStringRef))
;  a CFNumber 
(def-mactype :kWSFaultExtra (find-mactype ':CFStringRef))
...
;     error numbers mean.
; 
(def-mactype :kWSNetworkStreamFaultString (find-mactype ':CFStringRef))
(def-mactype :kWSStreamErrorMessage (find-mactype ':CFStringRef))
;  A CFString (for debug purposes only) 
(def-mactype :kWSStreamErrorDomain (find-mactype ':CFStringRef))
;  A CFNumberRef 
(def-mactype :kWSStreamErrorError (find-mactype ':CFStringRef))
;  A CFNumberRef 
;  
...
; 
(def-mactype :kWSHTTPMessage (find-mactype ':CFStringRef))
;  CFHTTPMessageRef 
(def-mactype :kWSHTTPResponseMessage (find-mactype ':CFStringRef))
;  CFHTTPMessageRef 
; 
...
; 
(def-mactype :kWSHTTPVersion (find-mactype ':CFStringRef))
;  "http/1.1" 
(def-mactype :kWSHTTPExtraHeaders (find-mactype ':CFStringRef))
;  a CFDictionary of { key (CFString), val (CFString) } pairs 
(def-mactype :kWSHTTPProxy (find-mactype ':CFStringRef))
;  CFURfRefL 
(def-mactype :kWSHTTPFollowsRedirects (find-mactype ':CFStringRef))
;  kCFBooleanFalse 
;  
...
;     dictionary.
; 
(def-mactype :kWSDebugOutgoingHeaders (find-mactype ':CFStringRef))
;  kCFBooleanFalse 
(def-mactype :kWSDebugOutgoingBody (find-mactype ':CFStringRef))
;  kCFBooleanFalse 
(def-mactype :kWSDebugIncomingHeaders (find-mactype ':CFStringRef))
;  kCFBooleanFalse 
(def-mactype :kWSDebugIncomingBody (find-mactype ':CFStringRef))
;  kCFBooleanFalse 
; 
...
; 
(def-mactype :kWSSOAPMethodNamespaceURI (find-mactype ':CFStringRef))
;  CFStringRef 
(def-mactype :kWSSOAPBodyEncodingStyle (find-mactype ':CFStringRef))
;  CFStringRef { kWSSOAPStyleDoc, kWSSOAPStyleRPC } 
(def-mactype :kWSSOAPStyleDoc (find-mactype ':CFStringRef))
(def-mactype :kWSSOAPStyleRPC (find-mactype ':CFStringRef))
; 
...
;     message.
; 
(def-mactype :kWSSOAPMessageHeaders (find-mactype ':CFStringRef))
;  CFArrayRef 
;  
;     When serializing a record (dictionary) these keys present in
;     the dictionary can modify the behavior of the serialization.
; 
(def-mactype :kWSRecordParameterOrder (find-mactype ':CFStringRef))
;  CFArrayRef of CFStringRef 
(def-mactype :kWSRecordNamespaceURI (find-mactype ':CFStringRef))
;  CFStringRef 
(def-mactype :kWSRecordType (find-mactype ':CFStringRef))
;  CFStringRef 
; 
...
; 
(def-mactype :kWSMethodInvocationResultParameterName (find-mactype ':CFStringRef))
;  
...
; 
(def-mactype :kWSMethodInvocationTimeoutValue (find-mactype ':CFStringRef))
...
(def-mactype :WSMethodInvocationRef (find-mactype '(:pointer :OpaqueWSMethodInvocationRef)))
; 
...
(deftrap-inline "_WSMethodInvocationGetTypeID" 
   (
...
(deftrap-inline "_WSMethodInvocationCreate" 
   ((url (:pointer :__CFURL))
    (methodName (:pointer :__CFString))
    (protocol (:pointer :__CFString))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :OpaqueWSMethodInvocationRef)
() )
; 
...
(deftrap-inline "_WSMethodInvocationCreateFromSerialization" 
   ((contract (:pointer :__CFData))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :OpaqueWSMethodInvocationRef)
() )
; 
...
(deftrap-inline "_WSMethodInvocationCopySerialization" 
   ((invocation (:pointer :OpaqueWSMethodInvocationRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :__CFData)
() )
; 
...
(deftrap-inline "_WSMethodInvocationSetParameters" 
   ((invocation (:pointer :OpaqueWSMethodInvocationRef))
    (parameters (:pointer :__CFDictionary))
    (parameterOrder (:pointer :__CFArray))      ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   nil
() )
; 
...
(deftrap-inline "_WSMethodInvocationCopyParameters" 
   ((invocation (:pointer :OpaqueWSMethodInvocationRef))
    (parameterOrder (:pointer :CFARRAYREF))     ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
...
(deftrap-inline "_WSMethodInvocationSetProperty" 
   ((invocation (:pointer :OpaqueWSMethodInvocationRef))
...
(deftrap-inline "_WSMethodInvocationCopyProperty" 
   ((invocation (:pointer :OpaqueWSMethodInvocationRef))
    (propertyName (:pointer :__CFString))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :void)
...
(deftrap-inline "_WSMethodInvocationInvoke" 
   ((invocation (:pointer :OpaqueWSMethodInvocationRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :__CFDictionary)
() )
...
(def-mactype :WSMethodInvocationCallBackProcPtr (find-mactype ':pointer)); (WSMethodInvocationRef invocation , void * info , CFDictionaryRef outRef)
; 
...
(deftrap-inline "_WSMethodInvocationSetCallBack" 
   ((invocation (:pointer :OpaqueWSMethodInvocationRef))
    (clientCB :pointer)
...
(deftrap-inline "_WSMethodInvocationScheduleWithRunLoop" 
   ((invocation (:pointer :OpaqueWSMethodInvocationRef))
...
(deftrap-inline "_WSMethodInvocationUnscheduleFromRunLoop" 
   ((invocation (:pointer :OpaqueWSMethodInvocationRef))
    (runLoop (:pointer :__CFRunLoop))
    (runLoopMode (:pointer :__CFString))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
...
(deftrap-inline "_WSMethodResultIsFault" 
   ((methodResult (:pointer :__CFDictionary))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :Boolean
() )
; 
...
(def-mactype :WSMethodInvocationSerializationProcPtr (find-mactype ':pointer)); (WSMethodInvocationRef invocation , CFTypeRef obj , void * info)
; 
...
(deftrap-inline "_WSMethodInvocationAddSerializationOverride" 
   ((invocation (:pointer :OpaqueWSMethodInvocationRef))
    (objType :UInt32)
    (serializationProc :pointer)
    (context (:pointer :WSClientContext))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   nil
() )
...
(def-mactype :WSMethodInvocationDeserializationProcPtr (find-mactype ':pointer)); (WSMethodInvocationRef invocation , CFXMLTreeRef msgRoot , CFXMLTreeRef deserializeRoot , void * info)
; 
...
(deftrap-inline "_WSMethodInvocationAddDeserializationOverride" 
   ((invocation (:pointer :OpaqueWSMethodInvocationRef))
    (typeNamespace (:pointer :__CFString))
    (typeName (:pointer :__CFString))
    (deserializationProc :pointer)
    (context (:pointer :WSClientContext))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   nil
() )
...
(provide-interface "WSMethodInvocation")
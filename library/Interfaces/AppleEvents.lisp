(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:AppleEvents.h"
...
(defconstant $keyProcessSerialNumber :|psn |)   ;  Keywords for special handlers 
...
(defconstant $kAEShowPreferences :|pref|)       ;  sent by Mac OS X when the user chooses the Preferences item 
...
(defconstant $kAENotifyRecording :|recr|)       ;  available only in vers 1.0.1 and greater 
...
(def-mactype :AEEventSource (find-mactype ':SInt8))
...
(deftrap-inline "_AEInstallEventHandler" 
   ((theAEEventClass :FourCharCode)
    (theAEEventID :FourCharCode)
    (handler (:pointer :OpaqueAEEventHandlerProcPtr))
...
(deftrap-inline "_AERemoveEventHandler" 
   ((theAEEventClass :FourCharCode)
    (theAEEventID :FourCharCode)
    (handler (:pointer :OpaqueAEEventHandlerProcPtr))
    (isSysHandler :Boolean)
...
(deftrap-inline "_AEGetEventHandler" 
   ((theAEEventClass :FourCharCode)
    (theAEEventID :FourCharCode)
...
(deftrap-inline "_AEInstallSpecialHandler" 
   ((functionClass :FourCharCode)
    (handler (:pointer :OpaqueAEEventHandlerProcPtr))
    (isSysHandler :Boolean)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSErr
...
(deftrap-inline "_AERemoveSpecialHandler" 
   ((functionClass :FourCharCode)
    (handler (:pointer :OpaqueAEEventHandlerProcPtr))
    (isSysHandler :Boolean)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
...
(deftrap-inline "_AEGetSpecialHandler" 
   ((functionClass :FourCharCode)
    (handler (:pointer :AEEVENTHANDLERUPP))
    (isSysHandler :Boolean)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
...
;  
(def-mactype :kAERemoteProcessURLKey (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kAERemoteProcessNameKey (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kAERemoteProcessUserIDKey (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kAERemoteProcessProcessIDKey (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  
(defrecord AERemoteProcessResolverContext
                                                ; 
;    * set to zero (0)
;    
   (version :SInt32)
...
;type name? (%define-record :AERemoteProcessResolverContext (find-record-descriptor ':AERemoteProcessResolverContext))
; 
...
(def-mactype :AERemoteProcessResolverRef (find-mactype '(:pointer :AERemoteProcessResolver)))
; 
...
(deftrap-inline "_AECreateRemoteProcessResolver" 
   ((allocator (:pointer :__CFAllocator))
    (url (:pointer :__CFURL))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   (:pointer :AERemoteProcessResolver)
() )
; 
...
(deftrap-inline "_AEDisposeRemoteProcessResolver" 
   ((ref (:pointer :AERemoteProcessResolver))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   nil
() )
; 
...
(deftrap-inline "_AERemoteProcessResolverGetProcesses" 
   ((ref (:pointer :AERemoteProcessResolver))
    (outError (:pointer :CFSTREAMERROR))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   (:pointer :__CFArray)
() )
; 
...
(def-mactype :AERemoteProcessResolverCallback (find-mactype ':pointer)); (AERemoteProcessResolverRef ref , void * info)
; 
...
(deftrap-inline "_AERemoteProcessResolverScheduleWithRunLoop" 
   ((ref (:pointer :AERemoteProcessResolver))
    (runLoop (:pointer :__CFRunLoop))
    (runLoopMode (:pointer :__CFString))
    (callback :pointer)
    (ctx (:pointer :AERemoteProcessResolverContext));  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   nil
() )

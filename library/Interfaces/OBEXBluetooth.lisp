(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:OBEXBluetooth.h"
...
(deftrap-inline "_IOBluetoothOBEXSessionCreateWithIOBluetoothSDPServiceRecordRef" 
   ((inSDPServiceRef (:pointer :OpaqueIOBluetoothObjectRef))
    (outSessionRef (:pointer :OBEXSESSIONREF))
   )
   :SInt32
() )
; ---------------------------------------------------------------------------------------------------------------------------
...
(deftrap-inline "_IOBluetoothOBEXSessionCreateWithIOBluetoothDeviceRefAndChannelNumber" 
...
(deftrap-inline "_IOBluetoothOBEXSessionCreateWithIncomingIOBluetoothRFCOMMChannel" 
   ((inRFCOMMChannelRef (:pointer :OpaqueIOBluetoothObjectRef))
    (inCallback :pointer)
...
(def-mactype :IOBluetoothOBEXSessionOpenConnectionCallback (find-mactype ':pointer)); (OBEXSessionRef session , OBEXError status , void * refCon)
; ---------------------------------------------------------------------------------------------------------------------------
...
(deftrap-inline "_IOBluetoothOBEXSessionOpenTransportConnection" 
...
(provide-interface "OBEXBluetooth")
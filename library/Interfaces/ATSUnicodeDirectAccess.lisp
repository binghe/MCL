(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:ATSUnicodeDirectAccess.h"
...
(def-mactype :ATSUDirectDataSelector (find-mactype ':UInt32))
; 
...
(defconstant $kATSUDirectDataAdvanceDeltaFixedArray 0)
; 
...
(defconstant $kATSUDirectDataBaselineDeltaFixedArray 1)
; 
...
(defconstant $kATSUDirectDataDeviceDeltaSInt16Array 2)
; 
...
(defconstant $kATSUDirectDataStyleIndexUInt16Array 3)
; 
...
(defconstant $kATSUDirectDataStyleSettingATSUStyleSettingRefArray 4)
; 
...
(defconstant $kATSUDirectDataLayoutRecordATSLayoutRecordVersion1 100)
; 
...
(defconstant $kATSUDirectDataLayoutRecordATSLayoutRecordCurrent 100)
;  ---------------------------------------------------------------------------- 
;  Data Types                                                                   
;  ---------------------------------------------------------------------------- 
; 
...
(def-mactype :ATSUStyleSettingRef (find-mactype '(:pointer :LLCStyleInfo)))
;  ---------------------------------------------------------------------------- 
;  Direct Accessors                                                             
;  ---------------------------------------------------------------------------- 
; 
...
(deftrap-inline "_ATSUDirectGetLayoutDataArrayPtrFromLineRef" 
   ((iLineRef (:pointer :ATSGlyphVector))
    (iDataSelector :UInt32)
    (iCreate :Boolean)
    (oLayoutDataArrayPtr :pointer)              ;  can be NULL 
    (oLayoutDataCount (:pointer :ItemCount))
...
(deftrap-inline "_ATSUDirectGetLayoutDataArrayPtrFromTextLayout" 
...
(deftrap-inline "_ATSUDirectReleaseLayoutDataArrayPtr" 
   ((iLineRef (:pointer :ATSGlyphVector))       ;  can be NULL 
    (iDataSelector :UInt32)
    (iLayoutDataArrayPtr :pointer)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
;  ---------------------------------------------------------------------------- 
...
(deftrap-inline "_ATSUDirectAddStyleSettingRef" 
   ((iLineRef (:pointer :ATSGlyphVector))
    (iStyleSettingRef (:pointer :LLCStyleInfo))
    (oStyleIndex (:pointer :UInt16))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; #ifdef __cplusplus
...
(provide-interface "ATSUnicodeDirectAccess")
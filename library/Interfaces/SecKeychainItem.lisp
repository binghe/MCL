(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:SecKeychainItem.h"
...
(def-mactype :SecItemClass (find-mactype ':FourCharCode))
; !
...
(defconstant $kSecInternetPasswordItemClass :|inet|)
(defconstant $kSecGenericPasswordItemClass :|genp|)
(defconstant $kSecAppleSharePasswordItemClass :|ashp|)
(defconstant $kSecCertificateItemClass $cssm_dl_db_record_x509_certificate)
; !
; 	@typedef SecItemAttr
...
(def-mactype :SecItemAttr (find-mactype ':FourCharCode))
; !
...
(defconstant $kSecCreationDateItemAttr :|cdat|)
(defconstant $kSecModDateItemAttr :|mdat|)
(defconstant $kSecDescriptionItemAttr :|desc|)
(defconstant $kSecCommentItemAttr :|icmt|)
(defconstant $kSecCreatorItemAttr :|crtr|)
(defconstant $kSecTypeItemAttr :|type|)
(defconstant $kSecScriptCodeItemAttr :|scrp|)
(defconstant $kSecLabelItemAttr :|labl|)
(defconstant $kSecInvisibleItemAttr :|invi|)
(defconstant $kSecNegativeItemAttr :|nega|)
(defconstant $kSecCustomIconItemAttr :|cusi|)
(defconstant $kSecAccountItemAttr :|acct|)
(defconstant $kSecServiceItemAttr :|svce|)
(defconstant $kSecGenericItemAttr :|gena|)
(defconstant $kSecSecurityDomainItemAttr :|sdmn|)
(defconstant $kSecServerItemAttr :|srvr|)
(defconstant $kSecAuthenticationTypeItemAttr :|atyp|)
(defconstant $kSecPortItemAttr :|port|)
(defconstant $kSecPathItemAttr :|path|)
(defconstant $kSecVolumeItemAttr :|vlme|)
(defconstant $kSecAddressItemAttr :|addr|)
(defconstant $kSecSignatureItemAttr :|ssig|)
(defconstant $kSecProtocolItemAttr :|ptcl|)
(defconstant $kSecCertificateType :|ctyp|)
(defconstant $kSecCertificateEncoding :|cenc|)
(defconstant $kSecCrlType :|crtp|)
(defconstant $kSecCrlEncoding :|crnc|)
(defconstant $kSecAlias :|alis|)
; !
; 	@typedef SecAFPServerSignature
; 	@abstract Represents a 16-byte Apple File Protocol server signature block.
; 
(defrecord SecAFPServerSignature
...
(deftrap-inline "_SecKeychainItemGetTypeID" 
   (
   )
   :UInt32
() )
...
(deftrap-inline "_SecKeychainItemModifyAttributesAndData" 
   ((itemRef (:pointer :OpaqueSecKeychainItemRef))
    (attrList (:pointer :SecKeychainAttributeList))
    (length :UInt32)
    (data :pointer)
   )
   :SInt32
...
(deftrap-inline "_SecKeychainItemCreateFromContent" 
   ((itemClass :FourCharCode)
    (attrList (:pointer :SecKeychainAttributeList))
    (length :UInt32)
    (data :pointer)
    (keychainRef (:pointer :OpaqueSecKeychainRef))
...
(deftrap-inline "_SecKeychainItemModifyContent" 
   ((itemRef (:pointer :OpaqueSecKeychainItemRef))
    (attrList (:pointer :SecKeychainAttributeList))
    (length :UInt32)
    (data :pointer)
...
(deftrap-inline "_SecKeychainItemCopyContent" 
   ((itemRef (:pointer :OpaqueSecKeychainItemRef))
    (itemClass (:pointer :SECITEMCLASS))
    (attrList (:pointer :SecKeychainAttributeList))
...
(deftrap-inline "_SecKeychainItemFreeContent" 
   ((attrList (:pointer :SecKeychainAttributeList))
    (data :pointer)
   )
   :SInt32
...
(deftrap-inline "_SecKeychainItemCopyAttributesAndData" 
   ((itemRef (:pointer :OpaqueSecKeychainItemRef))
...
(deftrap-inline "_SecKeychainItemFreeAttributesAndData" 
   ((attrList (:pointer :SecKeychainAttributeList))
    (data :pointer)
   )
   :SInt32
...
(deftrap-inline "_SecKeychainItemDelete" 
   ((itemRef (:pointer :OpaqueSecKeychainItemRef))
   )
   :SInt32
() )
...
(deftrap-inline "_SecKeychainItemCopyKeychain" 
   ((itemRef (:pointer :OpaqueSecKeychainItemRef))
    (keychainRef (:pointer :SecKeychainRef))
   )
   :SInt32
() )
; !
...
(deftrap-inline "_SecKeychainItemCreateCopy" 
   ((itemRef (:pointer :OpaqueSecKeychainItemRef))
    (destKeychainRef (:pointer :OpaqueSecKeychainRef))
    (initialAccess (:pointer :OpaqueSecAccessRef))
    (itemCopy (:pointer :SecKeychainItemRef))
   )
   :SInt32
() )
...
(deftrap-inline "_SecKeychainItemGetDLDBHandle" 
   ((keyItemRef (:pointer :OpaqueSecKeychainItemRef))
...
(deftrap-inline "_SecKeychainItemGetUniqueRecordID" 
   ((itemRef (:pointer :OpaqueSecKeychainItemRef))
    (uniqueRecordID (:pointer :CSSM_DB_UNIQUE_RECORD))
   )
   :SInt32
() )
...
(deftrap-inline "_SecKeychainItemCopyAccess" 
   ((itemRef (:pointer :OpaqueSecKeychainItemRef))
...
(deftrap-inline "_SecKeychainItemSetAccess" 
   ((itemRef (:pointer :OpaqueSecKeychainItemRef))
...
(provide-interface "SecKeychainItem")
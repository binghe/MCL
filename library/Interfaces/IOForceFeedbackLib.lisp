(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOForceFeedbackLib.h"
...
(require-interface "ForceFeedback/ForceFeedback")
; ====================================================================================================================
...
(defconstant $kFFPlugInAPIMajorRev 1)
(defconstant $kFFPlugInAPIMinorAndBugRev 0)
(defconstant $kFFPlugInAPIStage #x80)
(defconstant $kFFPlugInAPINonRelRev 0)
; ====================================================================================================================
; 	Defines
; ====================================================================================================================
; 
...
; #define kIOForceFeedbackLibTypeID CFUUIDGetConstantUUIDWithBytes(NULL, 	    0xF4, 0x54, 0x5C, 0xE5, 0xBF, 0x5B, 0x11, 0xD6, 					    0xA4, 0xBB, 0x00, 0x03, 0x93, 0x3E, 0x3E, 0x3E)
;  1C7C5850-BB6A-11D6-B75F-003065FBE6B0
; #define kIOForceFeedbackDeviceInterfaceID CFUUIDGetConstantUUIDWithBytes(NULL, 	    0x1C, 0x7C, 0x58, 0x50, 0xBB, 0x6A, 0x11, 0xD6, 							    0xB7, 0x5F, 0x00, 0x30, 0x65, 0xFB, 0xE6, 0xB0)
; ====================================================================================================================
; 	Structs
; ====================================================================================================================
; 
...
; 
; 
(defrecord ForceFeedbackDeviceState
   (dwSize :UInt32)
   (dwState :UInt32)
   (dwLoad :UInt32)
)

;type name? (%define-record :ForceFeedbackDeviceState (find-record-descriptor ':ForceFeedbackDeviceState))

(def-mactype :ForceFeedbackDeviceStatePtr (find-mactype '(:pointer :ForceFeedbackDeviceState)))
; !
; 
...
; 
; 
(defrecord ForceFeedbackVersion
   (apiVersion :NumVersion)
   (plugInVersion :NumVersion)
)

;type name? (%define-record :ForceFeedbackVersion (find-record-descriptor ':ForceFeedbackVersion))

(def-mactype :ForceFeedbackVersionPtr (find-mactype '(:pointer :ForceFeedbackVersion)))
; ====================================================================================================================
; 	Types
; ====================================================================================================================
; 
...
(def-mactype :FFEffectDownloadID (find-mactype ':UInt32))
; ====================================================================================================================
; 
...
; ====================================================================================================================
; 
(defrecord IOForceFeedbackDeviceInterface
#|
   (NIL :iunknown_c_guts)|#
)

;type name? (%define-record :IOForceFeedbackDeviceInterface (find-record-descriptor ':IOForceFeedbackDeviceInterface))

(def-mactype :IOForceFeedbackDeviceInterfacePtr (find-mactype '(:pointer :IOForceFeedbackDeviceInterface)))
; ====================================================================================================================
; 
...
; 
; 
   (ForceFeedbackGetVersion (:pointer :callback));(HRESULT (void * self , ForceFeedbackVersion * version))
...
; 
; 
   (InitializeTerminate (:pointer :callback))   ;(HRESULT (void * self , NumVersion forceFeedbackAPIVersion , io_object_t hidDevice , boolean_t begin))
...
; 
; 
   (DestroyEffect (:pointer :callback))         ;(HRESULT (void * self , FFEffectDownloadID downloadID))
...
; 
; 
   (DownloadEffect (:pointer :callback))        ;(HRESULT (void * self , CFUUIDRef effectType , FFEffectDownloadID * pDownloadID , FFEFFECT * pEffect , FFEffectParameterFlag flags))
                                                ; ! @function Escape
; 
...
; 
; 
   (Escape (:pointer :callback))                ;(HRESULT (void * self , FFEffectDownloadID downloadID , FFEFFESCAPE * pEscape))
...
; 
; 
   (GetEffectStatus (:pointer :callback))       ;(HRESULT (void * self , FFEffectDownloadID downloadID , FFEffectStatusFlag * pStatusCode))
...
; 
; 
   (GetForceFeedbackCapabilities (:pointer :callback));(HRESULT (void * self , FFCAPABILITIES * pCapabilities))
...
; 
; 
   (GetForceFeedbackState (:pointer :callback)) ;(HRESULT (void * self , ForceFeedbackDeviceState * pDeviceState))
...
; 
; 
   (SendForceFeedbackCommand (:pointer :callback));(HRESULT (void * self , FFCommandFlag state))
...
; 
; 
   (SetProperty (:pointer :callback))           ;(HRESULT (void * self , FFProperty property , void * pValue))
...
; 
; 
   (StartEffect (:pointer :callback))           ;(HRESULT (void * self , FFEffectDownloadID downloadID , FFEffectStartFlag mode , UInt32 iterations))
                                                ; ! @function StopEffect
; 
...
; 
; 
   (StopEffect (:pointer :callback))            ;(HRESULT (void * self , UInt32 downloadID))
)
 |#
...
(provide-interface "IOForceFeedbackLib")
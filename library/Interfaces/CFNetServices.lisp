(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:CFNetServices.h"
; at Sunday July 2,2006 7:23:39 pm.
; 
...
(def-mactype :CFNetServiceRef (find-mactype '(:pointer :__CFNetService)))
; 
...
(def-mactype :CFNetServiceBrowserRef (find-mactype '(:pointer :__CFNetServiceBrowser)))
; 
...
;  
(def-mactype :kCFStreamErrorDomainMach (find-mactype ':SInt32)); AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kCFStreamErrorDomainNetServices (find-mactype ':SInt32)); AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
; 
;  *  CFNetServicesError
;  *  
;  *  Discussion:
...
;  
(def-mactype :CFNetServicesError (find-mactype ':sint32))
; 
;    * An error of unknown type has occured.
;    

(defconstant $kCFNetServicesErrorUnknown -72000)
; 
...
(defconstant $kCFNetServicesErrorCollision -72001)
; 
;    * Not used
;    

(defconstant $kCFNetServicesErrorNotFound -72002)
; 
;    * There is already a register, resolve, or browse invoke on the
;    * given object.
;    

(defconstant $kCFNetServicesErrorInProgress -72003)
; 
;    * Not used
;    

(defconstant $kCFNetServicesErrorBadArgument -72004)
; 
;    * The register, resolve, or browse on the object has been cancelled.
;    

(defconstant $kCFNetServicesErrorCancel -72005)
; 
;    * The given CFNetServiceBrowser has already been invalidated and can
;    * no longer be used for browsing.
;    

(defconstant $kCFNetServicesErrorInvalid -72006)

;type name? (def-mactype :CFNetServicesError (find-mactype ':CFNetServicesError))
; 
...
(defconstant $kCFNetServiceFlagMoreComing 1)    ;  Client will get another callback briefly and shouldn't do costly screen updates (or such).

(defconstant $kCFNetServiceFlagIsDomain 2)      ;  If off, the result is a service.

(defconstant $kCFNetServiceFlagIsRegistrationDomain 4);  The result domain is the default registration domain.

(defconstant $kCFNetServiceFlagRemove 8)        ;  The result item should be removed and not added.
...
;  
(defrecord CFNetServiceClientContext
                                                ; 
...
;type name? (%define-record :CFNetServiceClientContext (find-record-descriptor ':CFNetServiceClientContext))
; 
...
(def-mactype :CFNetServiceClientCallBack (find-mactype ':pointer)); (CFNetServiceRef theService , CFStreamError * error , void * info)
; 
...
(def-mactype :CFNetServiceBrowserClientCallBack (find-mactype ':pointer)); (CFNetServiceBrowserRef browser , CFOptionFlags flags , CFTypeRef domainOrService , CFStreamError * error , void * info)
; 
...
(deftrap-inline "_CFNetServiceGetTypeID" 
   (
...
(deftrap-inline "_CFNetServiceBrowserGetTypeID" 
   (
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :UInt32
() )
...
(deftrap-inline "_CFNetServiceCreate" 
   ((alloc (:pointer :__CFAllocator))
    (domain (:pointer :__CFString))
    (serviceType (:pointer :__CFString))
    (name (:pointer :__CFString))
    (port :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :__CFNetService)
() )
; 
...
(deftrap-inline "_CFNetServiceCreateCopy" 
   ((alloc (:pointer :__CFAllocator))
...
(deftrap-inline "_CFNetServiceGetDomain" 
   ((theService (:pointer :__CFNetService))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :__CFString)
() )
; 
...
(deftrap-inline "_CFNetServiceGetType" 
   ((theService (:pointer :__CFNetService))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :__CFString)
() )
...
(deftrap-inline "_CFNetServiceGetName" 
   ((theService (:pointer :__CFNetService))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :__CFString)
() )
...
(deftrap-inline "_CFNetServiceGetAddressing" 
   ((theService (:pointer :__CFNetService))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :__CFArray)
() )
...
(deftrap-inline "_CFNetServiceGetProtocolSpecificInformation" 
   ((theService (:pointer :__CFNetService))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :__CFString)
() )
...
(deftrap-inline "_CFNetServiceSetProtocolSpecificInformation" 
   ((theService (:pointer :__CFNetService))
    (theInfo (:pointer :__CFString))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   nil
() )
; 
...
(deftrap-inline "_CFNetServiceRegister" 
   ((theService (:pointer :__CFNetService))
    (error (:pointer :CFSTREAMERROR))           ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :Boolean
() )
; 
...
(deftrap-inline "_CFNetServiceResolve" 
   ((theService (:pointer :__CFNetService))
    (error (:pointer :CFSTREAMERROR))           ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :Boolean
...
(deftrap-inline "_CFNetServiceCancel" 
   ((theService (:pointer :__CFNetService))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   nil
() )
...
(deftrap-inline "_CFNetServiceSetClient" 
   ((theService (:pointer :__CFNetService))
    (clientCB :pointer)                         ;  can be NULL 
    (clientContext (:pointer :CFNetServiceClientContext));  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :Boolean
() )
; 
...
(deftrap-inline "_CFNetServiceScheduleWithRunLoop" 
   ((theService (:pointer :__CFNetService))
...
(deftrap-inline "_CFNetServiceUnscheduleFromRunLoop" 
   ((theService (:pointer :__CFNetService))
    (runLoop (:pointer :__CFRunLoop))
    (runLoopMode (:pointer :__CFString))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
...
(deftrap-inline "_CFNetServiceBrowserCreate" 
   ((alloc (:pointer :__CFAllocator))
    (clientCB :pointer)
    (clientContext (:pointer :CFNetServiceClientContext))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :__CFNetServiceBrowser)
() )
; 
...
(deftrap-inline "_CFNetServiceBrowserInvalidate" 
   ((browser (:pointer :__CFNetServiceBrowser))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   nil
() )
; 
...
(deftrap-inline "_CFNetServiceBrowserSearchForDomains" 
   ((browser (:pointer :__CFNetServiceBrowser))
...
(deftrap-inline "_CFNetServiceBrowserSearchForServices" 
   ((browser (:pointer :__CFNetServiceBrowser))
    (domain (:pointer :__CFString))
    (serviceType (:pointer :__CFString))
    (error (:pointer :CFSTREAMERROR))           ;  can be NULL 
...
(deftrap-inline "_CFNetServiceBrowserStopSearch" 
   ((browser (:pointer :__CFNetServiceBrowser))
    (error (:pointer :CFSTREAMERROR))           ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   nil
...
(deftrap-inline "_CFNetServiceBrowserScheduleWithRunLoop" 
   ((browser (:pointer :__CFNetServiceBrowser))
    (runLoop (:pointer :__CFRunLoop))
    (runLoopMode (:pointer :__CFString))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
...
(deftrap-inline "_CFNetServiceBrowserUnscheduleFromRunLoop" 
   ((browser (:pointer :__CFNetServiceBrowser))
    (runLoop (:pointer :__CFRunLoop))
    (runLoopMode (:pointer :__CFString))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
...
(provide-interface "CFNetServices")
(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:QuickTimeComponents.k.h"
...
#| #|
	...
	#else		#define ADD_CLOCK_COMMA ,
	#endif	#define CLOCK_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define CLOCK_STRCAT(a,b) CLOCK_GLUE(a,b)
...
#| #|
		...
		#define SC_GLOBALS() 
		#define ADD_SC_COMMA 
	#else		#define ADD_SC_COMMA ,
	#endif	#define SC_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define SC_STRCAT(a,b) SC_GLUE(a,b)
...
#| #|
	#ifndefTWEENER_GLOBALS
		#define TWEENER_GLOBALS() 
		#define ADD_TWEENER_COMMA 
	#else		#define ADD_TWEENER_COMMA ,
	#endif	#define TWEENER_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define TWEENER_STRCAT(a,b) TWEENER_GLUE(a,b)
...
#| #|
		...
		#define TC_GLOBALS() 
		#define ADD_TC_COMMA 
	#else		#define ADD_TC_COMMA ,
	#endif	#define TC_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define TC_STRCAT(a,b) TC_GLUE(a,b)
...
#| #|
	#ifndefMOVIEIMPORT_GLOBALS
		#define MOVIEIMPORT_GLOBALS() 
		#define ADD_MOVIEIMPORT_COMMA 
	#else		#define ADD_MOVIEIMPORT_COMMA ,
	#endif	#define MOVIEIMPORT_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define MOVIEIMPORT_STRCAT(a,b) MOVIEIMPORT_GLUE(a,b)
...
#| #|
	#ifndefMOVIEEXPORT_GLOBALS
		#define MOVIEEXPORT_GLOBALS() 
		#define ADD_MOVIEEXPORT_COMMA 
	#else		#define ADD_MOVIEEXPORT_COMMA ,
	#endif	#define MOVIEEXPORT_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define MOVIEEXPORT_STRCAT(a,b) MOVIEEXPORT_GLUE(a,b)
...
#| #|
	#ifndefTEXTEXPORT_GLOBALS
		#define TEXTEXPORT_GLOBALS() 
		#define ADD_TEXTEXPORT_COMMA 
	#else		#define ADD_TEXTEXPORT_COMMA ,
	#endif	#define TEXTEXPORT_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define TEXTEXPORT_STRCAT(a,b) TEXTEXPORT_GLUE(a,b)
...
#| #|
	#ifndefMIDIIMPORT_GLOBALS
		#define MIDIIMPORT_GLOBALS() 
		#define ADD_MIDIIMPORT_COMMA 
	#else		#define ADD_MIDIIMPORT_COMMA ,
	#endif	#define MIDIIMPORT_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define MIDIIMPORT_STRCAT(a,b) MIDIIMPORT_GLUE(a,b)
...
#| #|
	#ifndefGRAPHICSIMAGEIMPORT_GLOBALS
		#define GRAPHICSIMAGEIMPORT_GLOBALS() 
		#define ADD_GRAPHICSIMAGEIMPORT_COMMA 
	#else		#define ADD_GRAPHICSIMAGEIMPORT_COMMA ,
	#endif	#define GRAPHICSIMAGEIMPORT_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define GRAPHICSIMAGEIMPORT_STRCAT(a,b) GRAPHICSIMAGEIMPORT_GLUE(a,b)
...
|#
 |#
;  GRAPHICSIMAGEIMPORT_BASENAME 
;  MixedMode ProcInfo constants for component calls 

(defconstant $uppTextExportGetDisplayDataProcInfo #x3F0)
(defconstant $uppTextExportGetTimeFractionProcInfo #x3F0)
(defconstant $uppTextExportSetTimeFractionProcInfo #x3F0)
(defconstant $uppTextExportGetSettingsProcInfo #x3F0)
(defconstant $uppTextExportSetSettingsProcInfo #x3F0)
(defconstant $uppMIDIImportGetSettingsProcInfo #x3F0)
(defconstant $uppMIDIImportSetSettingsProcInfo #x3F0)
(defconstant $uppMovieExportNewGetDataAndPropertiesProcsProcInfo #x3FFFFF0)
(defconstant $uppMovieExportDisposeGetDataAndPropertiesProcsProcInfo #x3FF0)
(defconstant $uppGraphicsImageImportSetSequenceEnabledProcInfo #x1F0)
(defconstant $uppGraphicsImageImportGetSequenceEnabledProcInfo #x3F0)
; 
; 	Example usage:
; 
...
#| #|
	#ifndefPREVIEW_GLOBALS
		#define PREVIEW_GLOBALS() 
		#define ADD_PREVIEW_COMMA 
	#else		#define ADD_PREVIEW_COMMA ,
	#endif	#define PREVIEW_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define PREVIEW_STRCAT(a,b) PREVIEW_GLUE(a,b)
...
#| #|
	#ifndefDATACODEC_GLOBALS
		#define DATACODEC_GLOBALS() 
		#define ADD_DATACODEC_COMMA 
	#else		#define ADD_DATACODEC_COMMA ,
	#endif	#define DATACODEC_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define DATACODEC_STRCAT(a,b) DATACODEC_GLUE(a,b)
...
#| #|
	...
	#else		#define ADD_DATAH_COMMA ,
	#endif	#define DATAH_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define DATAH_STRCAT(a,b) DATAH_GLUE(a,b)
...
#| #|
		...
		#define VD_GLOBALS() 
		#define ADD_VD_COMMA 
	#else		#define ADD_VD_COMMA ,
	#endif	#define VD_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define VD_STRCAT(a,b) VD_GLUE(a,b)
...
(defconstant $uppDataHGetDataProcInfo #xFFF0)
(defconstant $uppDataHPutDataProcInfo #xFFF0)
(defconstant $uppDataHFlushDataProcInfo #xF0)
(defconstant $uppDataHOpenForWriteProcInfo #xF0)
(defconstant $uppDataHCloseForWriteProcInfo #xF0)
(defconstant $uppDataHOpenForReadProcInfo #xF0)
(defconstant $uppDataHCloseForReadProcInfo #xF0)
(defconstant $uppDataHSetDataRefProcInfo #x3F0)
(defconstant $uppDataHGetDataRefProcInfo #x3F0)
(defconstant $uppDataHCompareDataRefProcInfo #xFF0)
(defconstant $uppDataHTaskProcInfo #xF0)
(defconstant $uppDataHScheduleDataProcInfo #xFFFF0)
(defconstant $uppDataHFinishDataProcInfo #x7F0)
(defconstant $uppDataHFlushCacheProcInfo #xF0)
(defconstant $uppDataHResolveDataRefProcInfo #x1FF0)
(defconstant $uppDataHGetFileSizeProcInfo #x3F0)
(defconstant $uppDataHCanUseDataRefProcInfo #xFF0)
(defconstant $uppDataHGetVolumeListProcInfo #x3F0)
(defconstant $uppDataHWriteProcInfo #x3FFF0)
(defconstant $uppDataHPreextendProcInfo #xFF0)
(defconstant $uppDataHSetFileSizeProcInfo #x3F0)
(defconstant $uppDataHGetFreeSpaceProcInfo #x3F0)
(defconstant $uppDataHCreateFileProcInfo #x7F0)
(defconstant $uppDataHGetPreferredBlockSizeProcInfo #x3F0)
(defconstant $uppDataHGetDeviceIndexProcInfo #x3F0)
(defconstant $uppDataHIsStreamingDataHandlerProcInfo #x3F0)
(defconstant $uppDataHGetDataInBufferProcInfo #xFF0)
(defconstant $uppDataHGetScheduleAheadTimeProcInfo #x3F0)
(defconstant $uppDataHSetCacheSizeLimitProcInfo #x3F0)
(defconstant $uppDataHGetCacheSizeLimitProcInfo #x3F0)
(defconstant $uppDataHGetMovieProcInfo #xFF0)
(defconstant $uppDataHAddMovieProcInfo #xFF0)
(defconstant $uppDataHUpdateMovieProcInfo #xBF0)
(defconstant $uppDataHDoesBufferProcInfo #xFF0)
(defconstant $uppDataHGetFileNameProcInfo #x3F0)
(defconstant $uppDataHGetAvailableFileSizeProcInfo #x3F0)
(defconstant $uppDataHGetMacOSFileTypeProcInfo #x3F0)
(defconstant $uppDataHGetMIMETypeProcInfo #x3F0)
(defconstant $uppDataHSetDataRefWithAnchorProcInfo #x3FF0)
(defconstant $uppDataHGetDataRefWithAnchorProcInfo #x3FF0)
(defconstant $uppDataHSetMacOSFileTypeProcInfo #x3F0)
(defconstant $uppDataHSetTimeBaseProcInfo #x3F0)
(defconstant $uppDataHGetInfoFlagsProcInfo #x3F0)
(defconstant $uppDataHScheduleData64ProcInfo #xFFFF0)
(defconstant $uppDataHWrite64ProcInfo #x3FFF0)
(defconstant $uppDataHGetFileSize64ProcInfo #x3F0)
(defconstant $uppDataHPreextend64ProcInfo #xFF0)
(defconstant $uppDataHSetFileSize64ProcInfo #x3F0)
(defconstant $uppDataHGetFreeSpace64ProcInfo #x3F0)
(defconstant $uppDataHAppend64ProcInfo #x3FF0)
(defconstant $uppDataHReadAsyncProcInfo #x3FFF0)
(defconstant $uppDataHPollReadProcInfo #xFF0)
(defconstant $uppDataHGetDataAvailabilityProcInfo #xFFF0)
(defconstant $uppDataHGetFileSizeAsyncProcInfo #x3FF0)
(defconstant $uppDataHGetDataRefAsTypeProcInfo #xFF0)
(defconstant $uppDataHSetDataRefExtensionProcInfo #xFF0)
(defconstant $uppDataHGetDataRefExtensionProcInfo #xFF0)
(defconstant $uppDataHGetMovieWithFlagsProcInfo #x2FF0)
(defconstant $uppDataHGetFileTypeOrderingProcInfo #x3F0)
(defconstant $uppDataHCreateFileWithFlagsProcInfo #x37F0)
(defconstant $uppDataHGetMIMETypeAsyncProcInfo #x3FF0)
(defconstant $uppDataHGetInfoProcInfo #xFF0)
(defconstant $uppDataHSetIdleManagerProcInfo #x3F0)
(defconstant $uppDataHDeleteFileProcInfo #xF0)
(defconstant $uppDataHSetMovieUsageFlagsProcInfo #x3F0)
(defconstant $uppDataHUseTemporaryDataRefProcInfo #x3F0)
(defconstant $uppDataHGetTemporaryDataRefCapabilitiesProcInfo #x3F0)
(defconstant $uppDataHRenameFileProcInfo #x3F0)
(defconstant $uppDataHPlaybackHintsProcInfo #xFFF0)
(defconstant $uppDataHPlaybackHints64ProcInfo #xFFF0)
(defconstant $uppDataHGetDataRateProcInfo #xFF0)
(defconstant $uppDataHSetTimeHintsProcInfo #x3FFF0)
(defconstant $uppVDGetMaxSrcRectProcInfo #xEF0)
(defconstant $uppVDGetActiveSrcRectProcInfo #xEF0)
(defconstant $uppVDSetDigitizerRectProcInfo #x3F0)
(defconstant $uppVDGetDigitizerRectProcInfo #x3F0)
(defconstant $uppVDGetVBlankRectProcInfo #xEF0)
(defconstant $uppVDGetMaskPixMapProcInfo #x3F0)
(defconstant $uppVDGetPlayThruDestinationProcInfo #xFFF0)
(defconstant $uppVDUseThisCLUTProcInfo #x3F0)
(defconstant $uppVDSetInputGammaValueProcInfo #x3FF0)
(defconstant $uppVDGetInputGammaValueProcInfo #x3FF0)
(defconstant $uppVDSetBrightnessProcInfo #x3F0)
(defconstant $uppVDGetBrightnessProcInfo #x3F0)
(defconstant $uppVDSetContrastProcInfo #x3F0)
(defconstant $uppVDSetHueProcInfo #x3F0)
(defconstant $uppVDSetSharpnessProcInfo #x3F0)
(defconstant $uppVDSetSaturationProcInfo #x3F0)
(defconstant $uppVDGetContrastProcInfo #x3F0)
(defconstant $uppVDGetHueProcInfo #x3F0)
(defconstant $uppVDGetSharpnessProcInfo #x3F0)
(defconstant $uppVDGetSaturationProcInfo #x3F0)
(defconstant $uppVDGrabOneFrameProcInfo #xF0)
(defconstant $uppVDGetMaxAuxBufferProcInfo #xFF0)
(defconstant $uppVDGetDigitizerInfoProcInfo #x3F0)
(defconstant $uppVDGetCurrentFlagsProcInfo #xFF0)
(defconstant $uppVDSetKeyColorProcInfo #x3F0)
(defconstant $uppVDGetKeyColorProcInfo #x3F0)
(defconstant $uppVDAddKeyColorProcInfo #x3F0)
(defconstant $uppVDGetNextKeyColorProcInfo #x3F0)
(defconstant $uppVDSetKeyColorRangeProcInfo #xFF0)
(defconstant $uppVDGetKeyColorRangeProcInfo #xFF0)
(defconstant $uppVDSetDigitizerUserInterruptProcInfo #x3FF0)
(defconstant $uppVDSetInputColorSpaceModeProcInfo #x2F0)
(defconstant $uppVDGetInputColorSpaceModeProcInfo #x3F0)
(defconstant $uppVDSetClipStateProcInfo #x2F0)
(defconstant $uppVDGetClipStateProcInfo #x3F0)
(defconstant $uppVDSetClipRgnProcInfo #x3F0)
(defconstant $uppVDClearClipRgnProcInfo #x3F0)
(defconstant $uppVDGetCLUTInUseProcInfo #x3F0)
(defconstant $uppVDSetPLLFilterTypeProcInfo #x2F0)
(defconstant $uppVDGetPLLFilterTypeProcInfo #x3F0)
(defconstant $uppVDGetMaskandValueProcInfo #x3EF0)
(defconstant $uppVDSetMasterBlendLevelProcInfo #x3F0)
(defconstant $uppVDSetPlayThruDestinationProcInfo #xFFF0)
(defconstant $uppVDSetPlayThruOnOffProcInfo #x2F0)
(defconstant $uppVDSetFieldPreferenceProcInfo #x2F0)
(defconstant $uppVDGetFieldPreferenceProcInfo #x3F0)
(defconstant $uppVDPreflightDestinationProcInfo #xFFF0)
(defconstant $uppVDPreflightGlobalRectProcInfo #xFF0)
(defconstant $uppVDSetPlayThruGlobalRectProcInfo #xFF0)
(defconstant $uppVDSetInputGammaRecordProcInfo #x3F0)
(defconstant $uppVDGetInputGammaRecordProcInfo #x3F0)
(defconstant $uppVDSetBlackLevelValueProcInfo #x3F0)
(defconstant $uppVDGetBlackLevelValueProcInfo #x3F0)
(defconstant $uppVDSetWhiteLevelValueProcInfo #x3F0)
(defconstant $uppVDGetWhiteLevelValueProcInfo #x3F0)
(defconstant $uppVDGetVideoDefaultsProcInfo #x3FFFF0)
(defconstant $uppVDGetNumberOfInputsProcInfo #x3F0)
(defconstant $uppVDGetInputFormatProcInfo #xEF0)
(defconstant $uppVDSetInputProcInfo #x2F0)
(defconstant $uppVDGetInputProcInfo #x3F0)
(defconstant $uppVDSetInputStandardProcInfo #x2F0)
(defconstant $uppVDSetupBuffersProcInfo #x3F0)
(defconstant $uppVDGrabOneFrameAsyncProcInfo #x2F0)
(defconstant $uppVDDoneProcInfo #x2F0)
(defconstant $uppVDSetCompressionProcInfo #xFFBF0)
(defconstant $uppVDCompressOneFrameAsyncProcInfo #xF0)
(defconstant $uppVDCompressDoneProcInfo #x3FFF0)
(defconstant $uppVDReleaseCompressBufferProcInfo #x3F0)
(defconstant $uppVDGetImageDescriptionProcInfo #x3F0)
(defconstant $uppVDResetCompressSequenceProcInfo #xF0)
(defconstant $uppVDSetCompressionOnOffProcInfo #x1F0)
(defconstant $uppVDGetCompressionTypesProcInfo #x3F0)
(defconstant $uppVDSetTimeBaseProcInfo #x3F0)
(defconstant $uppVDSetFrameRateProcInfo #x3F0)
(defconstant $uppVDGetDataRateProcInfo #x3FF0)
(defconstant $uppVDGetSoundInputDriverProcInfo #x3F0)
(defconstant $uppVDGetDMADepthsProcInfo #xFF0)
(defconstant $uppVDGetPreferredTimeScaleProcInfo #x3F0)
(defconstant $uppVDReleaseAsyncBuffersProcInfo #xF0)
(defconstant $uppVDSetDataRateProcInfo #x3F0)
(defconstant $uppVDGetTimeCodeProcInfo #x3FF0)
(defconstant $uppVDUseSafeBuffersProcInfo #x1F0)
(defconstant $uppVDGetSoundInputSourceProcInfo #xFF0)
(defconstant $uppVDGetCompressionTimeProcInfo #xFFBF0)
(defconstant $uppVDSetPreferredPacketSizeProcInfo #x3F0)
(defconstant $uppVDSetPreferredImageDimensionsProcInfo #xFF0)
(defconstant $uppVDGetPreferredImageDimensionsProcInfo #xFF0)
(defconstant $uppVDGetInputNameProcInfo #xFF0)
(defconstant $uppVDSetDestinationPortProcInfo #x3F0)
(defconstant $uppVDGetDeviceNameAndFlagsProcInfo #xFF0)
(defconstant $uppVDCaptureStateChangingProcInfo #x3F0)
(defconstant $uppVDGetUniqueIDsProcInfo #xFF0)
(defconstant $uppVDSelectUniqueIDsProcInfo #xFF0)
(defconstant $uppVDCopyPreferredAudioDeviceProcInfo #x3F0)
; 
; 	Example usage:
; 
...
#| #|
	#ifndefVDIIDC_GLOBALS
		#define VDIIDC_GLOBALS() 
		#define ADD_VDIIDC_COMMA 
	#else		#define ADD_VDIIDC_COMMA ,
	#endif	#define VDIIDC_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define VDIIDC_STRCAT(a,b) VDIIDC_GLUE(a,b)
...
#| #|
	#ifndefXMLPARSE_GLOBALS
		#define XMLPARSE_GLOBALS() 
		#define ADD_XMLPARSE_COMMA 
	#else		#define ADD_XMLPARSE_COMMA ,
	#endif	#define XMLPARSE_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define XMLPARSE_STRCAT(a,b) XMLPARSE_GLUE(a,b)
...
#| #|
		...
		#define SG_GLOBALS() 
		#define ADD_SG_COMMA 
	#else		#define ADD_SG_COMMA ,
	#endif	#define SG_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define SG_STRCAT(a,b) SG_GLUE(a,b)
...
#| #|
	#ifndefQTVIDEOOUTPUT_GLOBALS
		#define QTVIDEOOUTPUT_GLOBALS() 
		#define ADD_QTVIDEOOUTPUT_COMMA 
	#else		#define ADD_QTVIDEOOUTPUT_COMMA ,
	#endif	#define QTVIDEOOUTPUT_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define QTVIDEOOUTPUT_STRCAT(a,b) QTVIDEOOUTPUT_GLUE(a,b)
...
|#
 |#
;  QTVIDEOOUTPUT_BASENAME 

; #endif /* __QUICKTIMECOMPONENTS_K__ */


(provide-interface "QuickTimeComponents.k")
(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOMemoryCursor.h"
...
; 
#|
 confused about CLASS IOMemoryCursor #\: public OSObject #\{ OSDeclareDefaultStructors #\( IOMemoryCursor #\) public #\:
; !
...
; #define OutputSegmentFunc IOMemoryCursor::SegmentFunction
 protected #\:                                  ; ! @var outSeg The action method called when an event has been delivered 
 SegmentFunction outSeg #\;                     ; ! @var maxSegmentSize Maximum size of one segment in a scatter/gather list 
...
;     Currently unused.  Reserved for automated aligment restriction code. 
 IOPhysicalLength alignMask #\; public #\:
...
; 
#|
 confused about CLASS IONaturalMemoryCursor #\: public IOMemoryCursor #\{ OSDeclareDefaultStructors #\( IONaturalMemoryCursor #\) public #\:
...
; 
#|
 confused about CLASS IOBigMemoryCursor #\: public IOMemoryCursor #\{ OSDeclareDefaultStructors #\( IOBigMemoryCursor #\) public #\:
; ! @funtion outputSegment
...
; 
#|
 confused about CLASS IOLittleMemoryCursor #\: public IOMemoryCursor #\{ OSDeclareDefaultStructors #\( IOLittleMemoryCursor #\) public #\:
; ! @funtion outputSegment
...
; 
#|
 confused about CLASS IODBDMAMemoryCursor #\: public IOMemoryCursor #\{ OSDeclareDefaultStructors #\( IODBDMAMemoryCursor #\) public #\:
; ! @funtion outputSegment
...
(provide-interface "IOMemoryCursor")
(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOFireWireSBP2LUN.h"
...
(require-interface "IOKit/sbp2/IOFireWireSBP2Login")

(require-interface "IOKit/sbp2/IOFireWireSBP2ManagementORB")
...
; 
#|
 confused about CLASS IOFireWireSBP2LUN #\: public IOService #\{ OSDeclareDefaultStructors #\( IOFireWireSBP2LUN #\) #\; friend class IOFireWireSBP2ManagementORB #\; friend class IOFireWireSBP2Login #\; friend class IOFireWireSBP2UserClient #\; protected #\:;  reserved for future use
 struct ExpansionData #\{ #\} #\; ExpansionData * reserved #\;; //////////////////////////////////////////
;  methods called by friend classes
;  IOFireWireSBP2Login methods
 virtual void removeLogin #\( IOFireWireSBP2Login * login #\) #\; virtual IOFireWireSBP2Target * getTarget #\( void #\) #\;;  IOFireWireSBP2ManagementORB methods
 virtual void clearAllTasksInSet #\( void #\) #\;;  assumes caller is on workloop
 virtual void removeManagementORB #\( IOFireWireSBP2ManagementORB * orb #\) #\;;  IOFireWireSBP2UserClient methods
 virtual void flushAllManagementORBs #\( void #\) #\; public #\:; //////////////////////////////////////////
;  IOService overrides
; ! @function attach
...
; 	
 virtual bool matchPropertyTable #\( OSDictionary * table #\) #\; protected #\:; //////////////////////////////////////////
;  private fields
 IOFireWireSBP2Target * fProviderTarget #\; UInt32 fLUNumber #\; OSSet * fLoginSet #\; OSIterator * fLoginSetIterator #\; IOCommandGate * fGate #\; OSSet * fORBSet #\; OSIterator * fORBSetIterator #\; OSObject * fDiagnostics #\;; //////////////////////////////////////////
;  private methods
;  IOService methods
 virtual void free #\( void #\) #\; virtual IOReturn message #\( UInt32 type #\, IOService * provider #\, void * argument = 0 #\) #\;;  create management orb internals
 static IOReturn staticCreateManagementORBAction #\( OSObject * self #\, void * refCon #\, void * completion #\, void * orb #\, void * #\) #\; virtual IOReturn createManagementORBAction #\( void * refCon #\, FWSBP2ManagementCallback completion #\, IOFireWireSBP2ManagementORB ** orb #\) #\;;  remove management orb internals
 static IOReturn staticRemoveManagementORBAction #\( OSObject * self #\, void * orb #\, void * #\, void * #\, void * #\) #\; virtual IOReturn removeManagementORBAction #\( IOFireWireSBP2ManagementORB * orb #\) #\;;  flush all management orb internals
 static IOReturn staticExecuteFlushAllMgmtORBs #\( OSObject * self #\, void * #\, void * #\, void * #\, void * #\) #\; virtual IOReturn executeFlushAllMgmtORBs #\( void #\) #\;;  IOFireWireSBP2ManagementORB friend class wrappers
 virtual bool initMgmtORBWithLUN #\( IOFireWireSBP2ManagementORB * orb #\, IOFireWireSBP2LUN * lun #\, void * refCon #\, FWSBP2ManagementCallback completion #\) #\;;  IOFireWireSBP2Login friend class wrappers
 virtual bool initLoginWithLUN #\( IOFireWireSBP2Login * login #\, IOFireWireSBP2LUN * lun #\) #\; virtual void suspendedNotify #\( void #\) #\; virtual void resumeNotify #\( void #\) #\; private #\: OSMetaClassDeclareReservedUnused #\( IOFireWireSBP2LUN #\, 0 #\) #\; public #\:; //////////////////////////////////////////
;  client methods
;  getters
; !
...
; 	
 virtual UInt32 getLUNumber #\( void #\) #\;    ;  factory methods
; !
...
; 	
 virtual OSObject * getDiagnostics #\( void #\) #\; private #\: OSMetaClassDeclareReservedUnused #\( IOFireWireSBP2LUN #\, 1 #\) #\; OSMetaClassDeclareReservedUnused #\( IOFireWireSBP2LUN #\, 2 #\) #\; OSMetaClassDeclareReservedUnused #\( IOFireWireSBP2LUN #\, 3 #\) #\; OSMetaClassDeclareReservedUnused #\( IOFireWireSBP2LUN #\, 4 #\) #\; OSMetaClassDeclareReservedUnused #\( IOFireWireSBP2LUN #\, 5 #\) #\; OSMetaClassDeclareReservedUnused #\( IOFireWireSBP2LUN #\, 6 #\) #\; OSMetaClassDeclareReservedUnused #\( IOFireWireSBP2LUN #\, 7 #\) #\; OSMetaClassDeclareReservedUnused #\( IOFireWireSBP2LUN #\, 8 #\) #\;
|#

; #endif 


(provide-interface "IOFireWireSBP2LUN")
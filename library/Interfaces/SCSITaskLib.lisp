(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:SCSITaskLib.h"
...
(defconstant $kIOPropertySCSITaskUserClientInstanceGUID "SCSITaskUserClient GUID")
...
(defconstant $kIOPropertySCSITaskDeviceCategory "SCSITaskDeviceCategory")
...
(defconstant $kIOPropertySCSITaskUserClientDevice "SCSITaskUserClientDevice")
...
(defconstant $kIOPropertySCSITaskAuthoringDevice "SCSITaskAuthoringDevice")
...
(defconstant $kMMCDeviceTrayClosed 0)
(defconstant $kMMCDeviceTrayOpen 1)
(defconstant $kMMCDeviceTrayMask 1)
...
(def-mactype :SCSITaskCallbackFunction (find-mactype ':pointer)); (SCSIServiceResponse serviceResponse , SCSITaskStatus taskStatus , UInt64 bytesTransferred , void * refCon)
; ! 
...
; 	
   (IsTaskActive (:pointer :callback))          ;(Boolean (void * task))
...
; 	
   (SetTaskAttribute (:pointer :callback))      ;(IOReturn (void * task , SCSITaskAttribute inAttribute))
...
;     @result Returns kIOReturnSuccess or kIOReturnError.
; 	
   (GetTaskAttribute (:pointer :callback))      ;(IOReturn (void * task , SCSITaskAttribute * outAttribute))
...
;     @result Returns kIOReturnSuccess or kIOReturnError.
; 	
   (SetCommandDescriptorBlock (:pointer :callback));(IOReturn (void * task , UInt8 * inCDB , UInt8 inSize))
...
; 	
   (GetCommandDescriptorBlockSize (:pointer :callback));(UInt8 (void * task))
...
; 	
   (GetCommandDescriptorBlock (:pointer :callback));(IOReturn (void * task , UInt8 * outCDB))
...
;     @result Returns kIOReturnSucces or kIOReturnError.  
; 	
   (SetScatterGatherEntries (:pointer :callback));(IOReturn (void * task , IOVirtualRange * inScatterGatherList , UInt8 inScatterGatherEntries , UInt64 inTransferCount , UInt8 inTransferDirection))
...
;     @result Returns kIOReturnSucces or kIOReturnError.  
; 	
   (SetTimeoutDuration (:pointer :callback))    ;(IOReturn (void * task , UInt32 inTimeoutDurationMS))
...
; 	
   (GetTimeoutDuration (:pointer :callback))    ;(UInt32 (void * task))
...
; 	
   (SetTaskCompletionCallback (:pointer :callback));(IOReturn (void * task , SCSITaskCallbackFunction callback , void * refCon))
...
;     client has not called AddCallbackDispatcherToRunLoop on the SCSITaskDeviceInterface.
; 	
   (ExecuteTaskAsync (:pointer :callback))      ;(IOReturn (void * task))
...
;     @result Returns kIOReturnSuccess or kIOReturnError.
; 	
   (ExecuteTaskSync (:pointer :callback))       ;(IOReturn (void * task , SCSI_Sense_Data * senseDataBuffer , SCSITaskStatus * outStatus , UInt64 * realizedTransferCount))
                                                ; ! @function AbortTask
...
; 	
   (AbortTask (:pointer :callback))             ;(IOReturn (void * task))
...
;     @result Returns kIOReturnSuccess or kIOReturnError.
; 	
   (GetSCSIServiceResponse (:pointer :callback));(IOReturn (void * task , SCSIServiceResponse * outServiceResponse))
...
;     @result Returns kIOReturnSuccess or kIOReturnError.
; 	
   (GetTaskState (:pointer :callback))          ;(IOReturn (void * task , SCSITaskState * outState))
...
;     @result Returns kIOReturnSuccess or kIOReturnError.
; 	
   (GetTaskStatus (:pointer :callback))         ;(IOReturn (void * task , SCSITaskStatus * outStatus))
...
; 	
   (GetRealizedDataTransferCount (:pointer :callback));(UInt64 (void * task))
...
; 	
   (GetAutoSenseData (:pointer :callback))      ;(IOReturn (void * task , SCSI_Sense_Data * senseDataBuffer))
                                                ;  Added in 10.2 
...
; 	
   (SetAutoSenseDataBuffer (:pointer :callback));(IOReturn (void * task , SCSI_Sense_Data * senseDataBuffer , UInt8 senseDataLength))
)
...
; 
(defrecord SCSITaskDeviceInterface
#|
   (NIL :iunknown_c_guts)|#
   (version :UInt16)
   (revision :UInt16)
...
; 	
   (IsExclusiveAccessAvailable (:pointer :callback));(Boolean (void * self))
...
; 	
   (ObtainExclusiveAccess (:pointer :callback)) ;(IOReturn (void * self))
...
; 	appropriate error ••••••••••••••.
; 	
   (ReleaseExclusiveAccess (:pointer :callback));(IOReturn (void * self))
...
; 	
   (** (:pointer :callback))                    ;(SCSITaskInterface (* CreateSCSITask) (void * self))
)
; ! 
...
; 	by another client.
; 	
   (Inquiry (:pointer :callback))               ;(IOReturn (void * self , SCSICmd_INQUIRY_StandardData * inquiryBuffer , UInt32 inqBufferSize , SCSITaskStatus * taskStatus , SCSI_Sense_Data * senseDataBuffer))
...
; 	by another client.
; 	
   (TestUnitReady (:pointer :callback))         ;(IOReturn (void * self , SCSITaskStatus * taskStatus , SCSI_Sense_Data * senseDataBuffer))
...
; 	by another client.
; 	
   (GetPerformance (:pointer :callback))        ;(IOReturn (void * self , SCSICmdField2Bit TOLERANCE , SCSICmdField1Bit WRITE , SCSICmdField2Bit EXCEPT , SCSICmdField4Byte STARTING_LBA , SCSICmdField2Byte MAXIMUM_NUMBER_OF_DESCRIPTORS , void * buffer , SCSICmdField2Byte bufferSize , SCSITaskStatus * taskStatus , SCSI_Sense_Data * senseDataBuffer))
...
; 	by another client.
; 	
   (GetConfiguration (:pointer :callback))      ;(IOReturn (void * self , SCSICmdField1Byte RT , SCSICmdField2Byte STARTING_FEATURE_NUMBER , void * buffer , SCSICmdField2Byte bufferSize , SCSITaskStatus * taskStatus , SCSI_Sense_Data * senseDataBuffer))
...
; 	by another client.
; 	
   (ModeSense10 (:pointer :callback))           ;(IOReturn (void * self , SCSICmdField1Bit LLBAA , SCSICmdField1Bit DBD , SCSICmdField2Bit PC , SCSICmdField6Bit PAGE_CODE , void * buffer , SCSICmdField2Byte bufferSize , SCSITaskStatus * taskStatus , SCSI_Sense_Data * senseDataBuffer))
...
; 	by another client.
; 	
   (SetWriteParametersModePage (:pointer :callback));(IOReturn (void * self , void * buffer , SCSICmdField1Byte bufferSize , SCSITaskStatus * taskStatus , SCSI_Sense_Data * senseDataBuffer))
...
; 	
   (GetTrayState (:pointer :callback))          ;(IOReturn (void * self , UInt8 * trayState))
...
; 	by another client.
; 	
   (SetTrayState (:pointer :callback))          ;(IOReturn (void * self , UInt8 trayState))
...
; 	by another client.
; 	
   (ReadTableOfContents (:pointer :callback))   ;(IOReturn (void * self , SCSICmdField1Bit MSF , SCSICmdField4Bit FORMAT , SCSICmdField1Byte TRACK_SESSION_NUMBER , void * buffer , SCSICmdField2Byte bufferSize , SCSITaskStatus * taskStatus , SCSI_Sense_Data * senseDataBuffer))
...
;     by another client.
; 	
   (ReadDiscInformation (:pointer :callback))   ;(IOReturn (void * self , void * buffer , SCSICmdField2Byte bufferSize , SCSITaskStatus * taskStatus , SCSI_Sense_Data * senseDataBuffer))
...
; 	by another client.
; 	
   (ReadTrackInformation (:pointer :callback))  ;(IOReturn (void * self , SCSICmdField2Bit ADDRESS_NUMBER_TYPE , SCSICmdField4Byte LOGICAL_BLOCK_ADDRESS_TRACK_SESSION_NUMBER , void * buffer , SCSICmdField2Byte bufferSize , SCSITaskStatus * taskStatus , SCSI_Sense_Data * senseDataBuffer))
...
; 	by another client.
; 	
   (ReadDVDStructure (:pointer :callback))      ;(IOReturn (void * self , SCSICmdField4Byte ADDRESS , SCSICmdField1Byte LAYER_NUMBER , SCSICmdField1Byte FORMAT , void * buffer , SCSICmdField2Byte bufferSize , SCSITaskStatus * taskStatus , SCSI_Sense_Data * senseDataBuffer))
...
; 	
   (** (:pointer :callback))                    ;(SCSITaskDeviceInterface (* GetSCSITaskDeviceInterface) (void * self))
...
; 	by another client.
; 	
   (GetPerformanceV2 (:pointer :callback))      ;(IOReturn (void * self , SCSICmdField5Bit DATA_TYPE , SCSICmdField4Byte STARTING_LBA , SCSICmdField2Byte MAXIMUM_NUMBER_OF_DESCRIPTORS , SCSICmdField1Byte TYPE , void * buffer , SCSICmdField2Byte bufferSize , SCSITaskStatus * taskStatus , SCSI_Sense_Data * senseDataBuffer))
...
; 			by another client.
; 	
   (SetCDSpeed (:pointer :callback))            ;(IOReturn (void * self , SCSICmdField2Byte LOGICAL_UNIT_READ_SPEED , SCSICmdField2Byte LOGICAL_UNIT_WRITE_SPEED , SCSITaskStatus * taskStatus , SCSI_Sense_Data * senseDataBuffer))
                                                ;  Added in Mac OS X 10.3 
...
; 			by another client.
; 	
   (ReadFormatCapacities (:pointer :callback))  ;(IOReturn (void * self , void * buffer , SCSICmdField2Byte bufferSize , SCSITaskStatus * taskStatus , SCSI_Sense_Data * senseDataBuffer))
)

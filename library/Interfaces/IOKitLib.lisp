(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOKitLib.h"
...
(require-interface "mach/mach_init")
...
(def-mactype :IONotificationPortRef (find-mactype '(:pointer :IONotificationPort)))
...
(def-mactype :IOServiceMatchingCallback (find-mactype ':pointer)); (void * refcon , io_iterator_t iterator)
...
(def-mactype :IOServiceInterestCallback (find-mactype ':pointer)); (void * refcon , io_service_t service , natural_t messageType , void * messageArgument)
;  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 
...
; 
(def-mactype :kIOMasterPortDefault (find-mactype ':mach_port_t))
...
(deftrap-inline "_IOMasterPort" 
   ((bootstrapPort :pointer)
    (masterPort (:pointer :mach_port_t))
   )
   :signed-long
() )
...
(deftrap-inline "_IONotificationPortCreate" 
   ((masterPort :pointer)
   )
   (:pointer :IONotificationPort)
() )
...
(deftrap-inline "_IONotificationPortDestroy" 
   ((notify (:pointer :IONotificationPort))
   )
   :void
() )
...
(deftrap-inline "_IONotificationPortGetRunLoopSource" 
   ((notify (:pointer :IONotificationPort))
   )
...
(deftrap-inline "_IONotificationPortGetMachPort" 
   ((notify (:pointer :IONotificationPort))
   )
   :pointer
() )
...
(deftrap-inline "_IODispatchCalloutFromMessage" 
   ((unused :pointer)
...
(deftrap-inline "_IOCreateReceivePort" 
   ((msgType :signed-long)
    (recvPort (:pointer :mach_port_t))
   )
   :signed-long
() )
;  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 
...
(deftrap-inline "_IOObjectRelease" 
   ((object :pointer)
   )
   :signed-long
() )
...
(deftrap-inline "_IOObjectRetain" 
   ((object :pointer)
   )
   :signed-long
() )
...
(deftrap-inline "_IOObjectGetClass" 
   ((object :pointer)
...
(deftrap-inline "_IOObjectConformsTo" 
   ((object :pointer)
    (className (:pointer :IO_NAME_T))
   )
   :signed-long
...
(deftrap-inline "_IOObjectIsEqualTo" 
   ((object :pointer)
    (anObject :pointer)
   )
   :signed-long
...
(deftrap-inline "_IOObjectGetRetainCount" 
   ((object :pointer)
   )
   :signed-long
() )
...
(deftrap-inline "_IOIteratorNext" 
   ((iterator :pointer)
   )
   :pointer
() )
...
(deftrap-inline "_IOIteratorReset" 
   ((iterator :pointer)
   )
   :void
() )
...
(deftrap-inline "_IOIteratorIsValid" 
   ((iterator :pointer)
   )
   :signed-long
() )
...
(deftrap-inline "_IOServiceGetMatchingService" 
   ((masterPort :pointer)
    (matching (:pointer :__CFDictionary))
   )
   :pointer
() )
...
(deftrap-inline "_IOServiceGetMatchingServices" 
   ((masterPort :pointer)
    (matching (:pointer :__CFDictionary))
    (existing (:pointer :IO_ITERATOR_T))
   )
   :signed-long
() )

(deftrap-inline "_IOServiceAddNotification" 
   ((masterPort :pointer)
    (notificationType (:pointer :IO_NAME_T))
    (matching (:pointer :__CFDictionary))
    (wakePort :pointer)
    (reference :signed-long)
    (notification (:pointer :IO_ITERATOR_T))
   )
   :signed-long
() )
...
(deftrap-inline "_IOServiceAddMatchingNotification" 
   ((notifyPort (:pointer :IONotificationPort))
    (notificationType (:pointer :IO_NAME_T))
    (matching (:pointer :__CFDictionary))
    (callback :pointer)
    (refCon :pointer)
...
(deftrap-inline "_IOServiceAddInterestNotification" 
   ((notifyPort (:pointer :IONotificationPort))
    (service :pointer)
    (interestType (:pointer :IO_NAME_T))
    (callback :pointer)
    (refCon :pointer)
    (notification (:pointer :io_object_t))
   )
   :signed-long
() )
...
(deftrap-inline "_IOServiceMatchPropertyTable" 
   ((service :pointer)
    (matching (:pointer :__CFDictionary))
...
(deftrap-inline "_IOServiceGetBusyState" 
   ((service :pointer)
...
(deftrap-inline "_IOServiceWaitQuiet" 
   ((service :pointer)
    (waitTime (:pointer :MACH_TIMESPEC_T))
   )
   :signed-long
() )
...
(deftrap-inline "_IOKitGetBusyState" 
   ((masterPort :pointer)
    (busyState (:pointer :int))
   )
   :signed-long
...
(deftrap-inline "_IOKitWaitQuiet" 
   ((masterPort :pointer)
    (waitTime (:pointer :MACH_TIMESPEC_T))
   )
   :signed-long
...
(deftrap-inline "_IOServiceRequestProbe" 
   ((service :pointer)
    (options :UInt32)
   )
   :signed-long
...
(deftrap-inline "_IOServiceClose" 
   ((connect :pointer)
   )
   :signed-long
() )
...
(deftrap-inline "_IOConnectAddRef" 
   ((connect :pointer)
   )
   :signed-long
() )
...
(deftrap-inline "_IOConnectRelease" 
   ((connect :pointer)
   )
   :signed-long
() )
...
(deftrap-inline "_IOConnectGetService" 
   ((connect :pointer)
    (service (:pointer :io_service_t))
   )
   :signed-long
() )
...
(deftrap-inline "_IOConnectSetNotificationPort" 
   ((connect :pointer)
    (type :UInt32)
    (port :pointer)
    (reference :UInt32)
...
(deftrap-inline "_IOConnectMapMemory" 
   ((connect :pointer)
    (memoryType :UInt32)
    (intoTask :pointer)
    (atAddress (:pointer :vm_address_t))
    (ofSize (:pointer :VM_SIZE_T))
    (options :UInt32)
   )
   :signed-long
() )
...
(deftrap-inline "_IOConnectUnmapMemory" 
   ((connect :pointer)
    (memoryType :UInt32)
    (intoTask :pointer)
    (atAddress :vm_address_t)
   )
   :signed-long
() )
...
(deftrap-inline "_IOConnectSetCFProperties" 
   ((connect :pointer)
    (properties (:pointer :void))
   )
   :signed-long
() )
...
(deftrap-inline "_IOConnectSetCFProperty" 
   ((connect :pointer)
...
(deftrap-inline "_IOConnectMethodScalarIScalarO" 
   ((connect :pointer)
    (index :UInt32)
...
(deftrap-inline "_IOConnectMethodScalarIStructureO" 
   ((connect :pointer)
    (index :UInt32)
    (scalarInputCount :UInt32)
    (structureSize (:pointer :IOBYTECOUNT))
#| |...|  ;; What should this do?
    |#
   )
   :signed-long
...
(deftrap-inline "_IOConnectMethodScalarIStructureI" 
   ((connect :pointer)
    (index :UInt32)
    (scalarInputCount :UInt32)
...
(deftrap-inline "_IOConnectMethodStructureIStructureO" 
   ((connect :pointer)
    (index :UInt32)
    (structureInputSize :UInt32)
    (structureOutputSize (:pointer :IOBYTECOUNT))
    (inputStructure :pointer)
    (ouputStructure :pointer)
   )
   :signed-long
() )
;  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 

(deftrap-inline "_IOConnectTrap0" 
   ((connect :pointer)
    (index :UInt32)
   )
   :signed-long
...
(deftrap-inline "_IOConnectTrap1" 
   ((connect :pointer)
    (index :UInt32)
    (p1 :pointer)
   )
...
(deftrap-inline "_IOConnectTrap2" 
   ((connect :pointer)
    (index :UInt32)
    (p1 :pointer)
    (p2 :pointer)
...
(deftrap-inline "_IOConnectTrap3" 
   ((connect :pointer)
    (index :UInt32)
    (p1 :pointer)
    (p2 :pointer)
...
(deftrap-inline "_IOConnectTrap4" 
   ((connect :pointer)
    (index :UInt32)
    (p1 :pointer)
    (p2 :pointer)
...
(deftrap-inline "_IOConnectTrap5" 
   ((connect :pointer)
    (index :UInt32)
    (p1 :pointer)
    (p2 :pointer)
...
(deftrap-inline "_IOConnectTrap6" 
   ((connect :pointer)
    (index :UInt32)
    (p1 :pointer)
    (p2 :pointer)
...
(deftrap-inline "_IOConnectAddClient" 
   ((connect :pointer)
    (client :pointer)
   )
   :signed-long
...
(deftrap-inline "_IORegistryGetRootEntry" 
   ((masterPort :pointer)
   )
   :pointer
() )
...
(deftrap-inline "_IORegistryEntryFromPath" 
   ((masterPort :pointer)
...
(defconstant $kIORegistryIterateRecursively 1)
(defconstant $kIORegistryIterateParents 2)
...
(deftrap-inline "_IORegistryCreateIterator" 
   ((masterPort :pointer)
    (plane (:pointer :IO_NAME_T))
    (options :UInt32)
    (iterator (:pointer :IO_ITERATOR_T))
   )
   :signed-long
() )
...
(deftrap-inline "_IORegistryEntryCreateIterator" 
   ((entry :pointer)
    (plane (:pointer :IO_NAME_T))
    (options :UInt32)
    (iterator (:pointer :IO_ITERATOR_T))
...
(deftrap-inline "_IORegistryIteratorEnterEntry" 
   ((iterator :pointer)
   )
   :signed-long
() )
...
(deftrap-inline "_IORegistryIteratorExitEntry" 
   ((iterator :pointer)
   )
   :signed-long
() )
...
(deftrap-inline "_IORegistryEntryGetName" 
   ((entry :pointer)
...
(deftrap-inline "_IORegistryEntryGetNameInPlane" 
   ((entry :pointer)
    (plane (:pointer :IO_NAME_T))
    (name (:pointer :IO_NAME_T))
   )
...
(deftrap-inline "_IORegistryEntryGetLocationInPlane" 
   ((entry :pointer)
    (plane (:pointer :IO_NAME_T))
...
(deftrap-inline "_IORegistryEntryGetPath" 
   ((entry :pointer)
    (plane (:pointer :IO_NAME_T))
    (path (:pointer :IO_STRING_T))
   )
...
(deftrap-inline "_IORegistryEntryCreateCFProperties" 
   ((entry :pointer)
    (properties (:pointer :CFMUTABLEDICTIONARYREF))
...
(deftrap-inline "_IORegistryEntryCreateCFProperty" 
   ((entry :pointer)
...
(deftrap-inline "_IORegistryEntrySearchCFProperty" 
   ((entry :pointer)
    (plane (:pointer :IO_NAME_T))
    (key (:pointer :__CFString))
    (allocator (:pointer :__CFAllocator))
...
(deftrap-inline "_IORegistryEntryGetProperty" 
   ((entry :pointer)
    (propertyName (:pointer :IO_NAME_T))
    (buffer (:pointer :IO_STRUCT_INBAND_T))
    (size (:pointer :UInt32))
   )
   :signed-long
() )
...
(deftrap-inline "_IORegistryEntrySetCFProperties" 
   ((entry :pointer)
    (properties (:pointer :void))
   )
   :signed-long
...
(deftrap-inline "_IORegistryEntrySetCFProperty" 
   ((entry :pointer)
    (propertyName (:pointer :__CFString))
    (property (:pointer :void))
   )
...
(deftrap-inline "_IORegistryEntryGetChildIterator" 
   ((entry :pointer)
    (plane (:pointer :IO_NAME_T))
    (iterator (:pointer :IO_ITERATOR_T))
   )
...
(deftrap-inline "_IORegistryEntryGetChildEntry" 
   ((entry :pointer)
    (plane (:pointer :IO_NAME_T))
    (child (:pointer :io_registry_entry_t))
   )
   :signed-long
() )
...
(deftrap-inline "_IORegistryEntryGetParentIterator" 
   ((entry :pointer)
    (plane (:pointer :IO_NAME_T))
    (iterator (:pointer :IO_ITERATOR_T))
   )
...
(deftrap-inline "_IORegistryEntryGetParentEntry" 
   ((entry :pointer)
    (plane (:pointer :IO_NAME_T))
    (parent (:pointer :io_registry_entry_t))
   )
   :signed-long
() )
...
(deftrap-inline "_IORegistryEntryInPlane" 
   ((entry :pointer)
    (plane (:pointer :IO_NAME_T))
   )
   :signed-long
...
(deftrap-inline "_IOServiceMatching" 
   ((name (:pointer :char))
   )
...
(deftrap-inline "_IOServiceNameMatching" 
   ((name (:pointer :char))
   )
   (:pointer :__CFDictionary)
() )
...
(deftrap-inline "_IOBSDNameMatching" 
   ((masterPort :pointer)
    (options :UInt32)
    (bsdName (:pointer :char))
   )
   (:pointer :__CFDictionary)
() )
...
(deftrap-inline "_IOOpenFirmwarePathMatching" 
   ((masterPort :pointer)
    (options :UInt32)
    (path (:pointer :char))
   )
...
(deftrap-inline "_IOServiceOFPathToBSDName" 
   ((masterPort :pointer)
    (openFirmwarePath (:pointer :IO_NAME_T))
    (bsdName (:pointer :IO_NAME_T))
   )
   :signed-long
() )
;  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 
...
(def-mactype :IOAsyncCallback0 (find-mactype ':pointer)); (void * refcon , IOReturn result)
...
(def-mactype :IOAsyncCallback1 (find-mactype ':pointer)); (void * refcon , IOReturn result , void * arg0)
...
(def-mactype :IOAsyncCallback2 (find-mactype ':pointer)); (void * refcon , IOReturn result , void * arg0 , void * arg1)
...
(def-mactype :IOAsyncCallback (find-mactype ':pointer)); (void * refcon , IOReturn result , void ** args , int numArgs)
;  Internal use 

(deftrap-inline "_OSGetNotificationFromMessage" 
   ((msg (:pointer :MACH_MSG_HEADER_T))
    (index :UInt32)
    (type (:pointer :UInt32))
    (reference (:pointer :UInt32))
    (content :pointer)
...
(deftrap-inline "_IOCatalogueSendData" 
   ((masterPort :pointer)
    (flag :signed-long)
    (buffer (:pointer :char))
    (size :signed-long)
...
(deftrap-inline "_IOCatalogueTerminate" 
   ((masterPort :pointer)
    (flag :signed-long)
    (description (:pointer :IO_NAME_T))
   )
   :signed-long
() )

(deftrap-inline "_IOCatalogueGetData" 
   ((masterPort :pointer)
    (flag :signed-long)
    (buffer (:pointer :char))
    (size (:pointer :int))
...
(deftrap-inline "_IOCatalogueModuleLoaded" 
   ((masterPort :pointer)
    (name (:pointer :IO_NAME_T))
   )
   :signed-long
...
(deftrap-inline "_IOCatalogueReset" 
   ((masterPort :pointer)
    (flag :signed-long)
   )
   :signed-long
...
;type name? (def-mactype :IOObject (find-mactype ':IOObject))
;  for MacOS.app

(deftrap-inline "_IORegistryDisposeEnumerator" 
   ((enumerator :pointer)
   )
   :signed-long
() )

(deftrap-inline "_IOMapMemory" 
   ((connect :pointer)
    (memoryType :UInt32)
    (intoTask :pointer)
    (atAddress (:pointer :vm_address_t))
...
(deftrap-inline "_IOCompatibiltyNumber" 
   ((connect :pointer)
    (objectNumber (:pointer :UInt32))
   )
   :signed-long
() )
;  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 

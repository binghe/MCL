(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:ImageCodec.k.h"
; at Sunday July 2,2006 7:28:10 pm.
; 
;      File:       ImageCodec.k.h
;  
...
(require-interface "QuickTime/ImageCodec")
; 
; 	Example usage:
; 
...
#| #|
	#ifndefIMAGECODEC_GLOBALS
		#define IMAGECODEC_GLOBALS() 
		#define ADD_IMAGECODEC_COMMA 
	#else		#define ADD_IMAGECODEC_COMMA ,
	#endif	#define IMAGECODEC_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define IMAGECODEC_STRCAT(a,b) IMAGECODEC_GLUE(a,b)
...
#| #|
	#ifndefQTPHOTO_GLOBALS
		#define QTPHOTO_GLOBALS() 
		#define ADD_QTPHOTO_COMMA 
	#else		#define ADD_QTPHOTO_COMMA ,
	#endif	#define QTPHOTO_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define QTPHOTO_STRCAT(a,b) QTPHOTO_GLUE(a,b)
...
#| #|
	...
	#else		#define ADD_CURVE_COMMA ,
	#endif	#define CURVE_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define CURVE_STRCAT(a,b) CURVE_GLUE(a,b)
...
(provide-interface "ImageCodec.k")
(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:page_info.h"
...
(def-mactype :page_address_array_t (find-mactype '(:pointer :UInt32)))

; #endif	/* MACH_DEBUG_PAGE_INFO_H */


(provide-interface "page_info")
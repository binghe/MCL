(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:HIView.h"
...
(require-interface "HIToolbox/Controls")

; #endif

; #ifndef __CARBONEVENTS__

(require-interface "HIToolbox/CarbonEvents")
...
(def-mactype :HIViewRef (find-mactype ':ControlRef))

(%define-record :HIViewID (find-record-descriptor ':ControlID))

(def-mactype :HIViewPartCode (find-mactype ':SInt16))

(def-mactype :HIViewImageContentType (find-mactype ':SInt16))

(%define-record :HIViewImageContentInfo (find-record-descriptor ':ControlButtonContentInfo))
; 
...
;  
(%define-record :kHIViewWindowContentID (find-record-descriptor ':HIViewID)); AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(%define-record :kHIViewWindowGrowBoxID (find-record-descriptor ':HIViewID)); AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
; 
;  *  Discussion:
;  *    HIViewZOrderOp
;  
...
(defconstant $kHIViewZOrderAbove 1)
; 
;    * Indicates we wish to order a view below another view.
;    

(defconstant $kHIViewZOrderBelow 2)

(def-mactype :HIViewZOrderOp (find-mactype ':UInt32))
; 
;  *  HIViewFrameMetrics
;  *  
;  *  Summary:
...
;type name? (%define-record :HIViewFrameMetrics (find-record-descriptor ':HIViewFrameMetrics))
; ==============================================================================
;   CONTROL ATTRIBUTES                                                          
; ==============================================================================
; 
...
(defconstant $kHIViewSendCommandToUserFocus 1)
; 
;  *  Summary:
...
(defconstant $kHIViewSupportsGhosting 1)
; 
;    * This view allows subviews to be embedded within it.
;    

(defconstant $kHIViewAllowsSubviews 2)
; 
...
(defconstant $kHIViewGetsFocusOnClick #x100)
; 
...
(defconstant $kHIViewAutoToggles #x4000)
; 
...
(defconstant $kHIViewIdlesWithTimer #x800000)
; 
...
(defconstant $kHIViewInvertsUpDownValueMeaning #x1000000)
; 
...
(defconstant $kHIViewIsOpaque #x2000000)
; 
...
(defconstant $kHIViewDoesNotDraw #x8000000)
; 
...
(defconstant $kHIViewDoesNotUseSpecialParts #x10000000)
; 
...
(defconstant $kHIViewIgnoresClicks #x20000000)
(defconstant $kHIViewValidFeaturesForPanther #x3B804D03)

(%define-record :HIViewFeatures (find-record-descriptor ':UInt64))
; ==============================================================================
;   ERROR CODES                                                                 
; ==============================================================================
; 
...
(defconstant $errNeedsCompositedWindow -30598)
; ==============================================================================
;   HIOBJECT SUPPORT                                                            
;                                                                               
...
(deftrap-inline "_HIViewAddSubview" 
   ((inParent (:pointer :OpaqueControlRef))
    (inNewChild (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HIViewRemoveFromSuperview" 
...
(deftrap-inline "_HIViewGetSuperview" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :OpaqueControlRef)
() )
...
(deftrap-inline "_HIViewGetFirstSubview" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :OpaqueControlRef)
() )
...
(deftrap-inline "_HIViewGetLastSubview" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :OpaqueControlRef)
() )
...
(deftrap-inline "_HIViewGetNextView" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :OpaqueControlRef)
() )
...
(deftrap-inline "_HIViewGetPreviousView" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :OpaqueControlRef)
() )
...
(deftrap-inline "_HIViewSetZOrder" 
   ((inView (:pointer :OpaqueControlRef))
    (inOp :UInt32)
    (inOther (:pointer :OpaqueControlRef))      ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; ==============================================================================
...
(deftrap-inline "_HIViewSetVisible" 
   ((inView (:pointer :OpaqueControlRef))
    (inVisible :Boolean)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
...
(deftrap-inline "_HIViewIsVisible" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :Boolean
() )
...
(deftrap-inline "_HIViewGetBounds" 
   ((inView (:pointer :OpaqueControlRef))
...
(deftrap-inline "_HIViewGetFrame" 
   ((inView (:pointer :OpaqueControlRef))
    (outRect (:pointer :HIRECT))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
...
(deftrap-inline "_HIViewSetFrame" 
   ((inView (:pointer :OpaqueControlRef))
...
(deftrap-inline "_HIViewPlaceInSuperviewAt" 
   ((inView (:pointer :OpaqueControlRef))
    (inX :single-float)
    (inY :single-float)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
...
(deftrap-inline "_HIViewReshapeStructure" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_HIViewRegionChanged" 
   ((inView (:pointer :OpaqueControlRef))
    (inRegionCode :SInt16)
...
(deftrap-inline "_HIViewGetViewForMouseEvent" 
   ((inView (:pointer :OpaqueControlRef))
    (inEvent (:pointer :OpaqueEventRef))
    (outView (:pointer :HIVIEWREF))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HIViewSimulateClick" 
   ((inView (:pointer :OpaqueControlRef))
    (inPartToClick :SInt16)
    (inModifiers :UInt32)
    (outPartClicked (:pointer :ControlPartCode));  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HIViewGetPartHit" 
   ((inView (:pointer :OpaqueControlRef))
    (inPoint (:pointer :HIPOINT))
    (outPart (:pointer :HIVIEWPARTCODE))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HIViewGetSubviewHit" 
   ((inView (:pointer :OpaqueControlRef))
    (inPoint (:pointer :HIPOINT))
    (inDeep :Boolean)
    (outView (:pointer :HIVIEWREF))
...
(deftrap-inline "_HIViewGetNeedsDisplay" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :Boolean
() )
...
(deftrap-inline "_HIViewSetNeedsDisplay" 
   ((inView (:pointer :OpaqueControlRef))
    (inNeedsDisplay :Boolean)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HIViewSetNeedsDisplayInRegion" 
   ((inView (:pointer :OpaqueControlRef))
...
(deftrap-inline "_HIViewFlashDirtyArea" 
   ((inWindow (:pointer :OpaqueWindowPtr))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_HIViewGetSizeConstraints" 
   ((inView (:pointer :OpaqueControlRef))
    (outMinSize (:pointer :HISIZE))             ;  can be NULL 
    (outMaxSize (:pointer :HISIZE))             ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; ==============================================================================
...
(deftrap-inline "_HIViewConvertPoint" 
   ((ioPoint (:pointer :HIPOINT))
    (inSourceView (:pointer :OpaqueControlRef))
    (inDestView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HIViewConvertRect" 
   ((ioRect (:pointer :HIRECT))
    (inSourceView (:pointer :OpaqueControlRef))
    (inDestView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
...
(deftrap-inline "_HIViewConvertRegion" 
...
(deftrap-inline "_HIViewSetDrawingEnabled" 
   ((inView (:pointer :OpaqueControlRef))
    (inEnabled :Boolean)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
...
(deftrap-inline "_HIViewIsDrawingEnabled" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :Boolean
() )
...
(deftrap-inline "_HIViewScrollRect" 
   ((inView (:pointer :OpaqueControlRef))
    (inRect (:pointer :HIRECT))                 ;  can be NULL 
    (inDX :single-float)
    (inDY :single-float)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
...
(deftrap-inline "_HIViewSetBoundsOrigin" 
   ((inView (:pointer :OpaqueControlRef))
    (inX :single-float)
    (inY :single-float)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
...
(deftrap-inline "_HIViewAdvanceFocus" 
   ((inRootForFocus (:pointer :OpaqueControlRef))
    (inModifiers :UInt16)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_HIViewGetFocusPart" 
   ((inView (:pointer :OpaqueControlRef))
    (outFocusPart (:pointer :HIVIEWPARTCODE))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HIViewSubtreeContainsFocus" 
   ((inSubtreeStart (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :Boolean
() )
; 
...
(deftrap-inline "_HIViewSetNextFocus" 
   ((inView (:pointer :OpaqueControlRef))
    (inNextFocus (:pointer :OpaqueControlRef))  ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HIViewSetFirstSubViewFocus" 
   ((inParent (:pointer :OpaqueControlRef))
    (inSubView (:pointer :OpaqueControlRef))    ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; ==============================================================================
...
(defconstant $kHILayoutBindNone 0)
; 
;    * Bind to the minimum of the axis.
;    

(defconstant $kHILayoutBindMin 1)
; 
;    * Bind to the maximum of the axis.
;    

(defconstant $kHILayoutBindMax 2)
(defconstant $kHILayoutBindLeft 1)
(defconstant $kHILayoutBindRight 2)
; 
;    * Synonyms for convenience and clarity.
;    

(defconstant $kHILayoutBindTop 1)
(defconstant $kHILayoutBindBottom 2)

(def-mactype :HIBindingKind (find-mactype ':UInt16))
; 
;  *  HISideBinding
;  *  
;  *  Summary:
...
;type name? (%define-record :HISideBinding (find-record-descriptor ':HISideBinding))
; 
...
;type name? (%define-record :HIBinding (find-record-descriptor ':HIBinding))
; 
...
(defconstant $kHILayoutScaleAbsolute 0)

(def-mactype :HIScaleKind (find-mactype ':UInt16))
; 
;  *  HIAxisScale
;  *  
;  *  Summary:
...
;type name? (%define-record :HIAxisScale (find-record-descriptor ':HIAxisScale))
; 
;  *  HIScaling
;  *  
;  *  Summary:
...
;type name? (%define-record :HIScaling (find-record-descriptor ':HIScaling))
; 
;  *  Summary:
...
(defconstant $kHILayoutPositionNone 0)
; 
;    * Centered positioning will occur. The view will be centered
;    * relative to the specified view.
;    

(defconstant $kHILayoutPositionCenter 1)
; 
;    * Minimum positioning will occur. The view will be left or top
;    * aligned relative to the specified view.
;    

(defconstant $kHILayoutPositionMin 2)
; 
;    * Maximum positioning will occur. The view will be right or bottom
;    * aligned relative to the specified view.
;    

(defconstant $kHILayoutPositionMax 3)
; 
;    * Synonyms for convenience and clarity.
;    

(defconstant $kHILayoutPositionLeft 2)
(defconstant $kHILayoutPositionRight 3)
(defconstant $kHILayoutPositionTop 2)
(defconstant $kHILayoutPositionBottom 3)

(def-mactype :HIPositionKind (find-mactype ':UInt16))
; 
;  *  HIAxisPosition
;  *  
;  *  Summary:
...
;type name? (%define-record :HIAxisPosition (find-record-descriptor ':HIAxisPosition))
; 
;  *  HIPositioning
;  *  
;  *  Summary:
...
;type name? (%define-record :HIPositioning (find-record-descriptor ':HIPositioning))
; 
;  *  HILayoutInfo
;  *  
;  *  Summary:
...
;type name? (%define-record :HILayoutInfo (find-record-descriptor ':HILayoutInfo))

(defconstant $kHILayoutInfoVersionZero 0)
; 
; 
...
(deftrap-inline "_HIViewGetLayoutInfo" 
   ((inView (:pointer :OpaqueControlRef))
    (outLayoutInfo (:pointer :HILayoutInfo))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HIViewSetLayoutInfo" 
   ((inView (:pointer :OpaqueControlRef))
    (inLayoutInfo (:pointer :HILayoutInfo))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HIViewSuspendLayout" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_HIViewResumeLayout" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_HIViewIsLayoutActive" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :Boolean
() )
...
(deftrap-inline "_HIViewApplyLayout" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_HIViewGetWindow" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
...
(deftrap-inline "_HIViewFindByID" 
   ((inStartView (:pointer :OpaqueControlRef))
    (signature :OSType)
    (ID :SInt32)
...
(deftrap-inline "_HIViewGetAttributes" 
   ((inView (:pointer :OpaqueControlRef))
    (outAttrs (:pointer :OptionBits))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HIViewChangeAttributes" 
   ((inView (:pointer :OpaqueControlRef))
    (inAttrsToSet :UInt32)
...
(deftrap-inline "_HIViewCreateOffscreenImage" 
   ((inView (:pointer :OpaqueControlRef))
    (inOptions :UInt32)
    (outFrame (:pointer :HIRECT))               ;  can be NULL 
...
(deftrap-inline "_HIViewDrawCGImage" 
...
(deftrap-inline "_HIViewGetFeatures" 
   ((inView (:pointer :OpaqueControlRef))
    (outFeatures (:pointer :HIVIEWFEATURES))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HIViewChangeFeatures" 
   ((inView (:pointer :OpaqueControlRef))
    (inFeaturesToSet :HIVIEWFEATURES)
    (inFeaturesToClear :HIVIEWFEATURES)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
; ==============================================================================
...
(deftrap-inline "_HIGrowBoxViewSetTransparent" 
   ((inGrowBoxView (:pointer :OpaqueControlRef))
...
(deftrap-inline "_HIGrowBoxViewIsTransparent" 
   ((inGrowBoxView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :Boolean
() )
...
(defconstant $kEventClassScrollable :|scrl|)

(defconstant $kEventParamImageSize :|imsz|)     ;  typeHISize

(defconstant $kEventParamViewSize :|vwsz|)      ;  typeHISize

(defconstant $kEventParamLineSize :|lnsz|)      ;  typeHISize

(defconstant $kEventParamOrigin :|orgn|)        ;  typeHIPoint
...
(defconstant $kEventScrollableGetInfo 1)
; 
...
(defconstant $kEventScrollableInfoChanged 2)
; 
...
(defconstant $kEventScrollableScrollTo 10)
; 
;  *  Summary:
...
(defconstant $kHIScrollViewOptionsVertScroll 1)
; 
;    * This indicates that a horizontal scroll bar is desired.
;    

(defconstant $kHIScrollViewOptionsHorizScroll 2)
; 
...
(defconstant $kHIScrollViewOptionsAllowGrow 4)
(defconstant $kHIScrollViewValidOptions 7)
; 
;  *  HIScrollViewAction
;  *  
;  *  Summary:
...
(def-mactype :HIScrollViewAction (find-mactype ':UInt32))
; 
;    * The scroll view should move to the top of the content.
;    

(defconstant $kHIScrollViewScrollToTop 1)
; 
;    * The scroll view should move to the bottom of the content.
;    

(defconstant $kHIScrollViewScrollToBottom 2)
; 
;    * The scroll view should move to the left of the content.
;    

(defconstant $kHIScrollViewScrollToLeft 4)
; 
;    * The scroll view should move to the right of the content.
;    

(defconstant $kHIScrollViewScrollToRight 8)
; 
;    * The scroll view should page up.
;    

(defconstant $kHIScrollViewPageUp 16)
; 
;    * The scroll view should page down.
;    

(defconstant $kHIScrollViewPageDown 32)
; 
;    * The scroll view should page left.
;    

(defconstant $kHIScrollViewPageLeft 64)
; 
;    * The scroll view should page right.
;    

(defconstant $kHIScrollViewPageRight #x80)
; 
;  *  HIScrollViewCreate()
;  *  
;  *  Discussion:
...
(deftrap-inline "_HIScrollViewCreate" 
   ((inOptions :UInt32)
    (outView (:pointer :HIVIEWREF))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
...
(deftrap-inline "_HIScrollViewSetScrollBarAutoHide" 
   ((inView (:pointer :OpaqueControlRef))
    (inAutoHide :Boolean)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
...
(deftrap-inline "_HIScrollViewGetScrollBarAutoHide" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :Boolean
() )
...
(deftrap-inline "_HIScrollViewNavigate" 
   ((inView (:pointer :OpaqueControlRef))
    (inAction :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
...
(deftrap-inline "_HIScrollViewCanNavigate" 
   ((inView (:pointer :OpaqueControlRef))
    (inAction :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :Boolean
...
(deftrap-inline "_HIImageViewCreate" 
   ((inImage (:pointer :CGImage))               ;  can be NULL 
    (outControl (:pointer :ControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )

(defconstant $kHIImageViewImageTag :|imag|)     ;  CGImageRef (THIS TAG IS GOING AWAY!!! USE THE APIS BELOW!)
...
(deftrap-inline "_HIImageViewSetOpaque" 
   ((inView (:pointer :OpaqueControlRef))
    (inOpaque :Boolean)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
...
(deftrap-inline "_HIImageViewIsOpaque" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :Boolean
() )
...
(deftrap-inline "_HIImageViewSetAlpha" 
   ((inView (:pointer :OpaqueControlRef))
...
(deftrap-inline "_HIImageViewGetAlpha" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :single-float
() )
...
(deftrap-inline "_HIImageViewSetScaleToFit" 
   ((inView (:pointer :OpaqueControlRef))
    (inScaleToFit :Boolean)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HIImageViewGetScaleToFit" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :Boolean
() )
...
(deftrap-inline "_HIImageViewSetImage" 
   ((inView (:pointer :OpaqueControlRef))
    (inImage (:pointer :CGImage))               ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
...
(deftrap-inline "_HIImageViewCopyImage" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   (:pointer :CGImage)
() )
...
(defconstant $kHIComboBoxNoAttributes 0)
; 
...
(defconstant $kHIComboBoxAutoCompletionAttribute 1)
; 
;    * The control will disclose the ComboBox list after the user enters
;    * text.
;    

(defconstant $kHIComboBoxAutoDisclosureAttribute 2)
; 
;    * The items in the ComboBox list will be automatically sorted in
;    * alphabetical order.
;    

(defconstant $kHIComboBoxAutoSortAttribute 4)
; 
;    * The ComboBox list will be automatically sized to fit the Human
;    * Interface Guidelines.
;    

(defconstant $kHIComboBoxAutoSizeListAttribute 8)
; 
;    * The minimum set of ComboBox attributes commonly used.
;    

(defconstant $kHIComboBoxStandardAttributes 11)
;  ControlKind

(defconstant $kControlKindHIComboBox :|cbbx|)
;  ComboBox Part codes

(defconstant $kHIComboBoxEditTextPart 5)
(defconstant $kHIComboBoxDisclosurePart 28)
; 
...
(deftrap-inline "_HIComboBoxCreate" 
   ((boundsRect (:pointer :HIRECT))
    (text (:pointer :__CFString))               ;  can be NULL 
    (style (:pointer :ControlFontStyleRec))     ;  can be NULL 
    (list (:pointer :__CFArray))                ;  can be NULL 
    (inAttributes :UInt32)
    (outComboBox (:pointer :HIVIEWREF))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HIComboBoxGetItemCount" 
   ((inComboBox (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :UInt32
() )
; 
...
(deftrap-inline "_HIComboBoxInsertTextItemAtIndex" 
   ((inComboBox (:pointer :OpaqueControlRef))
    (inIndex :SInt32)
    (inText (:pointer :__CFString))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HIComboBoxAppendTextItem" 
   ((inComboBox (:pointer :OpaqueControlRef))
    (inText (:pointer :__CFString))
    (outIndex (:pointer :CFIndex))              ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HIComboBoxCopyTextItemAtIndex" 
   ((inComboBox (:pointer :OpaqueControlRef))
    (inIndex :SInt32)
...
(deftrap-inline "_HIComboBoxRemoveItemAtIndex" 
   ((inComboBox (:pointer :OpaqueControlRef))
    (inIndex :SInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
...
(deftrap-inline "_HIComboBoxChangeAttributes" 
   ((inComboBox (:pointer :OpaqueControlRef))
...
(deftrap-inline "_HIComboBoxGetAttributes" 
   ((inComboBox (:pointer :OpaqueControlRef))
...
(defconstant $kControlKindHISearchField :|srfd|)
;  HISearchField part codes

(defconstant $kControlSearchFieldCancelPart 30)
(defconstant $kControlSearchFieldMenuPart 31)
; 
;  *  Summary:
...
(defconstant $kHISearchFieldNoAttributes 0)
; 
;    * This view contains the cancel icon in the text field.
;    

(defconstant $kHISearchFieldAttributesCancel 1)
;  Event Classes

(defconstant $kEventClassSearchField :|srfd|)
; 
...
(defconstant $kEventSearchFieldCancelClicked 1)
; 
;  *  HISearchFieldCreate()
;  *  
;  *  Summary:
...
(deftrap-inline "_HISearchFieldCreate" 
   ((inBounds (:pointer :HIRECT))               ;  can be NULL 
    (inAttributes :UInt32)
    (inSearchMenu (:pointer :OpaqueMenuRef))    ;  can be NULL 
    (inDescriptiveText (:pointer :__CFString))  ;  can be NULL 
    (outRef (:pointer :HIVIEWREF))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HISearchFieldSetSearchMenu" 
   ((inSearchField (:pointer :OpaqueControlRef))
    (inSearchMenu (:pointer :OpaqueMenuRef))    ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_HISearchFieldGetSearchMenu" 
   ((inSearchField (:pointer :OpaqueControlRef))
    (outSearchMenu (:pointer :MenuRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HISearchFieldChangeAttributes" 
   ((inSearchField (:pointer :OpaqueControlRef))
    (inAttributesToSet :UInt32)
    (inAttributesToClear :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
...
(deftrap-inline "_HISearchFieldGetAttributes" 
   ((inSearchField (:pointer :OpaqueControlRef))
    (outAttributes (:pointer :OptionBits))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
...
(deftrap-inline "_HISearchFieldSetDescriptiveText" 
   ((inSearchField (:pointer :OpaqueControlRef))
    (inDescription (:pointer :__CFString))      ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HISearchFieldCopyDescriptiveText" 
   ((inSearchField (:pointer :OpaqueControlRef))
    (outDescription (:pointer :CFStringRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
; ==============================================================================
...
(defconstant $kEventClassTextField :|txfd|)
; 
...
(defconstant $kEventTextAccepted 1)
; ==============================================================================
;   HIMenuView                                                                  
;                                                                               
...
;  *    Non-Carbon CFM:   not available
;  
(%define-record :kHIViewMenuContentID (find-record-descriptor ':HIViewID))
; 
;  *  HIMenuViewGetMenu()
;  *  
;  *  Summary:
...
(deftrap-inline "_HIMenuViewGetMenu" 
   ((inView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
...
(deftrap-inline "_HIMenuGetContentView" 
...
(defconstant $kHISegmentedViewKind :|sgmt|)
; 
...
(deftrap-inline "_HISegmentedViewCreate" 
   ((inBounds (:pointer :HIRECT))               ;  can be NULL 
    (outRef (:pointer :HIVIEWREF))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
...
(deftrap-inline "_HISegmentedViewSetSegmentCount" 
   ((inSegmentedView (:pointer :OpaqueControlRef))
    (inSegmentCount :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HISegmentedViewGetSegmentCount" 
   ((inSegmentedView (:pointer :OpaqueControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :UInt32
() )
...
(defconstant $kHISegmentBehaviorMomentary 1)
; 
...
(defconstant $kHISegmentBehaviorRadio 2)
; 
;    * Like a check box. When clicked, it toggles back and forth between
;    * checked and unchecked states.
;    

(defconstant $kHISegmentBehaviorToggles 3)
; 
;    * After being pressed, this type of segment stays pressed until you
;    * programatically unpress it.
;    

(defconstant $kHISegmentBehaviorSticky 4)

(def-mactype :HISegmentBehavior (find-mactype ':UInt32))
; 
...
(deftrap-inline "_HISegmentedViewSetSegmentBehavior" 
   ((inSegmentedView (:pointer :OpaqueControlRef))
    (inSegmentIndexOneBased :UInt32)
    (inBehavior :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_HISegmentedViewGetSegmentBehavior" 
   ((inSegmentedView (:pointer :OpaqueControlRef))
    (inSegmentIndexOneBased :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :UInt32
...
(defconstant $kHISegmentNoAttributes 0)
; 
...
(defconstant $kHISegmentSendCmdToUserFocus 1)
; 
...
(deftrap-inline "_HISegmentedViewChangeSegmentAttributes" 
   ((inSegmentedView (:pointer :OpaqueControlRef))
    (inSegmentIndexOneBased :UInt32)
    (inAttributesToSet :UInt32)
    (inAttributesToClear :UInt32)
...
(deftrap-inline "_HISegmentedViewGetSegmentAttributes" 
   ((inSegmentedView (:pointer :OpaqueControlRef))
    (inSegmentIndexOneBased :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :UInt32
...
(deftrap-inline "_HISegmentedViewSetSegmentValue" 
   ((inSegmentedView (:pointer :OpaqueControlRef))
    (inSegmentIndexOneBased :UInt32)
    (inValue :SInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
...
(deftrap-inline "_HISegmentedViewGetSegmentValue" 
   ((inSegmentedView (:pointer :OpaqueControlRef))
    (inSegmentIndexOneBased :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :SInt32
...
(deftrap-inline "_HISegmentedViewSetSegmentEnabled" 
   ((inSegmentedView (:pointer :OpaqueControlRef))
    (inSegmentIndexOneBased :UInt32)
    (inEnabled :Boolean)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
...
(deftrap-inline "_HISegmentedViewIsSegmentEnabled" 
   ((inSegmentedView (:pointer :OpaqueControlRef))
    (inSegmentIndexOneBased :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :Boolean
...
(deftrap-inline "_HISegmentedViewSetSegmentCommand" 
   ((inSegmentedView (:pointer :OpaqueControlRef))
    (inSegmentIndexOneBased :UInt32)
    (inCommand :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
...
(deftrap-inline "_HISegmentedViewGetSegmentCommand" 
   ((inSegmentedView (:pointer :OpaqueControlRef))
    (inSegmentIndexOneBased :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :UInt32
...
(deftrap-inline "_HISegmentedViewSetSegmentLabel" 
   ((inSegmentedView (:pointer :OpaqueControlRef))
    (inSegmentIndexOneBased :UInt32)
...
(deftrap-inline "_HISegmentedViewCopySegmentLabel" 
   ((inSegmentedView (:pointer :OpaqueControlRef))
    (inSegmentIndexOneBased :UInt32)
...
(deftrap-inline "_HISegmentedViewSetSegmentContentWidth" 
   ((inSegmentedView (:pointer :OpaqueControlRef))
    (inSegmentIndexOneBased :UInt32)
    (inAutoCalculateWidth :Boolean)
...
(deftrap-inline "_HISegmentedViewGetSegmentContentWidth" 
   ((inSegmentedView (:pointer :OpaqueControlRef))
    (inSegmentIndexOneBased :UInt32)
    (outAutoCalculated (:pointer :Boolean))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :single-float
() )
; 
...
(deftrap-inline "_HISegmentedViewSetSegmentImage" 
   ((inSegmentedView (:pointer :OpaqueControlRef))
    (inSegmentIndexOneBased :UInt32)
    (inImage (:pointer :HIVIEWIMAGECONTENTINFO))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_HISegmentedViewGetSegmentImageContentType" 
   ((inSegmentedView (:pointer :OpaqueControlRef))
    (inSegmentIndexOneBased :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :SInt16
...
(deftrap-inline "_HISegmentedViewCopySegmentImage" 
   ((inSegmentedView (:pointer :OpaqueControlRef))
    (inSegmentIndexOneBased :UInt32)
    (ioImage (:pointer :HIVIEWIMAGECONTENTINFO))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )

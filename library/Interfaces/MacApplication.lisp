(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:MacApplication.h"
...
;  
(def-mactype :kHIToolboxVersionNumber (find-mactype ':float)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
;  *  Summary:
...
(defconstant $kUIModeContentSuppressed 1)
; 
;    * In this mode, system UI elements which cover the "content area" of
...
(defconstant $kUIModeContentHidden 2)
; 
...
(defconstant $kUIModeAllSuppressed 4)
; 
;    * In this mode, all system UI elements, including the menubar, are
...
(defconstant $kUIModeAllHidden 3)

(def-mactype :SystemUIMode (find-mactype ':UInt32))
; 
;  *  Summary:
...
(defconstant $kUIOptionAutoShowMenuBar 1)
; 
;    * Disables all items in the Apple menu. Valid for all modes.
;    

(defconstant $kUIOptionDisableAppleMenu 4)
; 
...
(defconstant $kUIOptionDisableProcessSwitch 8)
; 
...
(defconstant $kUIOptionDisableForceQuit 16)
; 
...
(defconstant $kUIOptionDisableSessionTerminate 32)
; 
...
(defconstant $kUIOptionDisableHide 64)

(def-mactype :SystemUIOptions (find-mactype ':UInt32))
; 
;  *  SetSystemUIMode()
;  *  
;  *  Summary:
...
(deftrap-inline "_SetSystemUIMode" 
   ((inMode :UInt32)
    (inOptions :UInt32)
...
(deftrap-inline "_GetSystemUIMode" 
   ((outMode (:pointer :SYSTEMUIMODE))          ;  can be NULL 
    (outOptions (:pointer :SYSTEMUIOPTIONS))    ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   nil
() )
; 
...
(deftrap-inline "_HIApplicationGetCurrent" 
   (
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
...
(deftrap-inline "_SetApplicationDockTileImage" 
...
(deftrap-inline "_OverlayApplicationDockTileImage" 
   ((inImage (:pointer :CGImage))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_RestoreApplicationDockTileImage" 
   (
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_BeginCGContextForApplicationDockTile" 
   (
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   (:pointer :CGContext)
() )
...
(deftrap-inline "_EndCGContextForApplicationDockTile" 
...
(deftrap-inline "_BeginQDContextForApplicationDockTile" 
   (
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
...
(deftrap-inline "_EndQDContextForApplicationDockTile" 
...
(deftrap-inline "_SetApplicationDockTileMenu" 
...
(deftrap-inline "_GetApplicationDockTileMenu" 
   (
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_1_AND_LATER
...
(deftrap-inline "_CreateCGImageFromPixMaps" 
   ((inImage (:Handle :PixMap))
    (inMask (:Handle :PixMap))
...
(deftrap-inline "_GetApplicationTextEncoding" 
   (
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :UInt32
() )
...
(deftrap-inline "_GetApplicationScript" 
   (
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :SInt16
() )
...
(deftrap-inline "_HIAboutBox" 
   ((inOptions (:pointer :__CFDictionary))
...
(provide-interface "MacApplication")
(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOTimerEventSource.h"
; at Sunday July 2,2006 7:26:48 pm.
; 
...
; 
#|
 confused about CLASS IOTimerEventSource #\: public IOEventSource #\{ OSDeclareDefaultStructors #\( IOTimerEventSource #\) protected #\:; ! @var calloutEntry thread_call entry for preregistered thread callouts 
 void * calloutEntry #\;                        ; ! @var abstime time to wake up next, see enable. 

(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:ATSUnicodeTypes.h"
...
(def-mactype :ATSUTextLayout (find-mactype '(:pointer :OpaqueATSUTextLayout)))
; 
;  *  ATSUStyle
;  *  
;  *  Discussion:
...
(def-mactype :ATSUStyle (find-mactype '(:pointer :OpaqueATSUStyle)))
; 
;  *  ATSUFontFallbacks
;  *  
;  *  Discussion:
...
(def-mactype :ATSUFontFallbacks (find-mactype '(:pointer :OpaqueATSUFontFallbacks)))
; 
;  *  ATSUTextMeasurement
;  *  
;  *  Discussion:
...
(def-mactype :ATSUTextMeasurement (find-mactype ':signed-long))
; 
;  *  ATSUFontID
;  *  
;  *  Discussion:
...
(def-mactype :ATSUFontID (find-mactype ':UInt32))
; 
;  *  ATSUFontFeatureType
;  *  
;  *  Discussion:
...
(def-mactype :ATSUFontFeatureType (find-mactype ':UInt16))
; 
...
(def-mactype :ATSUFontFeatureSelector (find-mactype ':UInt16))
; 
...
(def-mactype :ATSUFontVariationAxis (find-mactype ':FourCharCode))
; 
...
(def-mactype :ATSUFontVariationValue (find-mactype ':signed-long))
; 
;  *  ATSUAttributeTag
;  *  
;  *  Summary:
...
(defconstant $kATSULineBaselineValuesTag 6)
; 
...
(defconstant $kATSULineLayoutOptionsTag 7)
; 
...
(defconstant $kATSULineAscentTag 8)
; 
;    * (Type: ATSUTextMeasurement) (Default value: determined by font(s))
...
(defconstant $kATSULineDescentTag 9)
; 
...
(defconstant $kATSULineLangRegionTag 10)
; 
...
(defconstant $kATSULineTextLocatorTag 11)
; 
...
(defconstant $kATSULineTruncationTag 12)
; 
...
(defconstant $kATSULineFontFallbacksTag 13)
; 
...
(defconstant $kATSULineDecimalTabCharacterTag 14)
; 
...
(defconstant $kATSULayoutOperationOverrideTag 15)
; 
...
(defconstant $kATSUCGContextTag #x7FFF)
; 
...
(defconstant $kATSUQDBoldfaceTag #x100)
; 
;    * (Type: Boolean) (Default value: false) For compatability purposes
;    * only. Choosing typographic styles from font families is preferred.
;    * Note this tag will produce a synthetic style for fonts that do not
...
(defconstant $kATSULangRegionTag #x108)
; 
...
(defconstant $kATSUVerticalCharacterTag #x109)
; 
;    * (Type: ATSUTextMeasurement) (Default value: kATSUseGlyphAdvance)
;    * Must not be less than zero. May be set as a style attribute.
;    

(defconstant $kATSUImposeWidthTag #x10A)
; 
;    * (Type: Fixed) (Default value: 0) May be set as a style attribute.
;    

(defconstant $kATSUBeforeWithStreamShiftTag #x10B)
; 
;    * (Type: Fixed) (Default value: 0) May be set as a style attribute.
;    

(defconstant $kATSUAfterWithStreamShiftTag #x10C)
; 
;    * (Type: Fixed) (Default value: 0) May be set as a style attribute.
;    

(defconstant $kATSUCrossStreamShiftTag #x10D)
; 
;    * (Type: Fixed) (Default value: kATSNoTracking) May be set as a
;    * style attribute.
;    

(defconstant $kATSUTrackingTag #x10E)
; 
;    * (Type: Fract) (Default value: 0) May be set as a style attribute.
;    

(defconstant $kATSUHangingInhibitFactorTag #x10F)
; 
;    * (Type: Fract) (Default value: 0) May be set as a style attribute.
;    

(defconstant $kATSUKerningInhibitFactorTag #x110)
; 
;    * (Type: Fixed) (Default value: 0) Must be between -1.0 and 1.0. May
;    * be set as a style attribute.
;    

(defconstant $kATSUDecompositionFactorTag #x111)
; 
...
(defconstant $kATSUBaselineClassTag #x112)
; 
...
(defconstant $kATSUPriorityJustOverrideTag #x113)
; 
...
(defconstant $kATSUNoLigatureSplitTag #x114)
; 
...
(defconstant $kATSUNoCaretAngleTag #x115)
; 
;    * (Type: Boolean) (Default value: false) When set to true, ATSUI
...
(defconstant $kATSUSuppressCrossKerningTag #x116)
; 
;    * (Type: Boolean) (Default value: false) When set to true, ATSUI
...
(defconstant $kATSUNoOpticalAlignmentTag #x117)
; 
;    * (Type: Boolean) (Default value: false) When set to true, ATSUI
...
(defconstant $kATSUForceHangingTag #x118)
; 
;    * (Type: Boolean) (Default value: false) When set to true, ATSUI
...
(defconstant $kATSUNoSpecialJustificationTag #x119)
; 
;    * (Type: TextBreakLocatorRef) (Default value: NULL) See
...
(defconstant $kATSUStyleTextLocatorTag #x11A)
; 
...
(defconstant $kATSUStyleRenderingOptionsTag #x11B)
; 
...
(defconstant $kATSUAscentTag #x11C)
; 
;    * (Type: ATSUTextMeasurement) (Default value: determined by font)
;    * Must not be less than zero. Starting in Mac OS X 10.2, you can
;    * retrieve a value for this attribute, even if you have not
...
(defconstant $kATSUDescentTag #x11D)
; 
;    * (Type: ATSUTextMeasurement) (Default value: determined by font)
;    * Must not be less than zero. Starting in Mac OS X 10.2, you can
;    * retrieve a value for this attribute, even if you have not
...
(defconstant $kATSULeadingTag #x11E)
; 
...
(defconstant $kATSUGlyphSelectorTag #x11F)
; 
...
(defconstant $kATSURGBAlphaColorTag #x120)
; 
...
(defconstant $kATSUFontMatrixTag #x121)
; 
...
(defconstant $kATSUStyleUnderlineCountOptionTag #x122)
; 
...
(defconstant $kATSUStyleStrikeThroughCountOptionTag #x125)
; 
;    * (Type: CGColorRef) (Default value: NULL) Used to specify the color
...
(defconstant $kATSUStyleStrikeThroughColorOptionTag #x126)
; 
...
(defconstant $kATSUStyleDropShadowOffsetOptionTag #x129)
; 
;    * (Type: CGColorRef) (Default value: NULL) Used to specify the color
;    * of the dropshadow. May be set as a style attribute.
;    

(defconstant $kATSUStyleDropShadowColorOptionTag #x12A)
; 
;    * This is just for convenience. It is the upper limit of the style
;    * tags.
;    

(defconstant $kATSUMaxStyleTag #x12B)
; 
...
(defconstant $kATSULanguageTag #x108)
(defconstant $kATSUMaxATSUITagValue #xFFFF)
; 
...
(def-mactype :ATSUAttributeValuePtr (find-mactype '(:pointer :void)))

(def-mactype :ConstATSUAttributeValuePtr (find-mactype '(:pointer :void)))
; 
;  *  ATSUAttributeInfo
;  *  
;  *  Discussion:
...
;  
(defrecord ATSUAttributeInfo
   (fTag :UInt32)
   (fValueSize :UInt32)
)

;type name? (%define-record :ATSUAttributeInfo (find-record-descriptor ':ATSUAttributeInfo))
; 
;  *  ATSUCaret
;  *  
;  *  Discussion:
...
;type name? (%define-record :ATSUCaret (find-record-descriptor ':ATSUCaret))
; 
...
(def-mactype :ATSULineTruncation (find-mactype ':UInt32))

(defconstant $kATSUTruncateNone 0)
(defconstant $kATSUTruncateStart 1)
(defconstant $kATSUTruncateEnd 2)
(defconstant $kATSUTruncateMiddle 3)
(defconstant $kATSUTruncateSpecificationMask 7)
(defconstant $kATSUTruncFeatNoSquishing 8)
; 
...
(def-mactype :ATSUStyleLineCountType (find-mactype ':UInt16))

(defconstant $kATSUStyleSingleLineCount 1)
(defconstant $kATSUStyleDoubleLineCount 2)
; 
...
(def-mactype :ATSUVerticalCharacterType (find-mactype ':UInt16))

(defconstant $kATSUStronglyHorizontal 0)
(defconstant $kATSUStronglyVertical 1)
; 
;  *  ATSUStyleComparison
;  *  
;  *  Discussion:
...
(def-mactype :ATSUStyleComparison (find-mactype ':UInt16))

(defconstant $kATSUStyleUnequal 0)
(defconstant $kATSUStyleContains 1)
(defconstant $kATSUStyleEquals 2)
(defconstant $kATSUStyleContainedBy 3)
; 
...
(defconstant $kATSUSequentialFallbacksPreferred 2)
; 
...
(defconstant $kATSUSequentialFallbacksExclusive 3)
; 
;  *  ATSUTabType
;  *  
;  *  Discussion:
...
(def-mactype :ATSUTabType (find-mactype ':UInt16))

(defconstant $kATSULeftTab 0)
(defconstant $kATSUCenterTab 1)
(defconstant $kATSURightTab 2)
(defconstant $kATSUDecimalTab 3)
(defconstant $kATSUNumberTabTypes 4)
; 
;  *  ATSUTab
;  *  
;  *  Discussion:
...
;  
(defrecord ATSUTab
   (tabPosition :signed-long)
   (tabType :UInt16)
)

;type name? (%define-record :ATSUTab (find-record-descriptor ':ATSUTab))
; 
;  *  ATSURGBAlphaColor
;  *  
;  *  Discussion:
...
;type name? (%define-record :ATSURGBAlphaColor (find-record-descriptor ':ATSURGBAlphaColor))
; 
;  *  GlyphCollection
;  *  
;  *  Discussion:
...
(def-mactype :GlyphCollection (find-mactype ':UInt16))

(defconstant $kGlyphCollectionGID 0)
(defconstant $kGlyphCollectionAdobeCNS1 1)
(defconstant $kGlyphCollectionAdobeGB1 2)
(defconstant $kGlyphCollectionAdobeJapan1 3)
(defconstant $kGlyphCollectionAdobeJapan2 4)
(defconstant $kGlyphCollectionAdobeKorea1 5)
(defconstant $kGlyphCollectionUnspecified #xFF)
; 
;  *  ATSUGlyphSelector
;  *  
;  *  Discussion:
...
;type name? (%define-record :ATSUGlyphSelector (find-record-descriptor ':ATSUGlyphSelector))

; #if CALL_NOT_IN_CARBON
#| 
(def-mactype :ATSUCustomAllocFunc (find-mactype ':pointer)); (void * refCon , ByteCount howMuch)

(def-mactype :ATSUCustomFreeFunc (find-mactype ':pointer)); (void * refCon , void * doomedBlock)

(def-mactype :ATSUCustomGrowFunc (find-mactype ':pointer)); (void * refCon , void * oldBlock , ByteCount oldSize , ByteCount newSize)
; 
;  *  ATSUMemoryCallbacks
;  *  
;  *  Discussion:
...
;  
(defrecord ATSUMemoryCallbacks
   (:variant
   (
   (Alloc :ATSUCustomAllocFunc)
   (Free :ATSUCustomFreeFunc)
   (Grow :ATSUCustomGrowFunc)
   (memoryRefCon :pointer)
   )
   (
   (heapToUse (:pointer :Zone))
   )
   )
)

;type name? (def-mactype :ATSUMemoryCallbacks (find-mactype ':ATSUMemoryCallbacks))
; 
;  *  ATSUHeapSpec
;  *  
;  *  Discussion:
...
(def-mactype :ATSUHeapSpec (find-mactype ':UInt16))

(defconstant $kATSUUseCurrentHeap 0)
(defconstant $kATSUUseAppHeap 1)
(defconstant $kATSUUseSpecificHeap 2)
(defconstant $kATSUUseCallbacks 3)
; 
;  *  ATSUMemorySetting
;  *  
;  *  Discussion:
...
(def-mactype :ATSUMemorySetting (find-mactype '(:pointer :OpaqueATSUMemorySetting)))
 |#
...
;  
(defrecord ATSUGlyphInfo
   (glyphID :UInt16)
   (reserved :UInt16)
   (layoutFlags :UInt32)
   (charIndex :UInt32)
   (style (:pointer :OpaqueATSUStyle))
   (deltaY :single-float)
   (idealX :single-float)
   (screenX :SInt16)
   (caretX :SInt16)
...
;type name? (%define-record :ATSUGlyphInfo (find-record-descriptor ':ATSUGlyphInfo))
; 
;  *  ATSUGlyphInfoArray
;  *  
;  *  Summary:
...
;  
(defrecord ATSUGlyphInfoArray
   (layout (:pointer :OpaqueATSUTextLayout))
   (numGlyphs :UInt32)
   (glyphs (:array :ATSUGlyphInfo 1))
)

;type name? (%define-record :ATSUGlyphInfoArray (find-record-descriptor ':ATSUGlyphInfoArray))
; *******************************************************************************
...
(def-mactype :ATSUHighlightMethod (find-mactype ':UInt32))

(defconstant $kInvertHighlighting 0)
(defconstant $kRedrawHighlighting 1)
; 
...
(def-mactype :ATSUBackgroundDataType (find-mactype ':UInt32))

(defconstant $kATSUBackgroundColor 0)
(defconstant $kATSUBackgroundCallback 1)
; 
;  *  ATSUBackgroundColor
;  *  
;  *  Discussion:
...
(%define-record :ATSUBackgroundColor (find-record-descriptor ':ATSURGBAlphaColor))
; 
...
(def-mactype :RedrawBackgroundProcPtr (find-mactype ':pointer)); (ATSUTextLayout iLayout , UniCharArrayOffset iTextOffset , UniCharCount iTextLength , ATSTrapezoid iUnhighlightArea [ ] , ItemCount iTrapezoidCount)

(def-mactype :RedrawBackgroundUPP (find-mactype '(:pointer :OpaqueRedrawBackgroundProcPtr)))
; 
...
(deftrap-inline "_NewRedrawBackgroundUPP" 
   ((userRoutine :pointer)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   (:pointer :OpaqueRedrawBackgroundProcPtr)
() )
; 
...
(deftrap-inline "_DisposeRedrawBackgroundUPP" 
   ((userUPP (:pointer :OpaqueRedrawBackgroundProcPtr))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   nil
() )
; 
...
(deftrap-inline "_InvokeRedrawBackgroundUPP" 
   ((iLayout (:pointer :OpaqueATSUTextLayout))
    (iTextOffset :UInt32)
    (iTextLength :UInt32)
    (iUnhighlightArea (:pointer :ATSTrapezoid))
    (iTrapezoidCount :UInt32)
    (userUPP (:pointer :OpaqueRedrawBackgroundProcPtr))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :Boolean
() )
...
;    
   (
   (backgroundUPP (:pointer :OpaqueRedrawBackgroundProcPtr))
   )
   )
)

;type name? (%define-record :ATSUBackgroundData (find-record-descriptor ':ATSUBackgroundData))
; 
;  *  ATSUUnhighlightData
;  *  
;  *  Summary:
...
;type name? (%define-record :ATSUUnhighlightData (find-record-descriptor ':ATSUUnhighlightData))
; ******************************************************************************
...
(defconstant $kATSULeftToRightBaseDirection 0)
; 
;    * Impose right-to-left or bottom-to-top dominant direction.
;    

(defconstant $kATSURightToLeftBaseDirection 1)
(defconstant $kATSUStartAlignment 0)
; #define kATSUStartAlignment         ((Fract) 0x00000000L)
(defconstant $kATSUEndAlignment 1073741824)
; #define kATSUEndAlignment           ((Fract) 0x40000000L)
(defconstant $kATSUCenterAlignment 536870912)
; #define kATSUCenterAlignment        ((Fract) 0x20000000L)
(defconstant $kATSUNoJustification 0)
; #define kATSUNoJustification        ((Fract) 0x00000000L)
(defconstant $kATSUFullJustification 1073741824)
...
(defconstant $kATSUInvalidFontID 0)
; 
;  *  Summary:
...
(defconstant $kATSUUseLineControlWidth #x7FFFFFFF)
; 
;  *  Summary:
...
(defconstant $kATSUNoSelector #xFFFF)
; 
;  *  Summary:
...
(defconstant $kATSUFromTextBeginning #xFFFFFFFF)
; 
;    * Refers to the end of a text buffer.
;    

(defconstant $kATSUToTextEnd #xFFFFFFFF)
; 
;    * Used for bidi cursor movement between paragraphs.
;    

(defconstant $kATSUFromPreviousLayout #xFFFFFFFE)
; 
;    * Used for bidi cursor movement between paragraphs.
;    

(defconstant $kATSUFromFollowingLayout #xFFFFFFFD)
; 
;  *  Summary:
...
(defconstant $kATSUUseGrafPortPenLoc #xFFFFFFFF)
; 
...
(defconstant $kATSUClearAll #xFFFFFFFF)
...
(provide-interface "ATSUnicodeTypes")
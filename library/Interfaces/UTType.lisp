(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:UTType.h"
...
;  
(def-mactype :kUTExportedTypeDeclarationsKey (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kUTImportedTypeDeclarationsKey (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kUTTypeIdentifierKey (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kUTTypeTagSpecificationKey (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kUTTypeConformsToKey (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kUTTypeDescriptionKey (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
;  *  kUTTypeIconFileKey
;  *  
;  *  Availability:
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kUTTypeIconFileKey (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kUTTypeReferenceURLKey (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
;  *  kUTTypeVersionKey
;  *  
;  *  Availability:
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kUTTypeVersionKey (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
;     Type Tag Classes
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kUTTagClassFilenameExtension (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
;  *  kUTTagClassMIMEType
;  *  
;  *  Availability:
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kUTTagClassMIMEType (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kUTTagClassNSPboardType (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
;  *  kUTTagClassOSType
;  *  
;  *  Availability:
...
;  *    Non-Carbon CFM:   not available
;  
(def-mactype :kUTTagClassOSType (find-mactype ':CFStringRef)); AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
; 
...
(deftrap-inline "_UTTypeCreatePreferredIdentifierForTag" 
   ((inTagClass (:pointer :__CFString))
    (inTag (:pointer :__CFString))
    (inConformingToTypeIdentifier (:pointer :__CFString));  can be NULL 
...
(deftrap-inline "_UTTypeCreateAllIdentifiersForTag" 
   ((inTagClass (:pointer :__CFString))
    (inTag (:pointer :__CFString))
    (inConformingToTypeIdentifier (:pointer :__CFString));  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
...
(deftrap-inline "_UTTypeCopyPreferredTagWithClass" 
   ((inTypeIdentifier (:pointer :__CFString))
    (inTagClass (:pointer :__CFString))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   (:pointer :__CFString)
() )
...
(deftrap-inline "_UTTypeEqual" 
   ((inTypeIdentifier1 (:pointer :__CFString))
    (inTypeIdentifier2 (:pointer :__CFString))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :Boolean
() )
; 
...
(deftrap-inline "_UTTypeConformsTo" 
   ((inTypeIdentifier (:pointer :__CFString))
    (inConformsToTypeIdentifier (:pointer :__CFString))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :Boolean
() )
; 
...
(deftrap-inline "_UTTypeCopyDescription" 
   ((inTypeIdentifier (:pointer :__CFString))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   (:pointer :__CFString)
() )
...
(deftrap-inline "_UTTypeCopyDeclaration" 
   ((inTypeIdentifier (:pointer :__CFString))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
...
(deftrap-inline "_UTTypeCopyDeclaringBundleURL" 
   ((inTypeIdentifier (:pointer :__CFString))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   (:pointer :__CFURL)
() )
...
(deftrap-inline "_UTCreateStringForOSType" 
   ((inOSType :OSType)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   (:pointer :__CFString)
() )
...
(deftrap-inline "_UTGetOSTypeFromString" 

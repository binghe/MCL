(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:ForceFeedback.h"
...
(require-interface "ForceFeedback/ForceFeedbackConstants")
; -----------------------------------------------------------------------------
...
(defconstant $kFFAPIMajorRev 1)
(defconstant $kFFAPIMinorAndBugRev 0)
(defconstant $kFFAPIStage #x80)
(defconstant $kFFAPINonRelRev 0)
; -----------------------------------------------------------------------------
...
; 
; 
(defrecord FFCONSTANTFORCE
   (lMagnitude :signed-long)
)

;type name? (%define-record :FFCONSTANTFORCE (find-record-descriptor ':FFCONSTANTFORCE))

(def-mactype :PFFCONSTANTFORCE (find-mactype '(:pointer :FFCONSTANTFORCE)))
; !
; 
; @typedef FFRAMPFORCE
; 
...
; 
;  
(defrecord FFRAMPFORCE
   (lStart :signed-long)
   (lEnd :signed-long)
)

;type name? (%define-record :FFRAMPFORCE (find-record-descriptor ':FFRAMPFORCE))

(def-mactype :PFFRAMPFORCE (find-mactype '(:pointer :FFRAMPFORCE)))
; !
; 
; @typedef FFPERIODIC
; 
...
;type name? (%define-record :FFPERIODIC (find-record-descriptor ':FFPERIODIC))

(def-mactype :PFFPERIODIC (find-mactype '(:pointer :FFPERIODIC)))
; !
; 
; @typedef FFCONDITION
; 
...
; 
;  
(defrecord FFCONDITION
   (lOffset :signed-long)
   (lPositiveCoefficient :signed-long)
   (lNegativeCoefficient :signed-long)
   (dwPositiveSaturation :UInt32)
   (dwNegativeSaturation :UInt32)
   (lDeadBand :signed-long)
)

;type name? (%define-record :FFCONDITION (find-record-descriptor ':FFCONDITION))

(def-mactype :PFFCONDITION (find-mactype '(:pointer :FFCONDITION)))
; !
; 
...
; 
;  
(defrecord FFCUSTOMFORCE
   (cChannels :UInt32)
   (dwSamplePeriod :UInt32)
   (cSamples :UInt32)
   (rglForceData (:pointer :signed-long))
)

;type name? (%define-record :FFCUSTOMFORCE (find-record-descriptor ':FFCUSTOMFORCE))

(def-mactype :PFFCUSTOMFORCE (find-mactype '(:pointer :FFCUSTOMFORCE)))
; !
; 
; @typedef FFENVELOPE
; 
...
;type name? (%define-record :FFENVELOPE (find-record-descriptor ':FFENVELOPE))

(def-mactype :PFFENVELOPE (find-mactype '(:pointer :FFENVELOPE)))
; !
; 
; @typedef FFEFFECT
; 
...
(defrecord FFEFFECT
   ...
   (rglDirection (:pointer :signed-long))
   (lpEnvelope (:pointer :FFENVELOPE))
   (cbTypeSpecificParams :UInt32)
   (lpvTypeSpecificParams :pointer)
   (dwStartDelay :UInt32)
)

;type name? (%define-record :FFEFFECT (find-record-descriptor ':FFEFFECT))

(def-mactype :PFFEFFECT (find-mactype '(:pointer :FFEFFECT)))
; !
; 
; @typedef FFEFFESCAPE
; 
...
;type name? (%define-record :FFEFFESCAPE (find-record-descriptor ':FFEFFESCAPE))

(def-mactype :PFFEFFESCAPE (find-mactype '(:pointer :FFEFFESCAPE)))
; !
; 
...
;type name? (%define-record :FFCAPABILITIES (find-record-descriptor ':FFCAPABILITIES))

(def-mactype :PFFCAPABILITIES (find-mactype '(:pointer :FFCAPABILITIES)))
; -----------------------------------------------------------------------------
...
; 
(defrecord __FFDHIDDEN
#|
 confused about , * FFDeviceObjectReference
|#
)
(defrecord __FFEHIDDEN
#|
 confused about , * FFEffectObjectReference
|#
)
; -----------------------------------------------------------------------------
...
(deftrap-inline "_FFCreateDevice" 
   ((hidDevice :pointer)
    (pDeviceReference (:pointer :ffdeviceobjectreference))
   )
   :SInt32
() )
...
(deftrap-inline "_FFReleaseDevice" 
...
(deftrap-inline "_FFIsForceFeedback" 
   ((hidDevice :pointer)
   )
   :SInt32
() )
...
(deftrap-inline "_FFDeviceCreateEffect" 
   ((deviceReference :ffdeviceobjectreference)
    (uuidRef (:pointer :__CFUUID))
    (pEffectDefinition (:pointer :FFEFFECT))
    (pEffectReference (:pointer :ffeffectobjectreference))
   )
   :SInt32
() )
...
(deftrap-inline "_FFDeviceReleaseEffect" 
   ((deviceReference :ffdeviceobjectreference)
...
(deftrap-inline "_FFDeviceEscape" 
   ((deviceReference :ffdeviceobjectreference)
    (pFFEffectEscape (:pointer :FFEFFESCAPE))
   )
   :SInt32
() )
...
(deftrap-inline "_FFDeviceGetForceFeedbackState" 
   ((deviceReference :ffdeviceobjectreference)
    (pFFState (:pointer :FFSTATE))
   )
   :SInt32
() )
...
(deftrap-inline "_FFDeviceSendForceFeedbackCommand" 
   ((deviceReference :ffdeviceobjectreference)
    (flags :UInt32)
   )
   :SInt32
...
(deftrap-inline "_FFDeviceSetForceFeedbackProperty" 
   ((deviceReference :ffdeviceobjectreference)
    (property :UInt32)
    (pValue :pointer)
   )
...
(deftrap-inline "_FFDeviceGetForceFeedbackProperty" 
   ((deviceReference :ffdeviceobjectreference)
    (property :UInt32)
    (pValue :pointer)
    (valueSize :UInt32)
...
(deftrap-inline "_FFDeviceSetCooperativeLevel" 
   ((deviceReference :ffdeviceobjectreference)
    (taskIdentifier :pointer)
    (flags :UInt32)
   )
   :SInt32
() )
...
(deftrap-inline "_FFDeviceGetForceFeedbackCapabilities" 
   ((deviceReference :ffdeviceobjectreference)
    (pFFCapabilities (:pointer :FFCAPABILITIES))
   )
   :SInt32
() )
; -----------------------------------------------------------------------------
...
(deftrap-inline "_FFEffectDownload" 
   ((effectReference :ffeffectobjectreference)
   )
   :SInt32
() )
...
(deftrap-inline "_FFEffectEscape" 
   ((effectReference :ffeffectobjectreference)
    (pFFEffectEscape (:pointer :FFEFFESCAPE))
   )
   :SInt32
...
(deftrap-inline "_FFEffectGetEffectStatus" 
   ((effectReference :ffeffectobjectreference)
    (pFlags (:pointer :FFEFFECTSTATUSFLAG))
   )
   :SInt32
() )
...
(deftrap-inline "_FFEffectGetParameters" 
   ((effectReference :ffeffectobjectreference)
    (pFFEffect (:pointer :FFEFFECT))
    (flags :UInt32)
   )
   :SInt32
() )
...
(deftrap-inline "_FFEffectSetParameters" 
   ((effectReference :ffeffectobjectreference)
    (pFFEffect (:pointer :FFEFFECT))
    (flags :UInt32)
   )
...
(deftrap-inline "_FFEffectUnload" 
   ((effectReference :ffeffectobjectreference)
   )
   :SInt32
() )
...
(provide-interface "ForceFeedback")
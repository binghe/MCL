(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:etap_events.h"
...
#define ETAP_MISC_SPL			(ETAP_SUBS_LOCK_MISC + 22) 
#define ETAP_MISC_MASTER		(ETAP_SUBS_LOCK_MISC + 23) 
#define ETAP_MISC_FLOAT			(ETAP_SUBS_LOCK_MISC + 24) 
#define ETAP_MISC_GROUP			(ETAP_SUBS_LOCK_MISC + 25) 
...
#define ETAP_MISC_POST			(ETAP_SUBS_LOCK_MISC + 30) 
#define ETAP_MISC_KERNLOG		(ETAP_SUBS_LOCK_MISC + 31) 
#define ETAP_DPAGE_BS		(ETAP_SUBS_LOCK_MISC + 32) 
#define ETAP_DPAGE_BSL		(ETAP_SUBS_LOCK_MISC + 33) 
#define ETAP_DPAGE_SEGMENT	(ETAP_SUBS_LOCK_MISC + 34) 
#define ETAP_DPAGE_SEGLIST 	(ETAP_SUBS_LOCK_MISC + 35) 
#define ETAP_DPAGE_VSTRUCT	(ETAP_SUBS_LOCK_MISC + 36) 
#define ETAP_DPAGE_VSMAP	(ETAP_SUBS_LOCK_MISC + 37) 
#define ETAP_DPAGE_VSLIST	(ETAP_SUBS_LOCK_MISC + 38) 
#define ETAP_DPAGE_VSSEQNO	(ETAP_SUBS_LOCK_MISC + 39) 
#define ETAP_DPAGE_VSREAD	(ETAP_SUBS_LOCK_MISC + 40) 
#define ETAP_DPAGE_VSWRITE	(ETAP_SUBS_LOCK_MISC + 41) 
#define ETAP_DPAGE_VSREFS	(ETAP_SUBS_LOCK_MISC + 42) 
#define ETAP_DPAGE_VSASYNC	(ETAP_SUBS_LOCK_MISC + 43) 

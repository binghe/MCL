(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:SecTrustedApplication.h"
...
(deftrap-inline "_SecTrustedApplicationGetTypeID" 
   (
   )
   :UInt32
() )
...
(deftrap-inline "_SecTrustedApplicationCreateFromPath" 
   ((path (:pointer :char))
    (app (:pointer :SECTRUSTEDAPPLICATIONREF))
   )
   :SInt32
() )
; !
...
(deftrap-inline "_SecTrustedApplicationCopyData" 
   ((appRef (:pointer :OpaqueSecTrustedApplicationRef))
...
(deftrap-inline "_SecTrustedApplicationSetData" 
   ((appRef (:pointer :OpaqueSecTrustedApplicationRef))
...
(provide-interface "SecTrustedApplication")
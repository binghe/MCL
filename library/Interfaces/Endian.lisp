(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:Endian.h"
...
(require-interface "CarbonCore/ConditionalMacros")
...
#| 
(defrecord BigEndianLong
   (bigEndianValue :signed-long)
)

;type name? (def-mactype :BigEndianLong (find-mactype ':signed-long))
(defrecord BigEndianUnsignedLong
   (bigEndianValue :UInt32)
)

;type name? (def-mactype :BigEndianUnsignedLong (find-mactype ':BigEndianUnsignedLong))
(defrecord BigEndianShort
   (bigEndianValue :SInt16)
)

;type name? (def-mactype :BigEndianShort (find-mactype ':signed-integer))
(defrecord BigEndianUnsignedShort
   (bigEndianValue :UInt16)
)

;type name? (def-mactype :BigEndianUnsignedShort (find-mactype ':BigEndianUnsignedShort))
(defrecord BigEndianFixed
   (bigEndianValue :signed-long)
)

;type name? (def-mactype :BigEndianFixed (find-mactype ':signed-long))
(defrecord BigEndianUnsignedFixed
   (bigEndianValue :UInt32)
)

;type name? (def-mactype :BigEndianUnsignedFixed (find-mactype ':unsigned-long))
(defrecord BigEndianOSType
   (bigEndianValue :OSType)
)

;type name? (def-mactype :BigEndianOSType (find-mactype ':OSType))
 |#

; #else

(def-mactype :BigEndianLong (find-mactype ':signed-long))

(def-mactype :BigEndianUnsignedLong (find-mactype ':UInt32))

(def-mactype :BigEndianShort (find-mactype ':SInt16))

(def-mactype :BigEndianUnsignedShort (find-mactype ':UInt16))

(def-mactype :BigEndianFixed (find-mactype ':signed-long))

(def-mactype :BigEndianUnsignedFixed (find-mactype ':UInt32))

(def-mactype :BigEndianOSType (find-mactype ':OSType))

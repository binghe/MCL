(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:hash_info.h"
; at Sunday July 2,2006 7:26:03 pm.
; 
...
;  
(defrecord hash_info_bucket
   (hib_count :UInt32)
                                                ;  number of records in bucket 
)
(%define-record :hash_info_bucket_t (find-record-descriptor :HASH_INFO_BUCKET))

(def-mactype :hash_info_bucket_array_t (find-mactype '(:pointer :HASH_INFO_BUCKET)))

; #endif	/* _MACH_DEBUG_HASH_INFO_H_ */


(provide-interface "hash_info")
(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOATACommand.h"
; at Sunday July 2,2006 7:26:42 pm.
; 
...
(def-mactype :IOATACompletionFunction (find-mactype ':void)); (IOATACommand * command)
#|
 confused about CLASS IOATACommand #\: public IOCommand #\{ OSDeclareAbstractStructors #\( IOATACommand #\) public #\:
...
; 	in IOATATypes.h
; 	
 virtual void setRegMask #\( ataRegMask mask #\) #\;;  memory information
...
; 	
 virtual IOReturn setPacketCommand #\( UInt16 packetSizeBytes #\, UInt8 * command #\) #\;;  the following registers are only accessed by register access 
...
;  not part of task file params. not written to device when sending commands.
 virtual void setDataReg #\( UInt16 in #\) #\; virtual UInt16 getDataReg #\( void #\) #\;;  not part of taskfile. Not usually used except by controller.
 virtual void setControl #\( UInt8 in #\) #\; virtual UInt8 getAltStatus #\( void #\) #\;;  return values
; !@function getResult
...
; 	@abstract for use by disk drivers, clients of IOATADevice only. IOATADevice and IOATAControllers shall not use this field in any manner.
; 	
 void * refCon2 #\; protected #\:               ;  < 	return from ATA controllers to disk drivers

(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:TranslationServices.h"
...
(def-mactype :TranslationRef (find-mactype '(:pointer :OpaqueTranslationRef)))
...
(defconstant $badTranslationRefErr -3031)
; 
;  *  TranslationFlags
;  *  
;  *  Summary:
...
(def-mactype :TranslationFlags (find-mactype ':UInt32))
; 
;    * Indicates that the client is interested in translations which
;    * provide data translations.
;    

(defconstant $kTranslationDataTranslation 1)
; 
;    * Indicates that the client is interested in translations which
;    * provide file translations.
;    

(defconstant $kTranslationFileTranslation 2)
; 
...
(deftrap-inline "_TranslationGetTypeID" 
   (
...
(deftrap-inline "_TranslationCreate" 
   ((inSourceType (:pointer :__CFString))
    (inDestinationType (:pointer :__CFString))
    (inTranslationFlags :UInt32)
    (outTranslation (:pointer :TRANSLATIONREF))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_TranslationCreateWithSourceArray" 
   ((inSourceTypes (:pointer :__CFArray))
    (inTranslationFlags :UInt32)
    (outDestinationTypes (:pointer :CFArrayRef))
    (outTranslations (:pointer :CFDictionaryRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_TranslationPerformForData" 
   ((inTranslation (:pointer :OpaqueTranslationRef))
    (inSourceData (:pointer :__CFData))
    (outDestinationData (:pointer :CFDataRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_TranslationPerformForFile" 
   ((inTranslation (:pointer :OpaqueTranslationRef))
    (inSourceFile (:pointer :FSRef))
    (inDestinationDirectory (:pointer :FSRef))  ;  can be NULL 
    (inDestinationName (:pointer :__CFString))  ;  can be NULL 
    (outTranslatedFile (:pointer :FSRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_TranslationPerformForURL" 
   ((inTranslation (:pointer :OpaqueTranslationRef))
    (inSourceURL (:pointer :__CFURL))
    (inDestinationURL (:pointer :__CFURL))      ;  can be NULL 
    (outTranslatedURL (:pointer :CFURLRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_TranslationCopySourceType" 
   ((inTranslation (:pointer :OpaqueTranslationRef))
    (outSourceType (:pointer :CFStringRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_TranslationCopyDestinationType" 
   ((inTranslation (:pointer :OpaqueTranslationRef))
    (outDestinationType (:pointer :CFStringRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_TranslationGetTranslationFlags" 
   ((inTranslation (:pointer :OpaqueTranslationRef))
    (outTranslationFlags (:pointer :TRANSLATIONFLAGS))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
; #ifdef __cplusplus
...
(provide-interface "TranslationServices")
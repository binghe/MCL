(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:NSConnection.h"
...
|#
(def-mactype :NSConnectionReplyMode (find-mactype '(:pointer :NSString)))
(def-mactype :NSConnectionDidDieNotification (find-mactype '(:pointer :NSString)))
#| @INTERFACE 
NSObject (NSConnectionDelegateMethods)
...
|#
(def-mactype :NSFailedAuthenticationException (find-mactype '(:pointer :NSString)))
(def-mactype :NSConnectionDidInitializeNotification (find-mactype '(:pointer :NSString)))
#| @INTERFACE 

(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:vBLAS.h"
...
(require-interface "vecLib/cblas")

; #endif


;type name? (def-mactype :CBLAS_ORDER (find-mactype ':CBLAS_ORDER))

;type name? (def-mactype :CBLAS_TRANSPOSE (find-mactype ':CBLAS_TRANSPOSE))

;type name? (def-mactype :CBLAS_UPLO (find-mactype ':CBLAS_UPLO))

;type name? (def-mactype :CBLAS_DIAG (find-mactype ':CBLAS_DIAG))

;type name? (def-mactype :CBLAS_SIDE (find-mactype ':CBLAS_SIDE))
; 
;    ------------------------------------------------------------------------------------------------------------------

(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:ConditionalMacros.h"
...
; ***************************************************************************************************
(defconstant $UNIVERSAL_INTERFACES_VERSION 1024)
...
(defconstant $PRAGMA_IMPORT 0)
; #define PRAGMA_IMPORT               0

; #endif

; #ifndef PRAGMA_STRUCT_ALIGN
(defconstant $PRAGMA_STRUCT_ALIGN 0)
; #define PRAGMA_STRUCT_ALIGN         0

; #endif

; #ifndef PRAGMA_ONCE
(defconstant $PRAGMA_ONCE 0)
; #define PRAGMA_ONCE                 0

; #endif

; #ifndef PRAGMA_STRUCT_PACK
(defconstant $PRAGMA_STRUCT_PACK 0)
; #define PRAGMA_STRUCT_PACK          0

; #endif

; #ifndef PRAGMA_STRUCT_PACKPUSH
(defconstant $PRAGMA_STRUCT_PACKPUSH 0)
; #define PRAGMA_STRUCT_PACKPUSH      0

; #endif

; #ifndef PRAGMA_ENUM_PACK
(defconstant $PRAGMA_ENUM_PACK 0)
; #define PRAGMA_ENUM_PACK            0

; #endif

; #ifndef PRAGMA_ENUM_ALWAYSINT
(defconstant $PRAGMA_ENUM_ALWAYSINT 0)
; #define PRAGMA_ENUM_ALWAYSINT       0

; #endif

; #ifndef PRAGMA_ENUM_OPTIONS
(defconstant $PRAGMA_ENUM_OPTIONS 0)
; #define PRAGMA_ENUM_OPTIONS         0
...
(defconstant $TYPE_LONGDOUBLE_IS_DOUBLE 1)
; #define TYPE_LONGDOUBLE_IS_DOUBLE   1

; #endif

; #ifndef TYPE_EXTENDED
(defconstant $TYPE_EXTENDED 0)
; #define TYPE_EXTENDED               0

; #endif

; #ifndef TYPE_LONGLONG
(defconstant $TYPE_LONGLONG 0)
; #define TYPE_LONGLONG               0
...
(defconstant $FUNCTION_PASCAL 0)
; #define FUNCTION_PASCAL             0

; #endif

; #ifndef FUNCTION_DECLSPEC
(defconstant $FUNCTION_DECLSPEC 0)
; #define FUNCTION_DECLSPEC           0

; #endif

; #ifndef FUNCTION_WIN32CC
(defconstant $FUNCTION_WIN32CC 0)
; #define FUNCTION_WIN32CC            0
...
(defconstant $TARGET_API_MAC_OS8 0)
; #define TARGET_API_MAC_OS8 0
...
(defconstant $OPAQUE_UPP_TYPES 1)

(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:ATSUnicodeObjects.h"
...
(deftrap-inline "_ATSUCreateStyle" 
   ((oStyle (:pointer :ATSUSTYLE))
...
(deftrap-inline "_ATSUCreateAndCopyStyle" 
   ((iStyle (:pointer :OpaqueATSUStyle))
    (oStyle (:pointer :ATSUSTYLE))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_ATSUDisposeStyle" 
   ((iStyle (:pointer :OpaqueATSUStyle))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_ATSUSetStyleRefCon" 
   ((iStyle (:pointer :OpaqueATSUStyle))
    (iRefCon :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
...
(deftrap-inline "_ATSUGetStyleRefCon" 
   ((iStyle (:pointer :OpaqueATSUStyle))
    (oRefCon (:pointer :UInt32))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
;  ---------------------------------------------------------------------------- 
...
(deftrap-inline "_ATSUCompareStyles" 
   ((iFirstStyle (:pointer :OpaqueATSUStyle))
    (iSecondStyle (:pointer :OpaqueATSUStyle))
    (oComparison (:pointer :ATSUSTYLECOMPARISON))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
;  ---------------------------------------------------------------------------- 
...
(deftrap-inline "_ATSUCopyAttributes" 
   ((iSourceStyle (:pointer :OpaqueATSUStyle))
    (iDestinationStyle (:pointer :OpaqueATSUStyle))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUOverwriteAttributes" 
   ((iSourceStyle (:pointer :OpaqueATSUStyle))
    (iDestinationStyle (:pointer :OpaqueATSUStyle))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
...
(deftrap-inline "_ATSUUnderwriteAttributes" 
   ((iSourceStyle (:pointer :OpaqueATSUStyle))
    (iDestinationStyle (:pointer :OpaqueATSUStyle))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
...
(deftrap-inline "_ATSUClearStyle" 
   ((iStyle (:pointer :OpaqueATSUStyle))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_ATSUStyleIsEmpty" 
   ((iStyle (:pointer :OpaqueATSUStyle))
    (oIsClear (:pointer :Boolean))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
;  ---------------------------------------------------------------------------- 
...
(deftrap-inline "_ATSUCalculateBaselineDeltas" 
   ((iStyle (:pointer :OpaqueATSUStyle))
    (iBaselineClass :UInt32)
    (oBaselineDeltas (:pointer :BSLNBASELINERECORD))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUSetAttributes" 
   ((iStyle (:pointer :OpaqueATSUStyle))
    (iAttributeCount :UInt32)
    (iTag (:pointer :ATSUATTRIBUTETAG))
    (iValueSize (:pointer :ByteCount))
    (iValue (:pointer :ATSUATTRIBUTEVALUEPTR))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUGetAttribute" 
   ((iStyle (:pointer :OpaqueATSUStyle))
    (iTag :UInt32)
    (iExpectedValueSize :UInt32)
    (oValue (:pointer :void))                   ;  can be NULL 
    (oActualValueSize (:pointer :ByteCount))    ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUGetAllAttributes" 
   ((iStyle (:pointer :OpaqueATSUStyle))
    (oAttributeInfoArray (:pointer :ATSUAttributeInfo));  can be NULL 
    (iTagValuePairArraySize :UInt32)
    (oTagValuePairCount (:pointer :ItemCount))  ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUClearAttributes" 
   ((iStyle (:pointer :OpaqueATSUStyle))
    (iTagCount :UInt32)
    (iTag (:pointer :ATSUATTRIBUTETAG))         ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
;  ---------------------------------------------------------------------------- 
...
(deftrap-inline "_ATSUCreateTextLayout" 
   ((oTextLayout (:pointer :ATSUTEXTLAYOUT))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUCreateAndCopyTextLayout" 
...
(deftrap-inline "_ATSUCreateTextLayoutWithTextPtr" 
   ((iText (:pointer :UInt16))
    (iTextOffset :UInt32)
    (iTextLength :UInt32)
    (iTextTotalLength :UInt32)
    (iNumberOfRuns :UInt32)
    (iRunLengths (:pointer :UniCharCount))
...
(deftrap-inline "_ATSUClearLayoutCache" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iLineStart :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
...
(deftrap-inline "_ATSUDisposeTextLayout" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_ATSUSetTextLayoutRefCon" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iRefCon :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
...
(deftrap-inline "_ATSUGetTextLayoutRefCon" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (oRefCon (:pointer :UInt32))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
...
(deftrap-inline "_ATSUSetTextPointerLocation" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iText (:pointer :UInt16))
    (iTextOffset :UInt32)
    (iTextLength :UInt32)
...
(deftrap-inline "_ATSUGetTextLocation" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (oText :pointer)                            ;  can be NULL 
    (oTextIsStoredInHandle (:pointer :Boolean)) ;  can be NULL 
    (oOffset (:pointer :UNICHARARRAYOFFSET))    ;  can be NULL 
    (oTextLength (:pointer :UniCharCount))      ;  can be NULL 
    (oTextTotalLength (:pointer :UniCharCount)) ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUTextDeleted" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iDeletedRangeStart :UInt32)
    (iDeletedRangeLength :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUTextInserted" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iInsertionLocation :UInt32)
    (iInsertionLength :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUTextMoved" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iNewLocation (:pointer :UInt16))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
;  ---------------------------------------------------------------------------- 
...
(deftrap-inline "_ATSUCopyLayoutControls" 
   ((iSourceTextLayout (:pointer :OpaqueATSUTextLayout))
    (iDestTextLayout (:pointer :OpaqueATSUTextLayout))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUSetLayoutControls" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iAttributeCount :UInt32)
    (iTag (:pointer :ATSUATTRIBUTETAG))
    (iValueSize (:pointer :ByteCount))
...
(deftrap-inline "_ATSUGetLayoutControl" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iTag :UInt32)
    (iExpectedValueSize :UInt32)
    (oValue (:pointer :void))                   ;  can be NULL 
...
(deftrap-inline "_ATSUGetAllLayoutControls" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (oAttributeInfoArray (:pointer :ATSUAttributeInfo))
    (iTagValuePairArraySize :UInt32)
    (oTagValuePairCount (:pointer :ItemCount))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUClearLayoutControls" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iTagCount :UInt32)
    (iTag (:pointer :ATSUATTRIBUTETAG))         ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
...
(deftrap-inline "_ATSUCopyLineControls" 
   ((iSourceTextLayout (:pointer :OpaqueATSUTextLayout))
    (iSourceLineStart :UInt32)
    (iDestTextLayout (:pointer :OpaqueATSUTextLayout))
    (iDestLineStart :UInt32)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUSetLineControls" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iLineStart :UInt32)
    (iAttributeCount :UInt32)
    (iTag (:pointer :ATSUATTRIBUTETAG))
...
(deftrap-inline "_ATSUGetLineControl" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iLineStart :UInt32)
    (iTag :UInt32)
    (iExpectedValueSize :UInt32)
...
(deftrap-inline "_ATSUGetAllLineControls" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iLineStart :UInt32)
    (oAttributeInfoArray (:pointer :ATSUAttributeInfo));  can be NULL 
    (iTagValuePairArraySize :UInt32)
...
(deftrap-inline "_ATSUClearLineControls" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iLineStart :UInt32)
    (iTagCount :UInt32)
    (iTag (:pointer :ATSUATTRIBUTETAG))         ;  can be NULL 
...
(deftrap-inline "_ATSUSetRunStyle" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iStyle (:pointer :OpaqueATSUStyle))
    (iRunStart :UInt32)
    (iRunLength :UInt32)
...
(deftrap-inline "_ATSUGetRunStyle" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iOffset :UInt32)
    (oStyle (:pointer :ATSUSTYLE))
    (oRunStart (:pointer :UNICHARARRAYOFFSET))
    (oRunLength (:pointer :UniCharCount))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUGetContinuousAttributes" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iOffset :UInt32)
    (iLength :UInt32)
    (oStyle (:pointer :OpaqueATSUStyle))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
;  ---------------------------------------------------------------------------- 
...
(deftrap-inline "_ATSUSetTabArray" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iTabs (:pointer :ATSUTab))
    (iTabCount :UInt32)
...
(deftrap-inline "_ATSUGetTabArray" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iMaxTabCount :UInt32)
    (oTabs (:pointer :ATSUTab))                 ;  can be NULL 
    (oTabCount (:pointer :ItemCount))           ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
;  ---------------------------------------------------------------------------- 
...
(deftrap-inline "_ATSUCreateFontFallbacks" 
   ((oFontFallback (:pointer :ATSUFONTFALLBACKS))
...
(deftrap-inline "_ATSUDisposeFontFallbacks" 
   ((iFontFallbacks (:pointer :OpaqueATSUFontFallbacks))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_1_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUSetObjFontFallbacks" 
   ((iFontFallbacks (:pointer :OpaqueATSUFontFallbacks))
    (iFontFallbacksCount :UInt32)
    (iFonts (:pointer :ATSUFONTID))             ;  can be NULL 
    (iFontFallbackMethod :UInt16)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_1_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUGetObjFontFallbacks" 
   ((iFontFallbacks (:pointer :OpaqueATSUFontFallbacks))
    (iMaxFontFallbacksCount :UInt32)
    (oFonts (:pointer :ATSUFONTID))             ;  can be NULL 
    (oFontFallbackMethod (:pointer :ATSUFONTFALLBACKMETHOD))
    (oActualFallbacksCount (:pointer :ItemCount));  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_1_AND_LATER
   :OSStatus
() )
;  ---------------------------------------------------------------------------- 
...
(deftrap-inline "_ATSUSetFontFallbacks" 
   ((iFontFallbacksCount :UInt32)
    (iFontIDs (:pointer :ATSUFONTID))
    (iFontFallbackMethod :UInt16)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_ATSUGetFontFallbacks" 
   ((iMaxFontFallbacksCount :UInt32)
    (oFontIDs (:pointer :ATSUFONTID))
    (oFontFallbackMethod (:pointer :ATSUFONTFALLBACKMETHOD))
    (oActualFallbacksCount (:pointer :ItemCount))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUMatchFontsToText" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iTextStart :UInt32)
    (iTextLength :UInt32)
    (oFontID (:pointer :ATSUFONTID))
    (oChangedOffset (:pointer :UNICHARARRAYOFFSET))
    (oChangedLength (:pointer :UniCharCount))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUSetTransientFontMatching" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iTransientFontMatching :Boolean)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ATSUGetTransientFontMatching" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (oTransientFontMatching (:pointer :Boolean))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_ATSUCreateTextLayoutWithTextHandle" 
   ((iText (:Handle :UInt16))
    (iTextOffset :UInt32)
    (iTextLength :UInt32)
    (iTextTotalLength :UInt32)
...
(deftrap-inline "_ATSUSetTextHandleLocation" 
   ((iTextLayout (:pointer :OpaqueATSUTextLayout))
    (iText (:Handle :UInt16))
    (iTextOffset :UInt32)
    (iTextLength :UInt32)
...
(provide-interface "ATSUnicodeObjects")
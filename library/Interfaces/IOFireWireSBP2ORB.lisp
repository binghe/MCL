(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOFireWireSBP2ORB.h"
...
(defconstant $kFWSBP2MaxPageClusterSize #xF000)
...
; 	
 virtual void deallocatePageTable #\( void #\) #\; protected #\:;  IOFireWireSBP2Login methods
 virtual bool initWithLogin #\( IOFireWireSBP2Login * login #\) #\; virtual void setNextORBAddress #\( FWAddress address #\) #\; public #\:
; !
...
; 	
 virtual IOReturn allocatePageTable #\( UInt32 entryCount #\) #\; protected #\: virtual bool isTimerSet #\( void #\) #\; virtual void cancelTimer #\( void #\) #\; protected #\:;  reserved for future use
 struct ExpansionData #\{ #\} #\; ExpansionData * reserved #\; IOFireWireSBP2Login * fLogin #\; IOFireWireSBP2LUN * fLUN #\; IOFireWireUnit * fUnit #\; IOFireWireController * fControl #\; void * fUnused1 #\; void * fUnused2 #\; UInt32 fCommandFlags #\; UInt32 fMaxPayloadSize #\; UInt32 fTimeoutDuration #\; UInt32 fGeneration #\; void * fRefCon #\;; 
;  orb
; 
 IOBufferMemoryDescriptor * fORBDescriptor #\; FWSBP2ORB * fORBBuffer #\; FWAddress fORBPseudoAddress #\; IOFWAddressSpace * fORBPseudoAddressSpace #\; IOFWAddressSpace * fORBPhysicalAddressSpace #\; IOPhysicalAddress fORBPhysicalAddress #\;; 
;  page table
; 
 UInt32 fPageTableSize #\; IOBufferMemoryDescriptor * fPageTableDescriptor #\; IOFWAddressSpace * fPageTablePhysicalAddressSpace #\; IOPhysicalAddress fPageTablePhysicalAddress #\; IOFWAddressSpace * fPageTablePseudoAddressSpace #\; FWAddress fPageTablePseudoAddress #\;; 
;  buffers
; 
 IOFWAddressSpace * fBufferAddressSpace #\; bool fBufferAddressSpaceAllocated #\; IOMemoryDescriptor * fBufferDescriptor #\;; 
;  timer
; 
 IOFWDelayCommand * fTimeoutCommand #\; bool fTimeoutTimerSet #\; bool fInProgress #\; bool fIsAppended #\; UInt32 fFetchAgentWriteRetries #\; UInt32 fPTECount #\; virtual IOReturn allocateResources #\( void #\) #\; virtual void free #\( void #\) #\;;  orb timeout handler
 static void orbTimeoutStatic #\( void * refcon #\, IOReturn status #\, IOFireWireBus * bus #\, IOFWBusCommand * fwCmd #\) #\; virtual void orbTimeout #\( IOReturn status #\, IOFireWireBus * bus #\, IOFWBusCommand * fwCmd #\) #\;;  login friend class wrappers
 virtual IOFireWireUnit * getFireWireUnit #\( void #\) #\; virtual IOFireWireSBP2LUN * getFireWireLUN #\( void #\) #\; virtual void deallocateORB #\( void #\) #\; virtual IOReturn allocateORB #\( UInt32 orbSize #\) #\; virtual IOReturn removeORB #\( IOFireWireSBP2ORB * orb #\) #\; virtual void prepareORBForExecution #\( void #\) #\; virtual void startTimer #\( void #\) #\; virtual void sendTimeoutNotification #\( IOFireWireSBP2ORB * orb #\) #\; public #\:
; ! 
;         @function release
...
;     
 virtual IOMemoryDescriptor * getCommandBufferDescriptor #\( void #\) #\;;  accessors
; ! 
...
; 	
 virtual void * getRefCon #\( void #\) #\; protected #\: virtual void setToDummy #\( void #\) #\; public #\:
; !
...
; 	
 virtual void getORBAddress #\( FWAddress * address #\) #\; protected #\: virtual bool isAppended #\( void #\) #\; virtual void setIsAppended #\( bool state #\) #\; virtual UInt32 getFetchAgentWriteRetries #\( void #\) #\; virtual void setFetchAgentWriteRetries #\( UInt32 retries #\) #\; virtual void prepareFastStartPacket #\( IOBufferMemoryDescriptor * descriptor #\) #\;
|#

; #endif


(provide-interface "IOFireWireSBP2ORB")
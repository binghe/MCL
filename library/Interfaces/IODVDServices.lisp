(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IODVDServices.h"
...
(require-interface "IOKit/storage/IODVDBlockStorageDevice")

#|                                              ;  SCSI Architecture Model Family includes
|#

(require-interface "IOKit/scsi/IOSCSIPeripheralDeviceType05")
...
; ÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑ
#|
 confused about CLASS IODVDServices #\: public IODVDBlockStorageDevice #\{ OSDeclareDefaultStructors #\( IODVDServices #\)
...
; #endif
 ...
 protected #\: OSSet * fClients #\; IOSCSIPeripheralDeviceType05 * fProvider #\; virtual void free #\( void #\) #\;;  Reserve space for future expansion.
 struct IODVDServicesExpansionData #\{ #\} #\; IODVDServicesExpansionData * fIODVDServicesReserved #\; public #\: static void AsyncReadWriteComplete #\( void * clientData #\, IOReturn status #\, UInt64 actualByteCount #\) #\; virtual IOReturn doAsyncReadWrite #\( IOMemoryDescriptor * buffer #\, UInt32 block #\, UInt32 nblks #\, IOStorageCompletion completion #\) #\; virtual IOReturn doEjectMedia #\( void #\) #\; virtual IOReturn doFormatMedia #\( UInt64 byteCapacity #\) #\; virtual UInt32 doGetFormatCapacities #\( UInt64 * capacities #\, UInt32 capacitiesMaxCount #\) const #\; virtual IOReturn doLockUnlockMedia #\( bool doLock #\) #\; virtual IOReturn doSynchronizeCache #\( void #\) #\; virtual char * getVendorString #\( void #\) #\; virtual char * getProductString #\( void #\) #\; virtual char * getRevisionString #\( void #\) #\; virtual char * getAdditionalDeviceInfoString #\( void #\) #\; virtual IOReturn reportBlockSize #\( UInt64 * blockSize #\) #\; virtual IOReturn reportEjectability #\( bool * isEjectable #\) #\; virtual IOReturn reportLockability #\( bool * isLockable #\) #\; virtual IOReturn reportMediaState #\( bool * mediaPresent #\, bool * changed #\) #\; virtual IOReturn reportPollRequirements #\( bool * pollIsRequired #\, bool * pollIsExpensive #\) #\; virtual IOReturn reportMaxReadTransfer #\( UInt64 blockSize #\, UInt64 * max #\) #\; virtual IOReturn reportMaxValidBlock #\( UInt64 * maxBlock #\) #\; virtual IOReturn reportMaxWriteTransfer #\( UInt64 blockSize #\, UInt64 * max #\) #\; virtual IOReturn reportRemovability #\( bool * isRemovable #\) #\; virtual IOReturn reportWriteProtection #\( bool * isWriteProtected #\) #\;;  CD Specific 
 virtual IOReturn doAsyncReadCD #\( IOMemoryDescriptor * buffer #\, UInt32 block #\, UInt32 nblks #\, CDSectorArea sectorArea #\, CDSectorType sectorType #\, IOStorageCompletion completion #\) #\; virtual IOReturn readISRC #\( UInt8 track #\, CDISRC isrc #\) #\; virtual IOReturn readMCN #\( CDMCN mcn #\) #\; virtual IOReturn readTOC #\( IOMemoryDescriptor * buffer #\) #\; virtual IOReturn audioPause #\( bool pause #\) #\; virtual IOReturn audioPlay #\( CDMSF timeStart #\, CDMSF timeStop #\) #\; virtual IOReturn audioScan #\( CDMSF timeStart #\, bool reverse #\) #\; virtual IOReturn audioStop #\( void #\) #\; virtual IOReturn getAudioStatus #\( CDAudioStatus * status #\) #\; virtual IOReturn getAudioVolume #\( UInt8 * leftVolume #\, UInt8 * rightVolume #\) #\; virtual IOReturn setAudioVolume #\( UInt8 leftVolume #\, UInt8 rightVolume #\) #\; virtual IOReturn getSpeed #\( UInt16 * kilobytesPerSecond #\) #\; virtual IOReturn setSpeed #\( UInt16 kilobytesPerSecond #\) #\;;  DVD Specific 
 virtual UInt32 getMediaType #\( void #\) #\; virtual IOReturn reportKey #\( IOMemoryDescriptor * buffer #\, const DVDKeyClass keyClass #\, const UInt32 lba #\, const UInt8 agid #\, const DVDKeyFormat keyFormat #\) #\; virtual IOReturn sendKey #\( IOMemoryDescriptor * buffer #\, const DVDKeyClass keyClass #\, const UInt8 agid #\, const DVDKeyFormat keyFormat #\) #\; virtual IOReturn readDVDStructure #\( IOMemoryDescriptor * buffer #\, const UInt8 structureFormat #\, const UInt32 logicalBlockAddress #\, const UInt8 layer #\, const UInt8 agid #\) #\; virtual IOReturn message #\( UInt32 type #\, IOService * provider #\, void * argument #\) #\; virtual IOReturn setProperties #\( OSObject * properties #\) #\;;  User Client Specific 
 virtual bool start #\( IOService * provider #\) #\; virtual bool open #\( IOService * client #\, IOOptionBits options #\, IOStorageAccess access #\) #\; virtual bool handleOpen #\( IOService * client #\, IOOptionBits options #\, void * access #\) #\; virtual void handleClose #\( IOService * client #\, IOOptionBits options #\) #\; virtual bool handleIsOpen #\( const IOService * client #\) const #\;;  Added with 10.1.3 
 virtual IOReturn readTOC #\( IOMemoryDescriptor * buffer #\, CDTOCFormat format #\, UInt8 msf #\, UInt8 trackSessionNumber #\, UInt16 * actualByteCount #\) #\;;  Added with 10.1.3 
 virtual IOReturn readDiscInfo #\( IOMemoryDescriptor * buffer #\, UInt16 * actualByteCount #\) #\;;  Added with 10.1.3 
 virtual IOReturn readTrackInfo #\( IOMemoryDescriptor * buffer #\, UInt32 address #\, CDTrackInfoAddressType addressType #\, UInt16 * actualByteCount #\) #\; private #\:;  Space reserved for future expansion.
 OSMetaClassDeclareReservedUnused #\( IODVDServices #\, 1 #\) #\; OSMetaClassDeclareReservedUnused #\( IODVDServices #\, 2 #\) #\; OSMetaClassDeclareReservedUnused #\( IODVDServices #\, 3 #\) #\; OSMetaClassDeclareReservedUnused #\( IODVDServices #\, 4 #\) #\; OSMetaClassDeclareReservedUnused #\( IODVDServices #\, 5 #\) #\; OSMetaClassDeclareReservedUnused #\( IODVDServices #\, 6 #\) #\; OSMetaClassDeclareReservedUnused #\( IODVDServices #\, 7 #\) #\; OSMetaClassDeclareReservedUnused #\( IODVDServices #\, 8 #\) #\;
|#
 |#
...
(provide-interface "IODVDServices")
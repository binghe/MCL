(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:SecKeychain.h"
; at Sunday July 2,2006 7:31:45 pm.
; 
...
(defconstant $kSecUnlockStateStatus 1)
(defconstant $kSecReadPermStatus 2)
(defconstant $kSecWritePermStatus 4)
(defconstant $SEC_KEYCHAIN_SETTINGS_VERS1 1)
...
;type name? (%define-record :SecKeychainSettings (find-record-descriptor ':SecKeychainSettings))
; ! 
;     @typedef SecAuthenticationType
; 	@abstract Represents the type of authentication to use for an Internet password.
; 

(def-mactype :SecAuthenticationType (find-mactype ':FourCharCode))
; !
...
; #else
(defconstant $AUTH_TYPE_FIX_ 0)
; #define AUTH_TYPE_FIX_(x) (x)

; #endif


(defconstant $kSecAuthenticationTypeNTLM :|ntlm|)
(defconstant $kSecAuthenticationTypeMSN :|msna|)
(defconstant $kSecAuthenticationTypeDPA :|dpaa|)
(defconstant $kSecAuthenticationTypeRPA :|rpaa|)
(defconstant $kSecAuthenticationTypeHTTPBasic :|http|)
(defconstant $kSecAuthenticationTypeHTTPDigest :|httd|)
(defconstant $kSecAuthenticationTypeHTMLForm :|form|)
(defconstant $kSecAuthenticationTypeDefault :|dflt|)
; !
; 	@typedef SecProtocolType
; 	@abstract Represents the protocol type associated with an AppleShare or Internet password.
; 

(def-mactype :SecProtocolType (find-mactype ':FourCharCode))
; !
...
(defconstant $kSecProtocolTypeFTP :|ftp |)
(defconstant $kSecProtocolTypeFTPAccount :|ftpa|)
(defconstant $kSecProtocolTypeHTTP :|http|)
(defconstant $kSecProtocolTypeIRC :|irc |)
(defconstant $kSecProtocolTypeNNTP :|nntp|)
(defconstant $kSecProtocolTypePOP3 :|pop3|)
(defconstant $kSecProtocolTypeSMTP :|smtp|)
(defconstant $kSecProtocolTypeSOCKS :|sox |)
(defconstant $kSecProtocolTypeIMAP :|imap|)
(defconstant $kSecProtocolTypeLDAP :|ldap|)
(defconstant $kSecProtocolTypeAppleTalk :|atlk|)
(defconstant $kSecProtocolTypeAFP :|afp |)
(defconstant $kSecProtocolTypeTelnet :|teln|)
(defconstant $kSecProtocolTypeSSH :|ssh |)
(defconstant $kSecProtocolTypeFTPS :|ftps|)
(defconstant $kSecProtocolTypeHTTPS :|htps|)
(defconstant $kSecProtocolTypeHTTPProxy :|htpx|)
(defconstant $kSecProtocolTypeHTTPSProxy :|htsx|)
(defconstant $kSecProtocolTypeFTPProxy :|ftpx|)
(defconstant $kSecProtocolTypeSMB :|smb |)
(defconstant $kSecProtocolTypeRTSP :|rtsp|)
(defconstant $kSecProtocolTypeRTSPProxy :|rtsx|)
(defconstant $kSecProtocolTypeDAAP :|daap|)
(defconstant $kSecProtocolTypeEPPC :|eppc|)
(defconstant $kSecProtocolTypeIPP :|ipp |)
(defconstant $kSecProtocolTypeNNTPS :|ntps|)
(defconstant $kSecProtocolTypeLDAPS :|ldps|)
(defconstant $kSecProtocolTypeTelnetS :|tels|)
(defconstant $kSecProtocolTypeIMAPS :|imps|)
(defconstant $kSecProtocolTypeIRCS :|ircs|)
(defconstant $kSecProtocolTypePOP3S :|pops|)
; !
; 	@typedef SecKeychainEvent
; 	@abstract Represents an event in which the state of a keychain or one of its items changed.
; 

(def-mactype :SecKeychainEvent (find-mactype ':UInt32))
; !
...
(defconstant $kSecLockEvent 1)
(defconstant $kSecUnlockEvent 2)
(defconstant $kSecAddEvent 3)
(defconstant $kSecDeleteEvent 4)
(defconstant $kSecUpdateEvent 5)
(defconstant $kSecPasswordChangedEvent 6)
(defconstant $kSecDefaultChangedEvent 9)
(defconstant $kSecDataAccessEvent 10)
(defconstant $kSecKeychainListChangedEvent 11)
; !
; 	@typedef SecKeychainEventMask
; 	@abstract Represents a bit mask of keychain events
; 

(def-mactype :SecKeychainEventMask (find-mactype ':UInt32))
; !
; 	@enum KeychainEventConstants
...
(defconstant $kSecLockEventMask 2)
(defconstant $kSecUnlockEventMask 4)
(defconstant $kSecAddEventMask 8)
(defconstant $kSecDeleteEventMask 16)
(defconstant $kSecUpdateEventMask 32)
(defconstant $kSecPasswordChangedEventMask 64)
(defconstant $kSecDefaultChangedEventMask #x200)
(defconstant $kSecDataAccessEventMask #x400)
(defconstant $kSecKeychainListChangedMask #x800)
(defconstant $kSecEveryEventMask #xFFFFFFFF)
; !
...
; 
(defrecord SecKeychainCallbackInfo
   (version :UInt32)
...
;type name? (%define-record :SecKeychainCallbackInfo (find-record-descriptor ':SecKeychainCallbackInfo))
; !
...
(deftrap-inline "_SecKeychainGetTypeID" 
   (
   )
   :UInt32
() )
...
(deftrap-inline "_SecKeychainGetVersion" 
...
(deftrap-inline "_SecKeychainOpen" 
   ((pathName (:pointer :char))
    (keychain (:pointer :SecKeychainRef))
   )
   :SInt32
() )
; !
...
(deftrap-inline "_SecKeychainCreate" 
   ((pathName (:pointer :char))
    (passwordLength :UInt32)
    (password :pointer)
    (promptUser :Boolean)
    (initialAccess (:pointer :OpaqueSecAccessRef))
    (keychain (:pointer :SecKeychainRef))
   )
   :SInt32
() )
...
(deftrap-inline "_SecKeychainDelete" 
   ((keychainOrArray (:pointer :OpaqueSecKeychainRef))
   )
   :SInt32
() )
; !
...
(deftrap-inline "_SecKeychainSetSettings" 
   ((keychain (:pointer :OpaqueSecKeychainRef))
    (newSettings (:pointer :SecKeychainSettings))
   )
   :SInt32
() )
; !
...
(deftrap-inline "_SecKeychainCopySettings" 
   ((keychain (:pointer :OpaqueSecKeychainRef))
    (outSettings (:pointer :SecKeychainSettings))
   )
   :SInt32
() )
; !
...
(deftrap-inline "_SecKeychainUnlock" 
   ((keychain (:pointer :OpaqueSecKeychainRef))
    (passwordLength :UInt32)
    (password :pointer)
    (usePassword :Boolean)
...
(deftrap-inline "_SecKeychainLock" 
   ((keychain (:pointer :OpaqueSecKeychainRef))
   )
   :SInt32
() )
...
(deftrap-inline "_SecKeychainLockAll" 
   (
   )
   :SInt32
() )
...
(deftrap-inline "_SecKeychainCopyDefault" 
   ((keychain (:pointer :SecKeychainRef))
   )
   :SInt32
() )
...
(deftrap-inline "_SecKeychainSetDefault" 
   ((keychain (:pointer :OpaqueSecKeychainRef))
   )
   :SInt32
() )
...
(deftrap-inline "_SecKeychainCopySearchList" 
   ((searchList (:pointer :CFArrayRef))
   )
   :SInt32
() )
; !
...
(deftrap-inline "_SecKeychainSetSearchList" 
   ((searchList (:pointer :__CFArray))
   )
   :SInt32
() )
; 
...
(defconstant $kSecPreferencesDomainUser 0)      ;  user domain

(defconstant $kSecPreferencesDomainSystem 1)    ;  system (daemon) domain

(defconstant $kSecPreferencesDomainCommon 2)    ;  preferences to be merged to everyone
;  alternate user

(defconstant $kSecPreferencesDomainAlternate 3)
(def-mactype :SecPreferencesDomain (find-mactype ':SINT32))

(deftrap-inline "_SecKeychainCopyDomainDefault" 
   ((domain :SInt32)
    (keychain (:pointer :SecKeychainRef))
   )
   :SInt32
...
(deftrap-inline "_SecKeychainSetDomainDefault" 
   ((domain :SInt32)
    (keychain (:pointer :OpaqueSecKeychainRef))
   )
   :SInt32
...
(deftrap-inline "_SecKeychainCopyDomainSearchList" 
   ((domain :SInt32)
    (searchList (:pointer :CFArrayRef))
   )
   :SInt32
...
(deftrap-inline "_SecKeychainSetDomainSearchList" 
   ((domain :SInt32)
    (searchList (:pointer :__CFArray))
   )
   :SInt32
...
(deftrap-inline "_SecKeychainSetPreferenceDomain" 
   ((domain :SInt32)
   )
   :SInt32
() )

(deftrap-inline "_SecKeychainGetPreferenceDomain" 
   ((domain (:pointer :SecPreferencesDomain))
   )
   :SInt32
() )
; !
...
(deftrap-inline "_SecKeychainGetStatus" 
   ((keychain (:pointer :OpaqueSecKeychainRef))
    (keychainStatus (:pointer :SecKeychainStatus))
   )
   :SInt32
() )
; !
...
(deftrap-inline "_SecKeychainGetPath" 
   ((keychain (:pointer :OpaqueSecKeychainRef))
    (ioPathLength (:pointer :UInt32))
    (pathName (:pointer :char))
   )
   :SInt32
() )
...
(deftrap-inline "_SecKeychainAttributeInfoForItemID" 
   ((keychain (:pointer :OpaqueSecKeychainRef))
    (itemID :UInt32)
    (info (:pointer :SecKeychainAttributeInfo))
   )
   :SInt32
() )
; !
...
(deftrap-inline "_SecKeychainFreeAttributeInfo" 
   ((info (:pointer :SecKeychainAttributeInfo))
   )
   :SInt32
() )
...
(def-mactype :SecKeychainCallback (find-mactype ':pointer)); (SecKeychainEvent keychainEvent , SecKeychainCallbackInfo * info , void * context)
; !
...
(deftrap-inline "_SecKeychainAddCallback" 
...
(deftrap-inline "_SecKeychainRemoveCallback" 
   ((callbackFunction :pointer)
   )
   :SInt32
() )
...
(deftrap-inline "_SecKeychainAddInternetPassword" 
   ((keychain (:pointer :OpaqueSecKeychainRef))
    ...
    (path (:pointer :char))
    (port :UInt16)
    (protocol :FourCharCode)
    (authenticationType :FourCharCode)
    (passwordLength :UInt32)
    (passwordData :pointer)
    (itemRef (:pointer :SecKeychainItemRef))
   )
   :SInt32
() )
; !
...
(deftrap-inline "_SecKeychainFindInternetPassword" 
...
(deftrap-inline "_SecKeychainAddGenericPassword" 
   ((keychain (:pointer :OpaqueSecKeychainRef))
...
(deftrap-inline "_SecKeychainFindGenericPassword" 
   ((keychainOrArray (:pointer :void))
    (serviceNameLength :UInt32)
    (serviceName (:pointer :char))
    (accountNameLength :UInt32)
...
(deftrap-inline "_SecKeychainSetUserInteractionAllowed" 
   ((state :Boolean)
   )
   :SInt32
() )
...
(deftrap-inline "_SecKeychainGetUserInteractionAllowed" 
   ((state (:pointer :Boolean))
   )
   :SInt32
() )
...
(deftrap-inline "_SecKeychainGetCSPHandle" 
   ((keychain (:pointer :OpaqueSecKeychainRef))
    (cspHandle (:pointer :CSSM_CSP_HANDLE))
   )
   :SInt32
() )
; !
...
(deftrap-inline "_SecKeychainGetDLDBHandle" 
   ((keychain (:pointer :OpaqueSecKeychainRef))
    (dldbHandle (:pointer :CSSM_DL_DB_HANDLE))
   )
   :SInt32
() )
...
(deftrap-inline "_SecKeychainCopyAccess" 
   ((keychain (:pointer :OpaqueSecKeychainRef))
    (access (:pointer :SECACCESSREF))
   )
   :SInt32
() )
; !
...
(deftrap-inline "_SecKeychainSetAccess" 
   ((keychain (:pointer :OpaqueSecKeychainRef))

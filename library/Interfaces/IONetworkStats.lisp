(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IONetworkStats.h"
...
(defrecord IONetworkStats
   (inputPackets :UInt32)
   (inputErrors :UInt32)
   (outputPackets :UInt32)
   (outputErrors :UInt32)
   (collisions :UInt32)
)
...
;         an IONetworkStats. 
(defconstant $kIONetworkStatsKey "IONetworkStatsKey")
...
(defconstant $kIOOutputQueueStatsKey "IOOutputQueueStatsKey")
; #define kIOOutputQueueStatsKey          "IOOutputQueueStatsKey"

; #endif /* !_IONETWORKSTATS_H */


(provide-interface "IONetworkStats")
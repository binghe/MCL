(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:Sound.k.h"
...
#| #|
	#ifndefSOUNDCOMPONENT_GLOBALS
		#define SOUNDCOMPONENT_GLOBALS() 
		#define ADD_SOUNDCOMPONENT_COMMA 
	#else		#define ADD_SOUNDCOMPONENT_COMMA ,
	#endif	#define SOUNDCOMPONENT_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define SOUNDCOMPONENT_STRCAT(a,b) SOUNDCOMPONENT_GLUE(a,b)
...
#| #|
	...
	#else		#define ADD_AUDIO_COMMA ,
	#endif	#define AUDIO_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define AUDIO_STRCAT(a,b) AUDIO_GLUE(a,b)
...
#| #|
	#ifndefSNDINPUT_GLOBALS
		#define SNDINPUT_GLOBALS() 
		#define ADD_SNDINPUT_COMMA 
	#else		#define ADD_SNDINPUT_COMMA ,
	#endif	#define SNDINPUT_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define SNDINPUT_STRCAT(a,b) SNDINPUT_GLUE(a,b)

(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOPartitionScheme.h"
...
;  
(defconstant $kIOPartitionSchemeClass "IOPartitionScheme")
...
;  
(defconstant $kIOMediaPartitionIDKey "Partition ID")
; #define kIOMediaPartitionIDKey "Partition ID"

; #endif /* !_IOPARTITIONSCHEME_H */


(provide-interface "IOPartitionScheme")
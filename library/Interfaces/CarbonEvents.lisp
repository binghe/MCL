(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:CarbonEvents.h"
...
(defconstant $kEventParamPostTarget :|ptrg|)    ;  typeEventTargetRef
; 
;    * Indicates an event parameter of type EventTargetRef.
;    

(defconstant $typeEventTargetRef :|etrg|)       ;  EventTargetRef
...
(defconstant $kEventParamWindowRef :|wind|)     ;  typeWindowRef

(defconstant $kEventParamGrafPort :|graf|)      ;  typeGrafPtr

(defconstant $kEventParamMenuRef :|menu|)       ;  typeMenuRef

(defconstant $kEventParamEventRef :|evnt|)      ;  typeEventRef

(defconstant $kEventParamControlRef :|ctrl|)    ;  typeControlRef

(defconstant $kEventParamRgnHandle :|rgnh|)     ;  typeQDRgnHandle

(defconstant $kEventParamEnabled :|enab|)       ;  typeBoolean

(defconstant $kEventParamDimensions :|dims|)    ;  typeQDPoint

(defconstant $kEventParamBounds :|boun|)        ;  typeQDRectangle

(defconstant $kEventParamAvailableBounds :|avlb|);  typeQDRectangle

(defconstant $kEventParamAEEventID :|evti|)     ;  typeType

(defconstant $kEventParamAEEventClass :|evcl|)  ;  typeType

(defconstant $kEventParamCGContextRef :|cntx|)  ;  typeCGContextRef

(defconstant $kEventParamDeviceDepth :|devd|)   ;  typeShortInteger

(defconstant $kEventParamDeviceColor :|devc|)   ;  typeBoolean

(defconstant $kEventParamMutableArray :|marr|)  ;  typeCFMutableArrayRef

(defconstant $kEventParamResult :|ansr|)        ;  any type - depends on event like direct object

(defconstant $kEventParamMinimumSize :|mnsz|)   ;  typeHISize

(defconstant $kEventParamMaximumSize :|mxsz|)   ;  typeHISize

(defconstant $kEventParamAttributes :|attr|)    ;  typeUInt32

(defconstant $kEventParamReason :|why?|)        ;  typeUInt32

(defconstant $kEventParamTransactionID :|trns|) ;  typeUInt32

(defconstant $kEventParamGDevice :|gdev|)       ;  typeGDHandle

(defconstant $kEventParamIndex :|indx|)         ;  typeCFIndex

(defconstant $kEventParamUserData :|usrd|)      ;  typeVoidPtr

(defconstant $typeWindowRef :|wind|)            ;  WindowRef

(defconstant $typeGrafPtr :|graf|)              ;  CGrafPtr

(defconstant $typeGWorldPtr :|gwld|)            ;  GWorldPtr

(defconstant $typeMenuRef :|menu|)              ;  MenuRef

(defconstant $typeControlRef :|ctrl|)           ;  ControlRef

(defconstant $typeCollection :|cltn|)           ;  Collection

(defconstant $typeQDRgnHandle :|rgnh|)          ;  RgnHandle

(defconstant $typeOSStatus :|osst|)             ;  OSStatus

(defconstant $typeCFIndex :|cfix|)              ;  CFIndex

(defconstant $typeCGContextRef :|cntx|)         ;  CGContextRef

(defconstant $typeHIPoint :|hipt|)              ;  HIPoint

(defconstant $typeHISize :|hisz|)               ;  HISize

(defconstant $typeHIRect :|hirc|)               ;  HIRect

(defconstant $typeVoidPtr :|void|)              ;  void * (used for HIObject fun)

(defconstant $typeGDHandle :|gdev|)             ;  GDHandle

;  Mouse event parameters and types

(defconstant $kEventParamMouseLocation :|mloc|) ;  typeHIPoint

(defconstant $kEventParamWindowMouseLocation :|wmou|);  typeHIPoint (Mac OS X 10.1 or later)

(defconstant $kEventParamMouseButton :|mbtn|)   ;  typeMouseButton

(defconstant $kEventParamClickCount :|ccnt|)    ;  typeUInt32

(defconstant $kEventParamMouseWheelAxis :|mwax|);  typeMouseWheelAxis

(defconstant $kEventParamMouseWheelDelta :|mwdl|);  typeSInt32

(defconstant $kEventParamMouseDelta :|mdta|)    ;  typeHIPoint (10.2 or later) or typeQDPoint

(defconstant $kEventParamMouseChord :|chor|)    ;  typeUInt32

(defconstant $kEventParamTabletEventType :|tblt|);  typeUInt32

(defconstant $kEventParamMouseTrackingRef :|mtrf|);  typeMouseTrackingRef

(defconstant $typeMouseButton :|mbtn|)          ;  EventMouseButton

(defconstant $typeMouseWheelAxis :|mwax|)       ;  EventMouseWheelAxis

(defconstant $typeMouseTrackingRef :|mtrf|)     ;  MouseTrackingRef

;  Keyboard event parameter and types

(defconstant $kEventParamKeyCode :|kcod|)       ;  typeUInt32

(defconstant $kEventParamKeyMacCharCodes :|kchr|);  typeChar

(defconstant $kEventParamKeyModifiers :|kmod|)  ;  typeUInt32

(defconstant $kEventParamKeyUnicodes :|kuni|)   ;  typeUnicodeText

(defconstant $kEventParamKeyboardType :|kbdt|)  ;  typeUInt32

(defconstant $typeEventHotKeyID :|hkid|)        ;  EventHotKeyID

;  General TSM event parameters

(defconstant $kEventParamTSMSendRefCon :|tsrc|) ;     typeLongInteger

(defconstant $kEventParamTSMSendComponentInstance :|tsci|);     typeComponentInstance

;  TextInput event parameters

(defconstant $kEventParamTextInputSendRefCon :|tsrc|);     typeLongInteger

(defconstant $kEventParamTextInputSendComponentInstance :|tsci|);     typeComponentInstance

(defconstant $kEventParamTextInputSendSLRec :|tssl|);     typeIntlWritingCode

(defconstant $kEventParamTextInputReplySLRec :|trsl|);     typeIntlWritingCode

(defconstant $kEventParamTextInputSendText :|tstx|);     typeUnicodeText (if TSMDocument is Unicode), otherwise typeChar

(defconstant $kEventParamTextInputReplyText :|trtx|);     typeUnicodeText (if TSMDocument is Unicode), otherwise typeChar

(defconstant $kEventParamTextInputSendUpdateRng :|tsup|);     typeTextRangeArray

(defconstant $kEventParamTextInputSendHiliteRng :|tshi|);     typeTextRangeArray

(defconstant $kEventParamTextInputSendClauseRng :|tscl|);     typeOffsetArray

(defconstant $kEventParamTextInputSendPinRng :|tspn|);     typeTextRange

(defconstant $kEventParamTextInputSendFixLen :|tsfx|);     typeLongInteger

(defconstant $kEventParamTextInputSendLeadingEdge :|tsle|);     typeBoolean

(defconstant $kEventParamTextInputReplyLeadingEdge :|trle|);     typeBoolean

(defconstant $kEventParamTextInputSendTextOffset :|tsto|);     typeLongInteger

(defconstant $kEventParamTextInputReplyTextOffset :|trto|);     typeLongInteger

(defconstant $kEventParamTextInputReplyRegionClass :|trrg|);     typeLongInteger

(defconstant $kEventParamTextInputSendCurrentPoint :|tscp|);     typeQDPoint

(defconstant $kEventParamTextInputSendDraggingMode :|tsdm|);     typeBoolean

(defconstant $kEventParamTextInputReplyPoint :|trpt|);     typeQDPoint

(defconstant $kEventParamTextInputReplyFont :|trft|);     typeLongInteger

(defconstant $kEventParamTextInputReplyFMFont :|trfm|);     typeUInt32

(defconstant $kEventParamTextInputReplyPointSize :|trpz|);     typeFixed

(defconstant $kEventParamTextInputReplyLineHeight :|trlh|);     typeShortInteger

(defconstant $kEventParamTextInputReplyLineAscent :|trla|);     typeShortInteger

(defconstant $kEventParamTextInputReplyTextAngle :|trta|);     typeFixed

(defconstant $kEventParamTextInputSendShowHide :|tssh|);     typeBoolean

(defconstant $kEventParamTextInputReplyShowHide :|trsh|);     typeBoolean

(defconstant $kEventParamTextInputSendKeyboardEvent :|tske|);     typeEventRef

(defconstant $kEventParamTextInputSendTextServiceEncoding :|tsse|);     typeUInt32

(defconstant $kEventParamTextInputSendTextServiceMacEncoding :|tssm|);     typeUInt32

(defconstant $kEventParamTextInputReplyMacEncoding :|trme|);     typeUInt32

(defconstant $kEventParamTextInputGlyphInfoArray :|glph|);     typeGlyphInfoArray

(defconstant $kEventParamTextInputSendGlyphInfoArray :|glph|)
(defconstant $kEventParamTextInputReplyGlyphInfoArray :|rgph|);     typeGlyphInfoArray

(defconstant $kEventParamTextInputSendReplaceRange :|tsrp|);     typeCFRange

;  TSMDocumentAccess event parameters and types

(defconstant $kEventParamTSMDocAccessSendRefCon :|tsrc|);     typeLongInteger

(defconstant $kEventParamTSMDocAccessSendComponentInstance :|tsci|);     typeComponentInstance

(defconstant $kEventParamTSMDocAccessCharacterCount :|tdct|);     typeCFIndex

(defconstant $kEventParamTSMDocAccessReplyCharacterRange :|tdrr|);     typeCFRange

(defconstant $kEventParamTSMDocAccessReplyCharactersPtr :|tdrp|);     typePtr

(defconstant $kEventParamTSMDocAccessSendCharacterIndex :|tdsi|);     typeCFIndex

(defconstant $kEventParamTSMDocAccessSendCharacterRange :|tdsr|);     typeCFRange

(defconstant $kEventParamTSMDocAccessSendCharactersPtr :|tdsp|);     typePtr

(defconstant $kEventParamTSMDocAccessRequestedCharacterAttributes :|tdca|);     typeUInt32

(defconstant $kEventParamTSMDocAccessReplyATSFont :|tdaf|);     typeATSFontRef

(defconstant $kEventParamTSMDocAccessReplyFontSize :|tdrs|);     typeFloat

(defconstant $kEventParamTSMDocAccessEffectiveRange :|tder|);     typeRange

(defconstant $kEventParamTSMDocAccessReplyATSUGlyphSelector :|tdrg|);     typeGlyphSelector

(defconstant $kEventParamTSMDocAccessLockCount :|tdlc|);     typeCFIndex

(defconstant $typeATSFontRef :|atsf|)           ;     ATSFontRef

(defconstant $typeGlyphSelector :|glfs|)        ;     ATSUGlyphSelector

;  Command event parameters and types

(defconstant $kEventParamHICommand :|hcmd|)     ;  typeHICommand

(defconstant $typeHICommand :|hcmd|)            ;  HICommand

;  Window event parameters and types

(defconstant $kEventParamWindowFeatures :|wftr|);  typeUInt32

(defconstant $kEventParamWindowDefPart :|wdpc|) ;  typeWindowDefPartCode

(defconstant $kEventParamWindowPartCode :|wpar|);  typeWindowPartCode

(defconstant $kEventParamCurrentBounds :|crct|) ;  typeQDRectangle

(defconstant $kEventParamOriginalBounds :|orct|);  typeQDRectangle

(defconstant $kEventParamPreviousBounds :|prct|);  typeQDRectangle

(defconstant $kEventParamClickActivation :|clac|);  typeClickActivationResult

(defconstant $kEventParamWindowRegionCode :|wshp|);  typeWindowRegionCode

(defconstant $kEventParamWindowDragHiliteFlag :|wdhf|);  typeBoolean

(defconstant $kEventParamWindowModifiedFlag :|wmff|);  typeBoolean

(defconstant $kEventParamWindowProxyGWorldPtr :|wpgw|);  typeGWorldPtr

(defconstant $kEventParamWindowProxyImageRgn :|wpir|);  typeQDRgnHandle

(defconstant $kEventParamWindowProxyOutlineRgn :|wpor|);  typeQDRgnHandle

(defconstant $kEventParamWindowStateChangedFlags :|wscf|);  typeUInt32 

(defconstant $kEventParamWindowTitleFullWidth :|wtfw|);  typeSInt16

(defconstant $kEventParamWindowTitleTextWidth :|wttw|);  typeSInt16

(defconstant $kEventParamWindowGrowRect :|grct|);  typeQDRectangle

(defconstant $kEventParamPreviousDockRect :|pdrc|);  typeHIRect

(defconstant $kEventParamPreviousDockDevice :|pdgd|);  typeGDHandle

(defconstant $kEventParamCurrentDockRect :|cdrc|);  typeHIRect

(defconstant $kEventParamCurrentDockDevice :|cdgd|);  typeGDHandle

(defconstant $kEventParamWindowTransitionAction :|wtac|);  typeWindowTransitionAction

(defconstant $kEventParamWindowTransitionEffect :|wtef|);  typeWindowTransitionEffect

(defconstant $typeWindowRegionCode :|wshp|)     ;  WindowRegionCode

(defconstant $typeWindowDefPartCode :|wdpt|)    ;  WindowDefPartCode

(defconstant $typeWindowPartCode :|wpar|)       ;  WindowPartCode

(defconstant $typeClickActivationResult :|clac|);  ClickActivationResult

(defconstant $typeWindowTransitionAction :|wtac|);  WindowTransitionAction

(defconstant $typeWindowTransitionEffect :|wtef|);  WindowTransitionEffect

;  Control event parameters and types

(defconstant $kEventParamControlPart :|cprt|)   ;  typeControlPartCode

(defconstant $kEventParamInitCollection :|icol|);  typeCollection

(defconstant $kEventParamControlMessage :|cmsg|);  typeShortInteger

(defconstant $kEventParamControlParam :|cprm|)  ;  typeLongInteger

(defconstant $kEventParamControlResult :|crsl|) ;  typeLongInteger

(defconstant $kEventParamControlRegion :|crgn|) ;  typeQDRgnHandle

(defconstant $kEventParamControlAction :|caup|) ;  typeControlActionUPP

(defconstant $kEventParamControlIndicatorDragConstraint :|cidc|);  typeIndicatorDragConstraint

(defconstant $kEventParamControlIndicatorRegion :|cirn|);  typeQDRgnHandle

(defconstant $kEventParamControlIsGhosting :|cgst|);  typeBoolean

(defconstant $kEventParamControlIndicatorOffset :|ciof|);  typeQDPoint

(defconstant $kEventParamControlClickActivationResult :|ccar|);  typeClickActivationResult

(defconstant $kEventParamControlSubControl :|csub|);  typeControlRef

(defconstant $kEventParamControlOptimalBounds :|cobn|);  typeQDRectangle

(defconstant $kEventParamControlOptimalBaselineOffset :|cobo|);  typeShortInteger

(defconstant $kEventParamControlDataTag :|cdtg|);  typeEnumeration

(defconstant $kEventParamControlDataBuffer :|cdbf|);  typePtr

(defconstant $kEventParamControlDataBufferSize :|cdbs|);  typeLongInteger

(defconstant $kEventParamControlDrawDepth :|cddp|);  typeShortInteger

(defconstant $kEventParamControlDrawInColor :|cdic|);  typeBoolean

(defconstant $kEventParamControlFeatures :|cftr|);  typeUInt32

(defconstant $kEventParamControlPartBounds :|cpbd|);  typeQDRectangle

(defconstant $kEventParamControlOriginalOwningWindow :|coow|);  typeWindowRef

(defconstant $kEventParamControlCurrentOwningWindow :|ccow|);  typeWindowRef

(defconstant $kEventParamControlFocusEverything :|cfev|);  typeBoolean

(defconstant $kEventParamNextControl :|cnxc|)   ;  typeControlRef

(defconstant $kEventParamStartControl :|cstc|)  ;  typeControlRef

(defconstant $kEventParamControlSubview :|csvw|);  typeControlRef

(defconstant $kEventParamControlPreviousPart :|copc|);  typeControlPartCode

(defconstant $kEventParamControlCurrentPart :|cnpc|);  typeControlPartCode

(defconstant $kEventParamControlInvalRgn :|civr|);  typeQDRgnHandle

(defconstant $kEventParamControlValue :|cval|)  ;  typeLongInteger

(defconstant $kEventParamControlHit :|chit|)    ;  typeBoolean

(defconstant $kEventParamControlPartAutoRepeats :|caur|);  typeBoolean

(defconstant $kEventParamControlFrameMetrics :|cfmt|);  typeControlFrameMetrics

(defconstant $kEventParamControlWouldAcceptDrop :|cldg|);  typeBoolean

(defconstant $typeControlActionUPP :|caup|)     ;  ControlActionUPP

(defconstant $typeIndicatorDragConstraint :|cidc|);  IndicatorDragConstraint

(defconstant $typeControlPartCode :|cprt|)      ;  ControlPartCode

(defconstant $typeControlFrameMetrics :|cins|)  ;  HIViewFrameMetrics

;  Menu event parameters and types

(defconstant $kEventParamCurrentMenuTrackingMode :|cmtm|);  typeMenuTrackingMode

(defconstant $kEventParamNewMenuTrackingMode :|nmtm|);  typeMenuTrackingMode

(defconstant $kEventParamMenuFirstOpen :|1sto|) ;  typeBoolean

(defconstant $kEventParamMenuItemIndex :|item|) ;  typeMenuItemIndex

(defconstant $kEventParamMenuCommand :|mcmd|)   ;  typeMenuCommand

(defconstant $kEventParamEnableMenuForKeyEvent :|fork|);  typeBoolean

(defconstant $kEventParamMenuEventOptions :|meop|);  typeMenuEventOptions

(defconstant $kEventParamMenuContext :|mctx|)   ;  typeUInt32

(defconstant $kEventParamMenuDismissed :|mdis|) ;  typeUInt32

(defconstant $kEventParamMenuItemBounds :|mitb|);  typeQDRectangle

(defconstant $kEventParamMenuMarkBounds :|mmkb|);  typeQDRectangle

(defconstant $kEventParamMenuIconBounds :|micb|);  typeQDRectangle

(defconstant $kEventParamMenuTextBounds :|mtxb|);  typeQDRectangle

(defconstant $kEventParamMenuTextBaseline :|mtbl|);  typeShortInteger

(defconstant $kEventParamMenuCommandKeyBounds :|mcmb|);  typeQDRectangle

(defconstant $kEventParamMenuVirtualTop :|mvrt|);  typeLongInteger

(defconstant $kEventParamMenuVirtualBottom :|mvrb|);  typeLongInteger

(defconstant $kEventParamMenuDrawState :|mdrs|) ;  typeThemeMenuState

(defconstant $kEventParamMenuItemType :|mitp|)  ;  typeThemeMenuItemType

(defconstant $kEventParamMenuItemWidth :|mitw|) ;  typeShortInteger

(defconstant $kEventParamMenuItemHeight :|mith|);  typeShortInteger

(defconstant $kEventParamMenuFrameView :|mfrv|) ;  typeControlRef

(defconstant $kEventParamMenuType :|mtyp|)      ;  typeThemeMenuType

(defconstant $kEventParamMenuIsPopup :|mpop|)   ;  typeBoolean

(defconstant $kEventParamMenuDirection :|mdir|) ;  typeMenuDirection

(defconstant $kEventParamParentMenu :|mprm|)    ;  typeMenuRef

(defconstant $kEventParamParentMenuItem :|mpri|);  typeMenuItemIndex

(defconstant $kEventParamMenuPopupItem :|mpit|) ;  typeMenuItemIndex

(defconstant $typeMenuItemIndex :|midx|)        ;  MenuItemIndex

(defconstant $typeMenuCommand :|mcmd|)          ;  MenuCommand

(defconstant $typeMenuTrackingMode :|mtmd|)     ;  MenuTrackingMode

(defconstant $typeMenuEventOptions :|meop|)     ;  MenuEventOptions

(defconstant $typeThemeMenuState :|tmns|)       ;  ThemeMenuState

(defconstant $typeThemeMenuItemType :|tmit|)    ;  ThemeMenuItemType

(defconstant $typeMenuDirection :|mdir|)        ;  UInt32

(defconstant $typeThemeMenuType :|tmty|)        ;  ThemeMenuType

;  Application event parameters

(defconstant $kEventParamProcessID :|psn |)     ;  typeProcessSerialNumber

(defconstant $kEventParamLaunchRefCon :|lref|)  ;  typeUInt32

(defconstant $kEventParamLaunchErr :|err |)     ;  typeOSStatus

(defconstant $kEventParamSystemUIMode :|uimd|)  ;  typeUInt32

(defconstant $kEventParamIsInInstantMouser :|imou|);  typeBoolean

(defconstant $kEventParamPreviousWindow :|prvw|);  typeWindowRef

(defconstant $kEventParamCurrentWindow :|curw|) ;  typeWindowRef

;  Tablet event parameters and types

(defconstant $kEventParamTabletPointRec :|tbrc|);  typeTabletPointRec

(defconstant $kEventParamTabletProximityRec :|tbpx|);  typeTabletProximityRec

(defconstant $typeTabletPointRec :|tbrc|)       ;  kEventParamTabletPointRec

(defconstant $typeTabletProximityRec :|tbpx|)   ;  kEventParamTabletProximityRec

(defconstant $kEventParamTabletPointerRec :|tbrc|);  typeTabletPointerRec      -- deprecated, for compatibility only

(defconstant $typeTabletPointerRec :|tbrc|)     ;  kEventParamTabletPointerRec    -- deprecated, for compatibility only

;  Appearance event parameters

(defconstant $kEventParamNewScrollBarVariant :|nsbv|);  typeShortInteger

;  Service event parameters

(defconstant $kEventParamPasteboardRef :|pbrd|) ;     typePasteboardRef

(defconstant $kEventParamScrapRef :|scrp|)      ;     typeScrapRef

(defconstant $kEventParamServiceCopyTypes :|svsd|);     typeCFMutableArrayRef

(defconstant $kEventParamServicePasteTypes :|svpt|);     typeCFMutableArrayRef

(defconstant $kEventParamServiceMessageName :|svmg|);     typeCFStringRef

(defconstant $kEventParamServiceUserData :|svud|);     typeCFStringRef

(defconstant $typePasteboardRef :|pbrd|)        ;     PasteboardRef

(defconstant $typeScrapRef :|scrp|)             ;     ScrapRef

;  Accessibility event parameters

(defconstant $kEventParamAccessibleObject :|aobj|);  typeCFTypeRef with an AXUIElementRef

(defconstant $kEventParamAccessibleChild :|achl|);  typeCFTypeRef with an AXUIElementRef

(defconstant $kEventParamAccessibleAttributeName :|atnm|);  typeCFStringRef

(defconstant $kEventParamAccessibleAttributeNames :|atns|);  typeCFMutableArrayRef of CFStringRefs

(defconstant $kEventParamAccessibleAttributeValue :|atvl|);  variable

(defconstant $kEventParamAccessibleAttributeSettable :|atst|);  typeBoolean

(defconstant $kEventParamAccessibleAttributeParameter :|atpa|);  typeCFTypeRef

(defconstant $kEventParamAccessibleActionName :|acnm|);  typeCFStringRef

(defconstant $kEventParamAccessibleActionNames :|acns|);  typeCFMutableArrayRef of CFStringRefs

(defconstant $kEventParamAccessibleActionDescription :|acds|);  typeCFMutableStringRef

(defconstant $kEventParamAccessibilityEventQueued :|aequ|);  typeBoolean

;  Text field event type

(defconstant $typeCFRange :|cfrn|)              ;  CFRange
...
(defconstant $kTrackMouseLocationOptionDontConsumeMouseUp 1)

(def-mactype :MouseTrackingResult (find-mactype ':UInt16))

(defconstant $kMouseTrackingMouseDown 1)
(defconstant $kMouseTrackingMouseUp 2)
(defconstant $kMouseTrackingMouseExited 3)
(defconstant $kMouseTrackingMouseEntered 4)
(defconstant $kMouseTrackingMouseDragged 5)
(defconstant $kMouseTrackingKeyModifiersChanged 6)
(defconstant $kMouseTrackingUserCancelled 7)
(defconstant $kMouseTrackingTimedOut 8)
(defconstant $kMouseTrackingMouseMoved 9)
; 
...
(deftrap-inline "_IsUserCancelEventRef" 
...
(deftrap-inline "_TrackMouseLocation" 
   ((inPort (:pointer :OpaqueGrafPtr))          ;  can be NULL 
    (outPt (:pointer :Point))
    (outResult (:pointer :MOUSETRACKINGRESULT))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_TrackMouseLocationWithOptions" 
   ((inPort (:pointer :OpaqueGrafPtr))          ;  can be NULL 
    (inOptions :UInt32)
    (inTimeout :double-float)
    (outPt (:pointer :Point))
    (outModifiers (:pointer :UInt32))           ;  can be NULL 
    (outResult (:pointer :MOUSETRACKINGRESULT))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_TrackMouseRegion" 
   ((inPort (:pointer :OpaqueGrafPtr))          ;  can be NULL 
    (inRegion (:pointer :OpaqueRgnHandle))
    (ioWasInRgn (:pointer :Boolean))
    (outResult (:pointer :MOUSETRACKINGRESULT))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
...
(defconstant $kMouseParamsSticky :|stic|)
; 
...
(deftrap-inline "_HIMouseTrackingGetParameters" 
   ((inSelector :OSType)
    (outTime (:pointer :EventTime))             ;  can be NULL 
    (outDistance (:pointer :HISIZE))            ;  can be NULL 
...
(deftrap-inline "_ConvertEventRefToEventRecord" 
   ((inEvent (:pointer :OpaqueEventRef))
    (outEvent (:pointer :EventRecord))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :Boolean
() )
; 
...
(deftrap-inline "_GetLastUserEventTime" 
   (
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :double-float
() )
...
(deftrap-inline "_IsMouseCoalescingEnabled" 
   (
...
(deftrap-inline "_SetMouseCoalescingEnabled" 
   ((inNewState :Boolean)
    (outOldState (:pointer :Boolean))           ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_1_AND_LATER
   :OSStatus
() )
; ======================================================================================
...
(defconstant $kEventClassMouse :|mous|)
; 
;    * Events related to the keyboard.
;    

(defconstant $kEventClassKeyboard :|keyb|)
; 
;    * Events related to text input (by keyboard, or by input method).
;    

(defconstant $kEventClassTextInput :|text|)
; 
;    * Application-level events (launch, quit, etc.).
;    

(defconstant $kEventClassApplication :|appl|)
; 
;    * Apple Events.
;    

(defconstant $kEventClassAppleEvent :|eppc|)
; 
;    * Events related to menus.
;    

(defconstant $kEventClassMenu :|menu|)
; 
;    * Events related to windows.
;    

(defconstant $kEventClassWindow :|wind|)
; 
;    * Events related to controls.
;    

(defconstant $kEventClassControl :|cntl|)
; 
;    * Events related to commands generated by menu items or controls.
;    * These events contain HICommand structures.
;    

(defconstant $kEventClassCommand :|cmds|)
; 
;    * Events related to tablets.
;    

(defconstant $kEventClassTablet :|tblt|)
; 
;    * Events related to File Manager volumes.
;    

(defconstant $kEventClassVolume :|vol |)
; 
;    * Events related to the Appearance Manager.
;    

(defconstant $kEventClassAppearance :|appm|)
; 
;    * Events related to the Services Manager.
;    

(defconstant $kEventClassService :|serv|)
; 
;    * Events related to toolbars.
;    

(defconstant $kEventClassToolbar :|tbar|)
; 
;    * Events related to toolbar items.
;    

(defconstant $kEventClassToolbarItem :|tbit|)
; 
;    * Events related to toolbar item views.
;    

(defconstant $kEventClassToolbarItemView :|tbiv|)
; 
;    * Events related to application accessibility.
;    

(defconstant $kEventClassAccessibility :|acce|)
; 
;    * Events related to the system.
;    

(defconstant $kEventClassSystem :|macs|)
; 
;    * Events related to Ink.
;    

(defconstant $kEventClassInk :|ink |)
(defconstant $kEventClassTSMDocumentAccess :|tdac|)
; ——————————————————————————————————————————————————————————————————————————————————————
;  Mouse Events                                                                         
; ——————————————————————————————————————————————————————————————————————————————————————
; 
...
(def-mactype :EventMouseButton (find-mactype ':UInt16))
; 
;    * Only button for a one-button mouse (usually left button for
;    * multi-button mouse)
;    

(defconstant $kEventMouseButtonPrimary 1)
; 
;    * Usually right button for a multi-button mouse
;    

(defconstant $kEventMouseButtonSecondary 2)
; 
;    * Usually middle button for a three-button mouse
;    

(defconstant $kEventMouseButtonTertiary 3)
; 
;  *  EventMouseWheelAxis
;  *  
;  

(def-mactype :EventMouseWheelAxis (find-mactype ':UInt16))
; 
;    * The X axis (left or right)
;    

(defconstant $kEventMouseWheelAxisX 0)
; 
;    * The Y axis (up or down)
;    

(defconstant $kEventMouseWheelAxisY 1)
; 
...
(defconstant $kEventMouseMoved 5)
; 
...
(defconstant $kEventMouseDragged 6)
; 
...
(defconstant $kEventMouseEntered 8)
; 
...
(defconstant $kEventMouseExited 9)
; 
...
(defconstant $kEventMouseWheelMoved 10)
; ——————————————————————————————————————————————————————————————————————————————————————
...
(defconstant $kEventTSMDocumentAccessGetLength 1)
; 
...
(defconstant $kEventTSMDocumentAccessGetSelectedRange 2)
; 
...
(defconstant $kEventTSMDocumentAccessGetCharactersPtr 3)
; 
...
(defconstant $kEventTSMDocumentAccessGetCharactersPtrForLargestBuffer 4)
; 
...
(defconstant $kEventTSMDocumentAccessGetCharacters 5)
; 
; 
...
(defconstant $kTSMDocAccessFontSizeAttributeBit 0)
; 
...
(defconstant $kTSMDocAccessEffectiveRangeAttributeBit 1)

(def-mactype :TSMDocAccessAttributes (find-mactype ':UInt32))

(defconstant $kTSMDocAccessFontSizeAttribute 1) ;  More attributes may be added in the future

(defconstant $kTSMDocAccessEffectiveRangeAttribute 2)
; 
...
(defconstant $kEventTSMDocumentAccessGetFont 6)
; 
...
(defconstant $kEventTSMDocumentAccessGetGlyphInfo 7)
; 
; 
...
(defconstant $kEventTSMDocumentAccessLockDocument 8)
; 
...
(defconstant $kEventTSMDocumentAccessUnlockDocument 9)
; ——————————————————————————————————————————————————————————————————————————————————————
;  Text Input Events                                                                    
; ——————————————————————————————————————————————————————————————————————————————————————
; 
...
(defconstant $kEventTextInputUpdateActiveInputArea 1)
; 
...
(defconstant $kEventTextInputUnicodeForKeyEvent 2)
; 
...
(defconstant $kEventTextInputOffsetToPos 3)
; 
...
(defconstant $kEventTextInputPosToOffset 4)
; 
...
(defconstant $kEventTextInputShowHideBottomWindow 5)
; 
...
(defconstant $kEventTextInputGetSelectedText 6)
; 
...
(defconstant $kEventTextInputUnicodeText 7)
; ——————————————————————————————————————————————————————————————————————————————————————
;  Raw Keyboard Events                                                                  
; ——————————————————————————————————————————————————————————————————————————————————————
; 
...
(defconstant $kEventRawKeyDown 1)
; 
...
(defconstant $kEventRawKeyRepeat 2)
; 
...
(defconstant $kEventRawKeyModifiersChanged 4)
; 
...
(defconstant $kEventHotKeyPressed 5)
; 
...
(defconstant $kEventHotKeyReleased 6)
; 
;  *  Summary:
...
(defconstant $kEventKeyModifierNumLockBit 16)   ;  Num Lock is on? (Mac OS X only)
; 
;    * The Fn key state bit (Mac OS X only).
;    

(defconstant $kEventKeyModifierFnBit 17)        ;  Fn key is down? (Mac OS X only)


(defconstant $kEventKeyModifierNumLockMask #x10000)
(defconstant $kEventKeyModifierFnMask #x20000)
; ——————————————————————————————————————————————————————————————————————————————————————
;  Application Events                                                                   
; ——————————————————————————————————————————————————————————————————————————————————————
; 
...
(defconstant $kEventAppActivated 1)
; 
...
(defconstant $kEventAppDeactivated 2)
; 
...
(defconstant $kEventAppLaunchNotification 4)
; 
...
(defconstant $kEventAppLaunched 5)
; 
...
(defconstant $kEventAppTerminated 6)
; 
...
(defconstant $kEventAppFrontSwitched 7)
; 
...
(defconstant $kEventAppHidden 107)
; 
...
(defconstant $kEventAppShown 108)
; 
...
(defconstant $kEventAppSystemUIModeChanged 109)
; 
;  
; 
...
(defconstant $kAvailBoundsChangedForDock 1)
; 
;    * Indicates that a device’s available window positioning bounds have
;    * changed because of a change in display configuration.
;    

(defconstant $kAvailBoundsChangedForDisplay 2)
; 
...
(defconstant $kEventAppAvailableWindowBoundsChanged 110)
; 
...
(defconstant $kEventAppActiveWindowChanged 111)
; 
...
(defconstant $kEventAppGetDockTileMenu 20)
; 
...
(defconstant $kEventAppFocusMenuBar 8)
; 
...
(defconstant $kEventAppFocusNextDocumentWindow 9)
; 
...
(defconstant $kEventAppFocusNextFloatingWindow 10)
; 
...
(defconstant $kEventAppFocusToolbar 11)
; 
...
(defconstant $kEventAppIsEventInInstantMouser 104)
; ——————————————————————————————————————————————————————————————————————————————————————
;   Apple Events                                                                        
; ——————————————————————————————————————————————————————————————————————————————————————
; 
...
(defconstant $kEventAppleEvent 1)
; ——————————————————————————————————————————————————————————————————————————————————————
;   Window Events                                                                       
; ——————————————————————————————————————————————————————————————————————————————————————
; 
...
(defconstant $kEventWindowUpdate 1)
; 
...
(defconstant $kEventWindowDrawContent 2)
; 
...
(defconstant $kEventWindowActivated 5)
; 
...
(defconstant $kEventWindowDeactivated 6)
; 
...
(defconstant $kEventWindowGetClickActivation 7)
; 
;  *  Summary:
...
(defconstant $kWindowBoundsChangeUserDrag 1)
; 
;    * The bounds is changing because the user is resizing the window.
;    

(defconstant $kWindowBoundsChangeUserResize 2)
; 
;    * The dimensions of the window (width and height) are changing.
;    

(defconstant $kWindowBoundsChangeSizeChanged 4)
; 
;    * The top left corner (origin) is changing.
;    

(defconstant $kWindowBoundsChangeOriginChanged 8)
; 
...
(defconstant $kWindowBoundsChangeZoom 16)
; 
...
(defconstant $kEventWindowShowing 22)
; 
...
(defconstant $kEventWindowHiding 23)
; 
...
(defconstant $kEventWindowShown 24)
; 
...
(defconstant $kEventWindowHidden 25)
; 
...
(defconstant $kEventWindowCollapsing 86)
; 
...
(defconstant $kEventWindowCollapsed 67)
; 
...
(defconstant $kEventWindowExpanding 87)
; 
...
(defconstant $kEventWindowExpanded 70)
; 
...
(defconstant $kEventWindowZoomed 76)
; 
...
(defconstant $kEventWindowBoundsChanging 26)
; 
...
(defconstant $kEventWindowBoundsChanged 27)
; 
...
(defconstant $kEventWindowResizeStarted 28)
; 
...
(defconstant $kEventWindowResizeCompleted 29)
; 
...
(defconstant $kEventWindowDragStarted 30)
; 
...
(defconstant $kEventWindowDragCompleted 31)
; 
...
(defconstant $kEventWindowClosed 73)
; 
...
(defconstant $kEventWindowTransitionStarted 88)
; 
...
(defconstant $kEventWindowTransitionCompleted 89)
; 
...
(defconstant $kEventWindowClickDragRgn 32)
; 
...
(defconstant $kEventWindowClickResizeRgn 33)
; 
...
(defconstant $kEventWindowClickCollapseRgn 34)
; 
...
(defconstant $kEventWindowClickCloseRgn 35)
; 
...
(defconstant $kEventWindowClickZoomRgn 36)
; 
...
(defconstant $kEventWindowClickContentRgn 37)
; 
...
(defconstant $kEventWindowClickProxyIconRgn 38)
; 
...
(defconstant $kEventWindowClickToolbarButtonRgn 41)
; 
...
(defconstant $kEventWindowClickStructureRgn 42)
; 
...
(defconstant $kEventWindowCursorChange 40)
; 
...
(defconstant $kEventWindowCollapse 66)
; 
...
(defconstant $kEventWindowCollapseAll 68)
; 
...
(defconstant $kEventWindowExpand 69)
; 
...
(defconstant $kEventWindowExpandAll 71)
; 
...
(defconstant $kEventWindowClose 72)
; 
...
(defconstant $kEventWindowCloseAll 74)
; 
...
(defconstant $kEventWindowZoom 75)
; 
...
(defconstant $kEventWindowZoomAll 77)
; 
...
(defconstant $kEventWindowContextualMenuSelect 78)
; 
...
(defconstant $kEventWindowPathSelect 79)
; 
...
(defconstant $kEventWindowGetIdealSize 80)
; 
...
(defconstant $kEventWindowGetMinimumSize 81)
; 
...
(defconstant $kEventWindowGetMaximumSize 82)
; 
...
(defconstant $kEventWindowConstrain 83)
; 
...
(defconstant $kEventWindowProxyBeginDrag #x80)
; 
...
(defconstant $kEventWindowProxyEndDrag #x81)
; 
...
(defconstant $kEventWindowHandleContentClick 85)
; 
...
(defconstant $kEventWindowGetDockTileMenu 90)
; 
...
(defconstant $kEventWindowToolbarSwitchMode #x96)
; 
...
(defconstant $kEventWindowFocusAcquired #xC8)
; 
...
(defconstant $kEventWindowFocusRelinquish #xC9)
; 
...
(defconstant $kEventWindowFocusContent #xCA)
; 
...
(defconstant $kEventWindowFocusToolbar #xCB)
; 
...
(defconstant $kEventWindowDrawerOpening #xDC)
; 
...
(defconstant $kEventWindowDrawerOpened #xDD)
; 
...
(defconstant $kEventWindowDrawerClosing #xDE)
; 
...
(defconstant $kEventWindowDrawerClosed #xDF)
; 
...
(defconstant $kEventWindowDrawFrame #x3E8)
; 
...
(defconstant $kEventWindowDrawPart #x3E9)
; 
...
(defconstant $kEventWindowGetRegion #x3EA)
; 
...
(defconstant $kEventWindowHitTest #x3EB)
; 
...
(defconstant $kEventWindowInit #x3EC)
; 
...
(defconstant $kEventWindowDispose #x3ED)
; 
...
(defconstant $kEventWindowDragHilite #x3EE)
; 
...
(defconstant $kEventWindowModified #x3EF)
; 
...
(defconstant $kEventWindowSetupProxyDragImage #x3F0)
; 
...
(defconstant $kEventWindowStateChanged #x3F1)
; 
...
(defconstant $kEventWindowMeasureTitle #x3F2)
; 
...
(defconstant $kEventWindowDrawGrowBox #x3F3)
; 
...
(defconstant $kEventWindowGetGrowImageRegion #x3F4)
; 
...
(defconstant $kEventWindowPaint #x3F5)
; ——————————————————————————————————————————————————————————————————————————————————————
;   Menu Events                                                                         
; ——————————————————————————————————————————————————————————————————————————————————————
; 
...
(defconstant $kMenuContextMenuEnabling #x80000)
; 
...
(defconstant $kMenuContextCommandIDSearch #x100000)
; 
;  *  Summary:
;  *    Menu direction
;  
...
(defconstant $kEventMenuBeginTracking 1)
; 
...
(defconstant $kEventMenuEndTracking 2)
; 
...
(defconstant $kEventMenuChangeTrackingMode 3)
; 
...
(defconstant $kEventMenuOpening 4)
; 
...
(defconstant $kEventMenuClosed 5)
; 
...
(defconstant $kEventMenuTargetItem 6)
; 
...
(defconstant $kEventMenuMatchKey 7)
; 
...
(defconstant $kEventMenuEnableItems 8)
; 
...
(defconstant $kEventMenuPopulate 9)
; 
...
(defconstant $kEventMenuDispose #x3E9)
; 
...
(defconstant $kEventMenuMeasureItemWidth 100)
; 
...
(defconstant $kEventMenuMeasureItemHeight 101)
; 
...
(defconstant $kEventMenuDrawItem 102)
; 
...
(defconstant $kEventMenuDrawItemContent 103)
; 
...
(defconstant $kEventMenuCalculateSize #x3EC)
; 
...
(defconstant $kEventMenuCreateFrameView #x3ED)
; 
...
(defconstant $kEventMenuGetFrameBounds #x3EE)
; 
...
(defconstant $kEventMenuBecomeScrollable #x3EF)
; 
...
(defconstant $kEventMenuCeaseToBeScrollable #x3F0)
; 
...
(defconstant $kEventMenuBarShown #x7D0)
; 
...
(defconstant $kEventMenuBarHidden #x7D1)
; ——————————————————————————————————————————————————————————————————————————————————————
;   Command Events                                                                      
; ——————————————————————————————————————————————————————————————————————————————————————
; 
...
(defconstant $kEventCommandProcess 1)
; 
...
(defconstant $kEventCommandUpdateStatus 2)
;  HI Commands 
; 
;  *  Summary:
;  *    Common command IDs
...
(defconstant $kHICommandHide :|hide|)
; 
...
(defconstant $kHICommandHideOthers :|hido|)
; 
...
(defconstant $kHICommandShowAll :|shal|)
; 
;    * The Preferences menu item has been selected.
;    

(defconstant $kHICommandPreferences :|pref|)
; 
...
(defconstant $kHICommandZoomWindow :|zoom|)
; 
...
(defconstant $kHICommandMinimizeWindow :|mini|)
; 
...
(defconstant $kHICommandMinimizeAll :|mina|)
; 
...
(defconstant $kHICommandMaximizeWindow :|maxi|)
; 
...
(defconstant $kHICommandMaximizeAll :|maxa|)
; 
...
(defconstant $kHICommandArrangeInFront :|frnt|)
; 
...
(defconstant $kHICommandBringAllToFront :|bfrt|)
; 
...
(defconstant $kHICommandWindowListSeparator :|wldv|)
; 
...
(defconstant $kHICommandWindowListTerminator :|wlst|)
; 
...
(defconstant $kHICommandSelectWindow :|swin|)
; 
...
(defconstant $kHICommandRotateWindowsForward :|rotw|)
; 
;    * The Rotate Windows hotkey (cmd-~ by default) has been pressed, and
...
(defconstant $kHICommandRotateWindowsBackward :|rotb|)
; 
...
(defconstant $kHICommandRotateFloatingWindowsForward :|rtfw|)
; 
;    * The floating window focus hotkey (ctl-F6 by default) has been
;    * pressed, and floating windows should be rotated so that the window
...
(defconstant $kHICommandAppHelp :|ahlp|)
; 
...
(defconstant $kHICommandShowCharacterPalette :|chrp|)
; 
;  *  Summary:
...
;type name? (%define-record :HICommandExtended (find-record-descriptor ':HICommandExtended))
; ——————————————————————————————————————————————————————————————————————————————————————
;   Control Events                                                                      
; ——————————————————————————————————————————————————————————————————————————————————————
; 
...
(defconstant $kEventControlClick 13)
; 
...
(defconstant $kEventControlHit 1)
; 
...
(defconstant $kEventControlInitialize #x3E8)
; 
...
(defconstant $kEventControlDispose #x3E9)
; 
...
(defconstant $kEventControlGetOptimalBounds #x3EB)
; 
...
(defconstant $kEventControlSimulateHit 2)
; 
...
(defconstant $kEventControlHitTest 3)
; 
...
(defconstant $kEventControlDraw 4)
; 
...
(defconstant $kEventControlApplyBackground 5)
; 
...
(defconstant $kEventControlApplyTextColor 6)
; 
...
(defconstant $kEventControlGetNextFocusCandidate 14)
; 
...
(defconstant $kEventControlGetAutoToggleValue 15)
; 
...
(defconstant $kEventControlInterceptSubviewClick 16)
; 
...
(defconstant $kEventControlGetClickActivation 17)
; 
...
(defconstant $kEventControlDragEnter 18)
; 
...
(defconstant $kEventControlDragWithin 19)
; 
...
(defconstant $kEventControlDragLeave 20)
; 
...
(defconstant $kEventControlDragReceive 21)
; 
...
(defconstant $kEventControlSetFocusPart 7)
; 
...
(defconstant $kEventControlGetFocusPart 8)
; 
...
(defconstant $kEventControlActivate 9)
; 
...
(defconstant $kEventControlDeactivate 10)
; 
...
(defconstant $kEventControlSetCursor 11)
; 
...
(defconstant $kEventControlContextualMenuClick 12)
; 
...
(defconstant $kEventControlTrack 51)
; 
...
(defconstant $kEventControlGetScrollToHereStartPoint 52)
; 
...
(defconstant $kEventControlGetIndicatorDragConstraint 53)
; 
...
(defconstant $kEventControlIndicatorMoved 54)
; 
...
(defconstant $kEventControlGhostingFinished 55)
; 
...
(defconstant $kEventControlGetActionProcPart 56)
; 
...
(defconstant $kEventControlGetPartRegion 101)
; 
...
(defconstant $kEventControlGetPartBounds 102)
; 
...
(defconstant $kEventControlSetData 103)
; 
...
(defconstant $kEventControlGetData 104)
; 
...
(defconstant $kEventControlGetSizeConstraints 105)
; 
...
(defconstant $kEventControlGetFrameMetrics 106)
; 
...
(defconstant $kEventControlValueFieldChanged #x97)
; 
...
(defconstant $kEventControlAddedSubControl #x98)
; 
...
(defconstant $kEventControlRemovingSubControl #x99)
; 
...
(defconstant $kEventControlBoundsChanged #x9A)
; 
...
(defconstant $kEventControlInvalidateForSizeChange 22)
; 
...
(defconstant $kEventControlVisibilityChanged #x9D)
; 
...
(defconstant $kEventControlOwningWindowChanged #x9F)
; 
...
(defconstant $kEventControlTitleChanged #x9E)
; 
...
(defconstant $kEventControlHiliteChanged #xA0)
; 
...
(defconstant $kEventControlEnabledStateChanged #xA1)
; 
...
(defconstant $kEventControlLayoutInfoChanged #xA2)
; 
...
(defconstant $kEventControlArbitraryMessage #xC9)
; 
;  *  Summary:
...
(defconstant $kControlBoundsChangeSizeChanged 4)
; 
;    * The top left corner (position) changed.
;    

(defconstant $kControlBoundsChangePositionChanged 8)
; ——————————————————————————————————————————————————————————————————————————————————————
...
(defconstant $kEventTabletPoint 1)
; 
...
(defconstant $kEventTabletProximity 2)
(defrecord TabletPointRec
...
;type name? (%define-record :TabletPointRec (find-record-descriptor ':TabletPointRec))

(%define-record :TabletPointerRec (find-record-descriptor ':TabletPointRec))
(defrecord TabletProximityRec
...
;type name? (%define-record :TabletProximityRec (find-record-descriptor ':TabletProximityRec))
; ——————————————————————————————————————————————————————————————————————————————————————
;  Volume Events                                                                        
; ——————————————————————————————————————————————————————————————————————————————————————
; 
...
(defconstant $typeFSVolumeRefNum :|voln|)       ;  FSVolumeRefNum
...
(defconstant $kEventVolumeMounted 1)
; 
...
(defconstant $kEventVolumeUnmounted 2)
; ——————————————————————————————————————————————————————————————————————————————————————
;  Appearance Events                                                                    
; ——————————————————————————————————————————————————————————————————————————————————————
; 
...
(defconstant $kEventAppearanceScrollBarVariantChanged 1)
; ——————————————————————————————————————————————————————————————————————————————————————
;   Services Events                                                                     
; ——————————————————————————————————————————————————————————————————————————————————————
; 
...
(defconstant $kEventServiceCopy 1)
; 
...
(defconstant $kEventServicePaste 2)
; 
...
(defconstant $kEventServiceGetTypes 3)
; 
...
(defconstant $kEventServicePerform 4)
; 
...
(deftrap-inline "_CreateTypeStringWithOSType" 
   ((inType :OSType)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_1_AND_LATER
   (:pointer :__CFString)
() )
...
(defconstant $kEventAccessibleGetChildAtPoint 1)
; 
...
(defconstant $kEventAccessibleGetFocusedChild 2)
; 
...
(defconstant $kEventAccessibleGetAllAttributeNames 21)
; 
...
(defconstant $kEventAccessibleGetAllParameterizedAttributeNames 25)
; 
...
(defconstant $kEventAccessibleGetNamedAttribute 22)
; 
...
(defconstant $kEventAccessibleSetNamedAttribute 23)
; 
...
(defconstant $kEventAccessibleIsNamedAttributeSettable 24)
; 
...
(defconstant $kEventAccessibleGetAllActionNames 41)
; 
...
(defconstant $kEventAccessiblePerformNamedAction 42)
; 
...
(defconstant $kEventAccessibleGetNamedActionDescription 44)
; 
...
(deftrap-inline "_AXUIElementCreateWithHIObjectAndIdentifier" 
   ((inHIObject (:pointer :OpaqueHIObjectRef))
    (inIdentifier :UInt64)
...
(deftrap-inline "_AXUIElementGetHIObject" 
   ((inUIElement (:pointer :__AXUIElement))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
...
(deftrap-inline "_AXUIElementGetIdentifier" 
   ((inUIElement (:pointer :__AXUIElement))
    (outIdentifier (:pointer :UInt64))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   nil
() )
; 
...
(deftrap-inline "_AXNotificationHIObjectNotify" 
   ((inNotification (:pointer :__CFString))
    (inHIObject (:pointer :OpaqueHIObjectRef))
    (inIdentifier :UInt64)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   nil
...
(defconstant $kEventSystemTimeDateChanged 2)
; 
...
(defconstant $kEventSystemUserSessionActivated 10)
; 
...
(defconstant $kEventSystemUserSessionDeactivated 11)
; ——————————————————————————————————————————————————————————————————————————————————————
...
(deftrap-inline "_GetWindowEventTarget" 
   ((inWindow (:pointer :OpaqueWindowPtr))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   (:pointer :OpaqueEventTargetRef)
() )
; 
...
(deftrap-inline "_GetControlEventTarget" 
...
(deftrap-inline "_GetMenuEventTarget" 
...
(deftrap-inline "_GetApplicationEventTarget" 
   (
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   (:pointer :OpaqueEventTargetRef)
() )
...
(deftrap-inline "_GetUserFocusEventTarget" 
   (
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   (:pointer :OpaqueEventTargetRef)
() )
...
(deftrap-inline "_GetEventDispatcherTarget" 
   (
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   (:pointer :OpaqueEventTargetRef)
() )
...
(deftrap-inline "_GetEventMonitorTarget" 
   (
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   (:pointer :OpaqueEventTargetRef)
() )
; #define InstallApplicationEventHandler( h, n, l, u, r )      InstallEventHandler( GetApplicationEventTarget(), (h), (n), (l), (u), (r) )
; #define InstallHIObjectEventHandler( t, h, n, l, u, r )      InstallEventHandler( HIObjectGetEventTarget( t ), (h), (n), (l), (u), (r) )
...
(def-mactype :ToolboxObjectClassRef (find-mactype '(:pointer :OpaqueToolboxObjectClassRef)))
; 
...
(deftrap-inline "_RegisterToolboxObjectClass" 
   ((inClassID (:pointer :__CFString))
    (inBaseClass (:pointer :OpaqueToolboxObjectClassRef));  can be NULL 
    (inNumEvents :UInt32)
    (inEventList (:pointer :EventTypeSpec))
    (inEventHandler (:pointer :OpaqueEventHandlerProcPtr))
    (inEventHandlerData :pointer)
    (outClassRef (:pointer :TOOLBOXOBJECTCLASSREF))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_UnregisterToolboxObjectClass" 
   ((inClassRef (:pointer :OpaqueToolboxObjectClassRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; ======================================================================================
...
(deftrap-inline "_ProcessHICommand" 
   ((inCommand (:pointer :HICommand))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; ——————————————————————————————————————————————————————————————————————————————————————
...
(deftrap-inline "_RunApplicationEventLoop" 
   (
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   nil
() )
...
(deftrap-inline "_QuitApplicationEventLoop" 
   (
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   nil
() )
...
(deftrap-inline "_RunAppModalLoopForWindow" 
   ((inWindow (:pointer :OpaqueWindowPtr))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_QuitAppModalLoopForWindow" 
   ((inWindow (:pointer :OpaqueWindowPtr))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_BeginAppModalStateForWindow" 
   ((inWindow (:pointer :OpaqueWindowPtr))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_EndAppModalStateForWindow" 
   ((inWindow (:pointer :OpaqueWindowPtr))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_SetUserFocusWindow" 
   ((inWindow (:pointer :OpaqueWindowPtr))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_GetUserFocusWindow" 
   (
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
...
(deftrap-inline "_SetWindowDefaultButton" 
   ((inWindow (:pointer :OpaqueWindowPtr))
    (inControl (:pointer :OpaqueControlRef))    ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_SetWindowCancelButton" 
   ((inWindow (:pointer :OpaqueWindowPtr))
    (inControl (:pointer :OpaqueControlRef))    ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
...
(deftrap-inline "_GetWindowDefaultButton" 
   ((inWindow (:pointer :OpaqueWindowPtr))
...
(deftrap-inline "_GetWindowCancelButton" 
   ((inWindow (:pointer :OpaqueWindowPtr))
    (outControl (:pointer :ControlRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
...
;   • Global HotKey API                                                                 
; ——————————————————————————————————————————————————————————————————————————————————————
(defrecord EventHotKeyID
   (signature :OSType)
   (id :UInt32)
)

;type name? (%define-record :EventHotKeyID (find-record-descriptor ':EventHotKeyID))

(def-mactype :EventHotKeyRef (find-mactype '(:pointer :OpaqueEventHotKeyRef)))
; 
;  *  RegisterEventHotKey()
;  *  
;  *  Discussion:
...
(deftrap-inline "_RegisterEventHotKey" 
   ((inHotKeyCode :UInt32)
...
(deftrap-inline "_UnregisterEventHotKey" 
   ((inHotKey (:pointer :OpaqueEventHotKeyRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_0_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_CopySymbolicHotKeys" 
   ((outHotKeyArray (:pointer :CFArrayRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER
   :OSStatus
() )
; ——————————————————————————————————————————————————————————————————————————————————————
...
(def-mactype :MouseTrackingRef (find-mactype '(:pointer :OpaqueMouseTrackingRef)))
; 
...
(defconstant $kMouseTrackingOptionsGlobalClip 1)
; 
;    * Standard options. The region will be handled in local coordinates
;    * and remain clipped against the windows content region.
;    

(defconstant $kMouseTrackingOptionsStandard 0)
(defrecord MouseTrackingRegionID
   (signature :OSType)
   (id :SInt32)
)

;type name? (%define-record :MouseTrackingRegionID (find-record-descriptor ':MouseTrackingRegionID))
;  Creation
; 
...
(deftrap-inline "_CreateMouseTrackingRegion" 
   ((inWindow (:pointer :OpaqueWindowPtr))
    (inRegion (:pointer :OpaqueRgnHandle))
    (inClip (:pointer :OpaqueRgnHandle))        ;  can be NULL 
    (inOptions :UInt32)
    (signature :OSType)
    (ID :SInt32)
    (inRefCon :pointer)
    (inTargetToNotify (:pointer :OpaqueEventTargetRef));  can be NULL 
    (outTrackingRef (:pointer :MOUSETRACKINGREF))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_RetainMouseTrackingRegion" 
   ((inMouseRef (:pointer :OpaqueMouseTrackingRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_ReleaseMouseTrackingRegion" 
   ((inMouseRef (:pointer :OpaqueMouseTrackingRef))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
...
(deftrap-inline "_ChangeMouseTrackingRegion" 
   ((inMouseRef (:pointer :OpaqueMouseTrackingRef))
    (inRegion (:pointer :OpaqueRgnHandle))
    (inClip (:pointer :OpaqueRgnHandle))        ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
...
(deftrap-inline "_ClipMouseTrackingRegion" 
   ((inMouseRef (:pointer :OpaqueMouseTrackingRef))
    (inRegion (:pointer :OpaqueRgnHandle))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
...
(deftrap-inline "_GetMouseTrackingRegionID" 
   ((inMouseRef (:pointer :OpaqueMouseTrackingRef))
    (outID (:pointer :MouseTrackingRegionID))
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
() )
; 
...
(deftrap-inline "_GetMouseTrackingRegionRefCon" 
   ((inMouseRef (:pointer :OpaqueMouseTrackingRef))
    (outRefCon :pointer)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
...
(deftrap-inline "_MoveMouseTrackingRegion" 
   ((inMouseRef (:pointer :OpaqueMouseTrackingRef))
    (deltaH :SInt16)
    (deltaV :SInt16)
    (inClip (:pointer :OpaqueRgnHandle))        ;  can be NULL 
...
(deftrap-inline "_SetMouseTrackingRegionEnabled" 
   ((inMouseRef (:pointer :OpaqueMouseTrackingRef))
    (inEnabled :Boolean)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
...
(deftrap-inline "_ClipWindowMouseTrackingRegions" 
   ((inWindow (:pointer :OpaqueWindowPtr))
    (inSignature :OSType)
    (inClip (:pointer :OpaqueRgnHandle))        ;  can be NULL 
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
...
(deftrap-inline "_MoveWindowMouseTrackingRegions" 
   ((inWindow (:pointer :OpaqueWindowPtr))
    (inSignature :OSType)
    (deltaH :SInt16)
    (deltaV :SInt16)
...
(deftrap-inline "_SetWindowMouseTrackingRegionsEnabled" 
   ((inWindow (:pointer :OpaqueWindowPtr))
    (inSignature :OSType)
    (inEnabled :Boolean)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
...
(deftrap-inline "_ReleaseWindowMouseTrackingRegions" 
   ((inWindow (:pointer :OpaqueWindowPtr))
    (inSignature :OSType)
   )                                            ; AVAILABLE_MAC_OS_X_VERSION_10_2_AND_LATER
   :OSStatus
...
(defconstant $kEventParamInkTextRef :|iwrd|)    ;  typePtr 

(defconstant $kEventParamInkKeyboardShortcut :|ikbd|);  typeBoolean 

(defconstant $kEventParamInkGestureKind :|gknd|);  typeUInt32 

(defconstant $kEventParamInkGestureBounds :|gbnd|);  typeHIRect 

(defconstant $kEventParamInkGestureHotspot :|ghot|);  typeHIPoint 
...
(defconstant $kEventInkGesture 11)
; 
...
(defconstant $kEventInkText 12)
; ——————————————————————————————————————————————————————————————————————————————————————
;  Obsolete constant names - use the new ones. Will be removed.                         
; ——————————————————————————————————————————————————————————————————————————————————————

(defconstant $kEventWindowDefDrawFrame #x3E8)
(defconstant $kEventWindowDefDrawPart #x3E9)
(defconstant $kEventWindowDefGetRegion #x3EA)
(defconstant $kEventWindowDefHitTest #x3EB)
(defconstant $kEventWindowDefInit #x3EC)
(defconstant $kEventWindowDefDispose #x3ED)
(defconstant $kEventWindowDefDragHilite #x3EE)
(defconstant $kEventWindowDefModified #x3EF)
(defconstant $kEventWindowDefSetupProxyDragImage #x3F0)
(defconstant $kEventWindowDefStateChanged #x3F1)
(defconstant $kEventWindowDefMeasureTitle #x3F2)
(defconstant $kEventWindowDefDrawGrowBox #x3F3)
(defconstant $kEventWindowDefGetGrowImageRegion #x3F4)

(defconstant $kEventClassEPPC :|eppc|)
(defconstant $kEventHighLevelEvent 1)

(defconstant $kEventUpdateActiveInputArea 1)
(defconstant $kEventUnicodeForKeyEvent 2)
(defconstant $kEventOffsetToPos 3)
(defconstant $kEventPosToOffset 4)
(defconstant $kEventShowHideBottomWindow 5)
(defconstant $kEventGetSelectedText 6)

(defconstant $kEventProcessCommand 1)
(defconstant $kEventTabletPointer 1)
; ——————————————————————————————————————————————————————————————————————————————————————
;  Obsolete typedefs. Will be removed eventually.                                       
; ——————————————————————————————————————————————————————————————————————————————————————

(def-mactype :EventClassID (find-mactype ':UInt32))

(def-mactype :EventClass (find-mactype ':UInt32))

(def-mactype :EventType (find-mactype ':UInt32))
;  OBSOLETE CONSTANTS

(defconstant $kMouseTrackingMousePressed 1)
(defconstant $kMouseTrackingMouseReleased 2)

(defconstant $kEventControlGetSubviewForMouseEvent 16)
...
(provide-interface "CarbonEvents")
(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOSCSIParallelInterfaceController.h"
; at Sunday July 2,2006 7:29:47 pm.
; 
...
(require-interface "IOKit/IOFilterInterruptEventSource")

(require-interface "IOKit/IOTimerEventSource")

(require-interface "IOKit/scsi/SCSITask")
; ÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑ
; 	Constants
; ÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑ
(defconstant $kIOPropertySCSIParallelInterfaceKey "SCSI Parallel Interface")
; #define kIOPropertySCSIParallelInterfaceKey		"SCSI Parallel Interface"
(defconstant $kIOPropertySCSIDeviceFeaturesKey "SCSI Device Features")
; #define kIOPropertySCSIDeviceFeaturesKey		"SCSI Device Features"
(defconstant $kIOPropertySCSI_I_T_NexusFeaturesKey "SCSI I_T Nexus Features")
...
(def-mactype :SCSIParallelFeature (find-mactype ':sint32))
...
(defconstant $kSCSIParallelFeature_WideDataTransfer 0);  The selector for support of Synchronous Data Transfers

(defconstant $kSCSIParallelFeature_SynchronousDataTransfer 1);  The selector for support of Quick Arbitration and Selection (QAS)

(defconstant $kSCSIParallelFeature_QuickArbitrationAndSelection 2);  The selector for support of Double Transition (DT) data transfers.

(defconstant $kSCSIParallelFeature_DoubleTransitionDataTransfers 3);  The selector for SPI Information Unit (IU) transfers

(defconstant $kSCSIParallelFeature_InformationUnitTransfers 4);  Since the Feature selectors are zero base, this will always have the 
;  correct total.

(defconstant $kSCSIParallelFeature_TotalFeatureCount 5)
(def-mactype :SCSIParallelFeature (find-mactype ':SINT32))
(def-mactype :SCSIParallelFeatureRequest (find-mactype ':sint32))
;  This selector indicates that current negotiation 
;  should be used. 

(defconstant $kSCSIParallelFeature_NoNegotiation 0);  This selector indicates that the controller
;  should attempt negotiation for the feature

(defconstant $kSCSIParallelFeature_AttemptNegotiation 1);  This selector indicates that the controller
;  should clear any negotiation for the feature

(defconstant $kSCSIParallelFeature_ClearNegotiation 2)
(def-mactype :SCSIParallelFeatureResult (find-mactype ':sint32))

(defconstant $kSCSIParallelFeature_NegotitiationUnchanged 0)
(defconstant $kSCSIParallelFeature_NegotitiationCleared 1)
(defconstant $kSCSIParallelFeature_NegotitiationSuccess 2)
;  The SCSI Message Codes used for MESSAGE IN and MESSAGE OUT phases.
(def-mactype :SCSIParallelMessages (find-mactype ':sint32))
;  Link Control Messages

(defconstant $kSCSIParallelMessage_TASK_COMPLETE 0)
(defconstant $kSCSIParallelMessage_EXTENDED_MESSAGE 1)
(defconstant $kSCSIParallelMessage_SAVE_DATA_POINTER 2)
(defconstant $kSCSIParallelMessage_RESTORE_POINTERS 3)
(defconstant $kSCSIParallelMessage_DISCONNECT 4)
(defconstant $kSCSIParallelMessage_INITIATOR_DETECTED_ERROR 5)
(defconstant $kSCSIParallelMessage_MESSAGE_REJECT 7)
(defconstant $kSCSIParallelMessage_NO_OPERATION 8)
(defconstant $kSCSIParallelMessage_MESSAGE_PARITY_ERROR 9)
(defconstant $kSCSIParallelMessage_IGNORE_WIDE_RESIDUE 35)
(defconstant $kSCSIParallelMessage_QAS_REQUEST 85)
(defconstant $kSCSIParallelMessage_IDENTIFY #x80);  The Message Codes used in the EXTENDED_MESSAGE message.

(defconstant $kSCSIParallelMessage_MODIFY_DATA_POINTER 0)
(defconstant $kSCSIParallelMessage_SYNCHONOUS_DATA_TRANSFER_REQUEST 1);  Reserved												= 0x02

(defconstant $kSCSIParallelMessage_WIDE_DATA_TRANSFER_REQUEST 3)
(defconstant $kSCSIParallelMessage_PARALLEL_PROTOCOL_REQUEST 4);  Reserved												= 0x05 through 0xFF
;  Task Attribute Message Codes

(defconstant $kSCSIParallelMessage_ACA 36)
(defconstant $kSCSIParallelMessage_HEAD_OF_QUEUE 33)
(defconstant $kSCSIParallelMessage_LINKED_COMMAND_COMPLETE 10)
(defconstant $kSCSIParallelMessage_ORDERED 34)
(defconstant $kSCSIParallelMessage_SIMPLE 32)   ;  Task Management Message Codes

(defconstant $kSCSIParallelMessage_ABORT_TASK 13)
(defconstant $kSCSIParallelMessage_ABORT_TASK_SET 6)
(defconstant $kSCSIParallelMessage_CLEAR_ACA 22)
(defconstant $kSCSIParallelMessage_CLEAR_TASK_SET 14)
(defconstant $kSCSIParallelMessage_LOGICAL_UNIT_RESET 23)
(defconstant $kSCSIParallelMessage_TARGET_RESET 12)

(defconstant $kSCSIParallelTaskControllerIDQueueHead 0)
;  Notifications

(defconstant $kSCSIControllerNotificationBusReset #x68000000)
...
(def-mactype :SCSIParallelTaskIdentifier (find-mactype '(:pointer :OSObject)))
; ÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑ
; 	Class Declarations
; ÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑÑ
#|
 confused about CLASS IOSCSIParallelInterfaceController #\: public IOService #\{ OSDeclareAbstractStructors #\( IOSCSIParallelInterfaceController #\)
; #if 0
#| ; #pragma mark -
...
; 	
 SCSIServiceResponse ExecuteParallelTask #\( SCSIParallelTaskIdentifier parallelRequest #\) #\;;  --- Public API methods provided by HBA child classes ----
; !
...
; 	
 virtual bool InitializeTargetForID #\( SCSITargetIdentifier targetID #\) = 0 #\;;  The SCSI Task Management Functions as defined in the SCSI Architecture
...
;  function complete member routine listed in the child class API section.
 virtual SCSIServiceResponse AbortTaskRequest #\( SCSITargetIdentifier theT #\, SCSILogicalUnitNumber theL #\, SCSITaggedTaskIdentifier theQ #\) = 0 #\; virtual SCSIServiceResponse AbortTaskSetRequest #\( SCSITargetIdentifier theT #\, SCSILogicalUnitNumber theL #\) = 0 #\; virtual SCSIServiceResponse ClearACARequest #\( SCSITargetIdentifier theT #\, SCSILogicalUnitNumber theL #\) = 0 #\; virtual SCSIServiceResponse ClearTaskSetRequest #\( SCSITargetIdentifier theT #\, SCSILogicalUnitNumber theL #\) = 0 #\; virtual SCSIServiceResponse LogicalUnitResetRequest #\( SCSITargetIdentifier theT #\, SCSILogicalUnitNumber theL #\) = 0 #\; virtual SCSIServiceResponse TargetResetRequest #\( SCSITargetIdentifier theT #\) = 0 #\;;  Padding for the Client API
 OSMetaClassDeclareReservedUnused #\( IOSCSIParallelInterfaceController #\, 1 #\) #\; OSMetaClassDeclareReservedUnused #\( IOSCSIParallelInterfaceController #\, 2 #\) #\; OSMetaClassDeclareReservedUnused #\( IOSCSIParallelInterfaceController #\, 3 #\) #\; OSMetaClassDeclareReservedUnused #\( IOSCSIParallelInterfaceController #\, 4 #\) #\; OSMetaClassDeclareReservedUnused #\( IOSCSIParallelInterfaceController #\, 5 #\) #\; OSMetaClassDeclareReservedUnused #\( IOSCSIParallelInterfaceController #\, 6 #\) #\; OSMetaClassDeclareReservedUnused #\( IOSCSIParallelInterfaceController #\, 7 #\) #\; OSMetaClassDeclareReservedUnused #\( IOSCSIParallelInterfaceController #\, 8 #\) #\;
; #if 0
#| ; #pragma mark -
...
; #endif
 ...
 protected #\:                                  ;  ---- Target Creation and Destruction methods ---
; !
...
; 		found.
; 	
 IOSCSIParallelInterfaceDevice * GetTargetForID #\( SCSIDeviceIdentifier targetID #\) #\;;  ---- Methods to retrieve the HBA specifics. ----
...
; 	
 virtual bool DoesHBAPerformDeviceManagement #\( void #\) = 0 #\;;  ---- Initialize and Terminate methods for the subclass to implement -----
...
; 		class is destroyed.
; 	
 virtual void TerminateController #\( void #\) = 0 #\;;  ---- Start and Stop methods for the subclass ----
; !
...
; 		discussion )
; 	
 virtual void StopController #\( void #\) = 0 #\;;  ---- Suspend and Resume Methods for the subclass ----
; !
...
; 	
 void CompleteParallelTask #\( SCSIParallelTaskIdentifier parallelRequest #\, SCSITaskStatus completionStatus #\, SCSIServiceResponse serviceResponse #\) #\;;  Completion routines for the SCSI Task Management functions as described
...
;  need to call the appropriate completion member routine listed here.
 void CompleteAbortTask #\( SCSITargetIdentifier theT #\, SCSILogicalUnitNumber theL #\, SCSITaggedTaskIdentifier theQ #\, SCSIServiceResponse serviceResponse #\) #\; void CompleteAbortTaskSet #\( SCSITargetIdentifier theT #\, SCSILogicalUnitNumber theL #\, SCSIServiceResponse serviceResponse #\) #\; void CompleteClearACA #\( SCSITargetIdentifier theT #\, SCSILogicalUnitNumber theL #\, SCSIServiceResponse serviceResponse #\) #\; void CompleteClearTaskSet #\( SCSITargetIdentifier theT #\, SCSILogicalUnitNumber theL #\, SCSIServiceResponse serviceResponse #\) #\; void CompleteLogicalUnitReset #\( SCSITargetIdentifier theT #\, SCSILogicalUnitNumber theL #\, SCSIServiceResponse serviceResponse #\) #\; void CompleteTargetReset #\( SCSITargetIdentifier theT #\, SCSIServiceResponse serviceResponse #\) #\;
; !
...
; 	
 IOCommandGate * GetCommandGate #\( void #\) #\;;  ---- SCSI Parallel Task Object Accessors ----
; !
...
; 	
 SCSITargetIdentifier GetTargetIdentifier #\( SCSIParallelTaskIdentifier parallelTask #\) #\;;  ---- Methods for Accessing data in the client's SCSI Task Object ----	
...
; 		@result an unsigned integer up to 64 bits in size.
; 	
 UInt64 GetSCSIParallelFeatureNegotiationResultCount #\( SCSIParallelTaskIdentifier parallelTask #\) #\;;  Controller Task Identifier related member routines
; !
...
; 		@result none
; 	
 void SetControllerTaskIdentifier #\( SCSIParallelTaskIdentifier parallelTask #\, UInt64 newIdentifier #\) #\; UInt64 GetControllerTaskIdentifier #\( SCSIParallelTaskIdentifier parallelTask #\) #\;;  The HBA Data related fields
; !
...
; 	
 IOMemoryDescriptor * GetHBADataDescriptor #\( SCSIParallelTaskIdentifier parallelTask #\) #\;;  ---- SCSI Parallel Device Object Accessors ----
...
; 		@param parallelRequest A valid SCSIParallelTaskIdentifier.
; 	
 OSMetaClassDeclareReservedUsed #\( IOSCSIParallelInterfaceController #\, 9 #\) #\; virtual void HandleTimeout #\( SCSIParallelTaskIdentifier parallelRequest #\) #\;;  ---- Filter Interrupt methods ----
; !
...
; 	
 OSMetaClassDeclareReservedUsed #\( IOSCSIParallelInterfaceController #\, 10 #\) #\; virtual bool FilterInterruptRequest #\( void #\) #\;;  Padding for the Child Class API
 OSMetaClassDeclareReservedUnused #\( IOSCSIParallelInterfaceController #\, 11 #\) #\; OSMetaClassDeclareReservedUnused #\( IOSCSIParallelInterfaceController #\, 12 #\) #\; OSMetaClassDeclareReservedUnused #\( IOSCSIParallelInterfaceController #\, 13 #\) #\; OSMetaClassDeclareReservedUnused #\( IOSCSIParallelInterfaceController #\, 14 #\) #\; OSMetaClassDeclareReservedUnused #\( IOSCSIParallelInterfaceController #\, 15 #\) #\; OSMetaClassDeclareReservedUnused #\( IOSCSIParallelInterfaceController #\, 16 #\) #\;
; #if 0
#| ; #pragma mark -
...
; #endif
 ...
 private #\:                                    ;  binary compatibility instance variable expansion
 struct ExpansionData #\{ #\} #\; ExpansionData * fIOSCSIParallelInterfaceControllerExpansionData #\; IOService * fProvider #\; OSSet * fClients #\; static SInt32 fSCSIParallelDomainCount #\; SInt32 fSCSIDomainIdentifier #\;;  The HBA attributes
 SCSIInitiatorIdentifier fInitiatorIdentifier #\;;  The maximum SCSI Device Identifier support by the HBA
;  This is retreived from the child class via the 
 SCSIDeviceIdentifier fHighestSupportedDeviceID #\;;  The total number of tasks that the HBA can proccess at a time.
;  This is retrieved from the child class via ReportMaximumTaskCount
 UInt32 fSupportedTaskCount #\;                 ;  The Number of requests that are currently outstanding for the current
;  instantiation.
 UInt16 fOutstandingRequests #\;                ;  The member variable to indicate if the current instantiation has been
;  succesfully intialized.
 bool fHBAHasBeenInitialized #\;                ;  The member variable to indicate if the current instantiation is running.
...
;  Stop call has been made.
 bool fHBACanAcceptClientRequests #\;           ;  The pool for the available SCSI Parallel Task objects
 IOCommandPool * fParallelTaskPool #\;          ;  WorkLoop variables
 IOWorkLoop * fWorkLoop #\; IOTimerEventSource * fTimerEvent #\; IOInterruptEventSource * fDispatchEvent #\; IOCommandGate * fControllerGate #\; bool AllocateSCSIParallelTasks #\( void #\) #\; void DeallocateSCSIParallelTasks #\( void #\) #\; IOWorkLoop * getWorkLoop #\( void #\) const #\; bool CreateWorkLoop #\( IOService * provider #\) #\; void ReleaseWorkLoop #\( void #\) #\;;  SCSI Parallel Device List
...
;  like a simple array of device objects.
 enum #\{ kSCSIParallelDeviceListArrayCount = 16 #\, kSCSIParallelDeviceListIndexMask = 0x0F #\} #\; IOSimpleLock * fDeviceLock #\; IOSCSIParallelInterfaceDevice * fParallelDeviceList #\[ kSCSIParallelDeviceListArrayCount #\] #\; void InitializeDeviceList #\( void #\) #\; void AddDeviceToTargetList #\( IOSCSIParallelInterfaceDevice * newDevice #\) #\; void RemoveDeviceFromTargetList #\( IOSCSIParallelInterfaceDevice * victimDevice #\) #\;;  The Interrupt Service Routine for the controller.
 static void ServiceInterrupt #\( OSObject * theObject #\, IOInterruptEventSource * theSource #\, int count #\) #\; static void TimeoutOccurred #\( OSObject * owner #\, IOTimerEventSource * sender #\) #\; static bool FilterInterrupt #\( OSObject * theObject #\, IOFilterInterruptEventSource * theSource #\) #\;;  IOService support methods
;  These shall not be overridden by the HBA child classes.
 bool start #\( IOService * provider #\) #\; void stop #\( IOService * provider #\) #\;;  These may be overriden by the HBA child classes if necessary.
 virtual bool handleOpen #\( IOService * client #\, IOOptionBits options #\, void * arg #\) #\; virtual void handleClose #\( IOService * client #\, IOOptionBits options #\) #\; virtual bool handleIsOpen #\( const IOService * client #\) const #\;
|#

; #endif	/* __IOKIT_IO_SCSI_PARALLEL_INTERFACE_CONTROLLER_H__ */


(provide-interface "IOSCSIParallelInterfaceController")
(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:SecPolicy.h"
...
(deftrap-inline "_SecPolicyGetTypeID" 
   (
   )
   :UInt32
() )
...
(deftrap-inline "_SecPolicyGetOID" 
   ((policyRef (:pointer :OpaqueSecPolicyRef))
    (oid (:pointer :cssm_oid))
   )
   :SInt32
() )
; !
...
(deftrap-inline "_SecPolicyGetValue" 
   ((policyRef (:pointer :OpaqueSecPolicyRef))
...
(deftrap-inline "_SecPolicyGetTPHandle" 
   ((policyRef (:pointer :OpaqueSecPolicyRef))
    (tpHandle (:pointer :CSSM_TP_HANDLE))
   )
   :SInt32
() )

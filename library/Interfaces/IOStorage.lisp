(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOStorage.h"
; at Sunday July 2,2006 7:28:22 pm.
; 
...
;  
(defconstant $kIOStorageClass "IOStorage")
...
(def-mactype :IOStorageAccess (find-mactype ':UInt32))
(defconstant $kIOStorageAccessNone 0)
; #define kIOStorageAccessNone         0x00
(defconstant $kIOStorageAccessReader 1)
; #define kIOStorageAccessReader       0x01
(defconstant $kIOStorageAccessReaderWriter 3)
...
;  
(defconstant $kIOStorageCategory "IOStorage")
; #define kIOStorageCategory "IOStorage"                /* (as IOMatchCategory) */

; #endif /* !_IOSTORAGE_H */


(provide-interface "IOStorage")
(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:hw_lock_types.h"
...
(def-mactype :hw_lock_data_t (find-mactype ':signed-long))

(def-mactype :hw_lock_t (find-mactype '(:pointer :signed-long)))
; #define hw_lock_addr(hwl)	(&(hwl))

; #endif	/* _I386_HW_LOCK_TYPES_H_ */


(provide-interface "hw_lock_types")
(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOAudioEngine.h"
...
#|class IOCommandGate;
|#
(defconstant $IOAUDIOENGINE_DEFAULT_NUM_ERASES_PER_BUFFER 4)
...
;  
(defrecord IOAudioEnginePosition
   (fSampleFrame :UInt32)
   (fLoopCount :UInt32)
)
; #define CMP_IOAUDIOENGINEPOSITION(p1, p2)     (((p1)->fLoopCount > (p2)->fLoopCount) ? 1 :	        ((p1)->fLoopCount == (p2)->fLoopCount) && ((p1)->fSampleFrame > (p2)->fSampleFrame) ? 1 :	            ((p1)->fLoopCount == (p2)->fLoopCount) && ((p1)->fSampleFrame == (p2)->fSampleFrame) ? 0 : -1)
...
;  
#|
 confused about CLASS IOAudioEngine #\: public IOService #\{ OSDeclareAbstractStructors #\( IOAudioEngine #\) friend class IOAudioEngineUserClient #\; friend class IOAudioDevice #\; friend class IOAudioStream #\; public #\:; ! @var gSampleRateWholeNumberKey 
 static const OSSymbol * gSampleRateWholeNumberKey #\;; ! @var gSampleRateFractionKey 
 static const OSSymbol * gSampleRateFractionKey #\;; ! @var numSampleFramesPerBuffer 
...
;      *  An OSSet of all of the input IOAudioStreams attached to this IOAudioEngine. 
 OSOrderedSet * inputStreams #\; UInt32 maxNumInputChannels #\;
; ! @var outputStreams 
;      *  An OSSet of all of the output IOAudioStreams attached to this IOAudioEngine. 
 OSOrderedSet * outputStreams #\; UInt32 maxNumOutputChannels #\;
; ! @var userClients 
...
;      *    recording audio. 
 UInt32 numActiveUserClients #\; UInt32 sampleOffset #\; UInt32 index #\; bool duringStartup #\; protected #\:
; !
...
;      * @param options
;      
 virtual void registerService #\( IOOptionBits options = 0 #\) #\; virtual void setAudioDevice #\( IOAudioDevice * device #\) #\; virtual void setIndex #\( UInt32 index #\) #\; virtual void setDescription #\( const char * description #\) #\;
; !
...
;      
 virtual IOReturn addAudioStream #\( IOAudioStream * stream #\) #\; virtual IOAudioStream * getAudioStream #\( IOAudioStreamDirection direction #\, UInt32 channelID #\) #\; virtual void lockAllStreams #\( #\) #\; virtual void unlockAllStreams #\( #\) #\; virtual void updateChannelNumbers #\( #\) #\;
; !
...
;      
 virtual IOReturn stopAudioEngine #\( #\) #\; virtual IOReturn pauseAudioEngine #\( #\) #\; virtual IOReturn resumeAudioEngine #\( #\) #\;
; !
...
;      
 virtual const IOAudioSampleRate * getSampleRate #\( #\) #\; virtual IOReturn hardwareSampleRateChanged #\( const IOAudioSampleRate * sampleRate #\) #\;
; !
;      * @function getErases 
...
;      
 static void initKeys #\( #\) #\; virtual void setNumSampleFramesPerBuffer #\( UInt32 numSampleFrames #\) #\; virtual UInt32 getNumSampleFramesPerBuffer #\( #\) #\;
; !
;      * @function _setState
...
;      
 virtual void setSampleLatency #\( UInt32 numSamples #\) #\; virtual void setOutputSampleLatency #\( UInt32 numSamples #\) #\; virtual void setInputSampleLatency #\( UInt32 numSamples #\) #\; virtual void setSampleOffset #\( UInt32 numSamples #\) #\;
; !
;      * @function _setErases

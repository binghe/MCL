(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:CGPDFContext.h"
; at Sunday July 2,2006 7:24:18 pm.
...
(deftrap-inline "_CGPDFContextCreate" 
...
(deftrap-inline "_CGPDFContextCreateWithURL" 
   ((url (:pointer :__CFURL))
    (mediaBox (:pointer :CGRect))
    (auxiliaryInfo (:pointer :__CFDictionary))
   )
...
(provide-interface "CGPDFContext")
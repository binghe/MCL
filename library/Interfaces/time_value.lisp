(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:time_value.h"
...
;  
(defrecord time_value
   (seconds :signed-long)
   (microseconds :signed-long)
)

(%define-record :time_value_t (find-record-descriptor ':time_value))

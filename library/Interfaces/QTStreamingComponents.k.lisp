(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:QTStreamingComponents.k.h"
...
(require-interface "QuickTime/QTStreamingComponents")
; 
; 	Example usage:
; 
...
#| #|
	#ifndefQTSSOURCER_GLOBALS
		#define QTSSOURCER_GLOBALS() 
		#define ADD_QTSSOURCER_COMMA 
	#else		#define ADD_QTSSOURCER_COMMA ,
	#endif	#define QTSSOURCER_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define QTSSOURCER_STRCAT(a,b) QTSSOURCER_GLUE(a,b)
...
#| #|
	#ifndefRTPRSSM_GLOBALS
		#define RTPRSSM_GLOBALS() 
		#define ADD_RTPRSSM_COMMA 
	#else		#define ADD_RTPRSSM_COMMA ,
	#endif	#define RTPRSSM_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define RTPRSSM_STRCAT(a,b) RTPRSSM_GLUE(a,b)
...
#| #|
	...
	#else		#define ADD_RTPMP_COMMA ,
	#endif	#define RTPMP_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define RTPMP_STRCAT(a,b) RTPMP_GLUE(a,b)
...
#| #|
	...
	#else		#define ADD_RTPPB_COMMA ,
	#endif	#define RTPPB_GLUE(a,b) a
; #b
#COMPILER-DIRECTIVE 	#define RTPPB_STRCAT(a,b) RTPPB_GLUE(a,b)
...
(provide-interface "QTStreamingComponents.k")
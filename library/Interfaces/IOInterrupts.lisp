(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOInterrupts.h"
...
(defconstant $kIOInterruptTypeEdge 0)
; #define kIOInterruptTypeEdge  (0)
(defconstant $kIOInterruptTypeLevel 1)
...
(def-mactype :IOInterruptHandler (find-mactype ':pointer)); (void * target , void * refCon , void * nub , int source)

; #endif /* ! _IOKIT_IOINTERRUPTS_H */


(provide-interface "IOInterrupts")
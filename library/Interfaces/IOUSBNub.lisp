(in-package :TRAPS)
; Generated from #P"macintosh-hd:hd3:CInterface Translator:Source Interfaces:IOUSBNub.h"
; at Sunday July 2,2006 7:29:58 pm.
; 
...
|#
#|
 confused about CLASS IOUSBNub #\: public IOService #\{ OSDeclareDefaultStructors #\( IOUSBNub #\) public #\: virtual bool USBCompareProperty #\( OSDictionary * matching #\, const char * key #\) #\;
|#
; #ifdef __cplusplus
#| #|
extern "C" {
...
(deftrap-inline "_printDescriptor" 
   ((desc (:pointer :iousbdescriptorheader))
   )
   :void
() )

(deftrap-inline "_printDeviceDescriptor" 
   ((desc (:pointer :iousbdevicedescriptor))
   )
   :void
() )

(deftrap-inline "_printConfigDescriptor" 
   ((cd (:pointer :iousbconfigurationdescriptor))
   )
   :void
() )

(deftrap-inline "_printEndpointDescriptor" 
   ((ed (:pointer :iousbendpointdescriptor))
   )
   :void
() )

(deftrap-inline "_printInterfaceDescriptor" 
   ((id (:pointer :iousbinterfacedescriptor))
   )
   :void
() )
; #ifdef __cplusplus
